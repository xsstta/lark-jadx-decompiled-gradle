...
public abstract class RestrictedSuspendLambda extends RestrictedContinuationImpl implements FunctionBase<Object> {
    ...
    public RestrictedSuspendLambda(int i, Continuation<Object> cVar) {
        super(cVar);
        this.arity = i;
    }
}
