...
class ap extends ao {
    ...
    /* renamed from: a */
    public static final <T> Set<T> m265692a(Set<? extends T> set, Iterable<? extends T> iterable) {
        int i;
        Intrinsics.checkParameterIsNotNull(set, "$this$plus");
