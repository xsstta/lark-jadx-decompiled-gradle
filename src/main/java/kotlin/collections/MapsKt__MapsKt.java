...
public class MapsKt__MapsKt extends MapsKt__MapsJVMKt {
    ...
    public static final <K, V> Map<K, V> emptyMap() {
        EmptyMap vVar = EmptyMap.INSTANCE;
        if (vVar != null) {
            return vVar;
        }
    ...
    public static final <K, V> Map<K, V> toMap(Iterable<? extends Pair<? extends K, ? extends V>> iterable) {
        ...
        return MapsKt.mapOf((Pair) obj);
    }

    public static final <K, V> Map<K, V> toMap(Sequence<? extends Pair<? extends K, ? extends V>> iVar) {
        Intrinsics.checkParameterIsNotNull(iVar, "$this$toMap");
        return MapsKt.optimizeReadOnlyMap(MapsKt.toMap(iVar, new LinkedHashMap()));
    }
    ...
    private static final <K, V> V remove(Map<? extends K, V> map, K k) {
        if (map != null) {
            return (V) C69121n.m265993j(map).remove(k);
        }
    ...
    private static final <K, V> void minusAssign(Map<K, V> map, Sequence<? extends K> iVar) {
        Intrinsics.checkParameterIsNotNull(map, "$this$minusAssign");
        CollectionsKt.removeAll(map.keySet(), iVar);
    }
    ...
    public static final <K, V> Map<K, V> minus(Map<? extends K, ? extends V> map, Sequence<? extends K> iVar) {
        Intrinsics.checkParameterIsNotNull(map, "$this$minus");
        Intrinsics.checkParameterIsNotNull(iVar, "keys");
        Map mutableMap = MapsKt.toMutableMap(map);
        CollectionsKt.removeAll(mutableMap.keySet(), iVar);
        return MapsKt.optimizeReadOnlyMap(mutableMap);
    }
    ...
    private static final <K, V> void plusAssign(Map<? super K, ? super V> map, Sequence<? extends Pair<? extends K, ? extends V>> iVar) {
        Intrinsics.checkParameterIsNotNull(map, "$this$plusAssign");
        MapsKt.putAll(map, iVar);
    }

    public static final <K, V> void putAll(Map<? super K, ? super V> map, Sequence<? extends Pair<? extends K, ? extends V>> iVar) {
        Intrinsics.checkParameterIsNotNull(map, "$this$putAll");
        Intrinsics.checkParameterIsNotNull(iVar, "pairs");
        Iterator<? extends Pair<? extends K, ? extends V>> a = iVar.mo4717a();
        while (a.hasNext()) {
    ...
    public static final <K, V> Map<K, V> plus(Map<? extends K, ? extends V> map, Sequence<? extends Pair<? extends K, ? extends V>> iVar) {
        Intrinsics.checkParameterIsNotNull(map, "$this$plus");
        Intrinsics.checkParameterIsNotNull(iVar, "pairs");
        LinkedHashMap linkedHashMap = new LinkedHashMap(map);
        MapsKt.putAll(linkedHashMap, iVar);
    ...
    public static final <K, V, M extends Map<? super K, ? super V>> M toMap(Sequence<? extends Pair<? extends K, ? extends V>> iVar, M m) {
        Intrinsics.checkParameterIsNotNull(iVar, "$this$toMap");
        Intrinsics.checkParameterIsNotNull(m, "destination");
        MapsKt.putAll(m, iVar);
        return m;
    }
