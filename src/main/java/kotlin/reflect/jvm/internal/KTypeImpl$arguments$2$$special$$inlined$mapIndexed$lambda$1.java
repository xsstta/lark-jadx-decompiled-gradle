...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\n\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002¨\u0006\u0003"}, d2 = {"<anonymous>", "Ljava/lang/reflect/Type;", "invoke", "kotlin/reflect/jvm/internal/KTypeImpl$arguments$2$1$type$1"}, mo238835k = 3, mv = {1, 1, 16})
    ...
    public final Type invoke() {
        ...
        if (javaType$kotlin_reflection instanceof Class) {
            ...
            if (type instanceof WildcardType) {
                ...
                Type type2 = (Type) C69043h.m265778d(lowerBounds);
                if (type2 != null) {
                    type = type2;
                } else {
                    Type[] upperBounds = wildcardType.getUpperBounds();
                    Intrinsics.checkExpressionValueIsNotNull(upperBounds, "argument.upperBounds");
                    type = (Type) C69043h.m265771c(upperBounds);
                }
            }
