...
public final class KFunctionImpl extends KCallableImpl<Object> implements FunctionBase<Object>, KFunction<Object>, FunctionWithAllInvokes {
    ...
    public final CallerImpl.Method createInstanceMethodCaller(Method method) {
        ...
        if (isBound()) {
            method2 = new CallerImpl.Method.BoundInstance(method, getBoundReceiver());
        } else {
            method2 = new CallerImpl.Method.Instance(method);
        }
        return method2;
    }
    ...
    public final CallerImpl.Method createJvmStaticInObjectCaller(Method method) {
        CallerImpl.Method method2;
        if (isBound()) {
            method2 = new CallerImpl.Method.BoundJvmStaticInObject(method);
        } else {
            method2 = new CallerImpl.Method.JvmStaticInObject(method);
        }
        return method2;
    }
    ...
    public final CallerImpl.Method createStaticMethodCaller(Method method) {
        CallerImpl.Method method2;
        if (isBound()) {
            method2 = new CallerImpl.Method.BoundStatic(method, getBoundReceiver());
        } else {
            method2 = new CallerImpl.Method.Static(method);
        }
        return method2;
    }
