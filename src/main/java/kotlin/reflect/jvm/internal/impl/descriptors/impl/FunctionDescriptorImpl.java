...
public abstract class FunctionDescriptorImpl extends DeclarationDescriptorNonRootImpl implements FunctionDescriptor {
    ...
    public FunctionDescriptor getOriginal() {
        ...
        FunctionDescriptor functionDescriptor2 = this.original;
        if (functionDescriptor2 == this) {
            functionDescriptor = this;
        } else {
            functionDescriptor = functionDescriptor2.getOriginal();
        }
    ...
    public kotlin.reflect.jvm.internal.impl.descriptors.CallableDescriptor substitute(kotlin.reflect.jvm.internal.impl.types.TypeSubstitutor r2) {
        /*
            r1 = this;
        ...
        L_0x000e:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.descriptors.impl.FunctionDescriptorImpl.substitute(kotlin.reflect.jvm.internal.impl.types.TypeSubstitutor):kotlin.reflect.jvm.internal.impl.descriptors.FunctionDescriptor");
    }
        ...
        if (copyConfiguration.copyOverrides && !getOriginal().getOverriddenDescriptors().isEmpty()) {
            if (copyConfiguration.substitution.isEmpty()) {
                ...
                createSubstitutedCopy.lazyOverriddenFunctionsTask = new Function0<Collection<FunctionDescriptor>>() {
                    /* class kotlin.reflect.jvm.internal.impl.descriptors.impl.FunctionDescriptorImpl.C691691 */
        ...
        for (ValueParameterDescriptor valueParameterDescriptor : list) {
            ...
            if (valueParameterDescriptor instanceof ValueParameterDescriptorImpl.WithDestructuringDeclaration) {
                ...
                r17 = new Function0<List<VariableDescriptor>>() {
                    /* class kotlin.reflect.jvm.internal.impl.descriptors.impl.FunctionDescriptorImpl.C691702 */
            ...
            if (z2) {
                sourceElement = valueParameterDescriptor.getSource();
            } else {
                sourceElement = SourceElement.NO_SOURCE;
            }
            arrayList.add(ValueParameterDescriptorImpl.createWithDestructuringDeclarations(functionDescriptor, valueParameterDescriptor2, index, annotations, name, substitute, declaresDefaultValue, isCrossinline, isNoinline, substitute2, sourceElement, r17));
        }
        return arrayList;
    }
