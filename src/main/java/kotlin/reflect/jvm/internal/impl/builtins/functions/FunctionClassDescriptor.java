...
public final class FunctionClassDescriptor extends AbstractClassDescriptor {
        ...
        public static final class Companion {
            ...
            public final Kind byClassNamePrefix(FqName fqName, String str) {
                ...
                for (Kind kind : values) {
                    if (!Intrinsics.areEqual(kind.getPackageFqName(), fqName) || !StringsKt.startsWith$default(str, kind.getClassNamePrefix(), false, 2, (Object) null)) {
                        z = false;
                    } else {
                        z = true;
                    }
    ...
    public FunctionClassDescriptor(StorageManager storageManager2, PackageFragmentDescriptor packageFragmentDescriptor, Kind kind, int i) {
        ...
        C691431 r6 = new Function2<Variance, String, Unit>(this) {
            /* class kotlin.reflect.jvm.internal.impl.builtins.functions.FunctionClassDescriptor.C691431 */
        ...
        IntRange kVar = new IntRange(1, i);
        ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(kVar, 10));
