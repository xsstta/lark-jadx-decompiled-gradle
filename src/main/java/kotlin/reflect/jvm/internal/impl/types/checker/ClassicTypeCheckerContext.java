...
public class ClassicTypeCheckerContext extends AbstractTypeCheckerContext implements ClassicTypeSystemContext {
    ...
    public SimpleTypeMarker captureFromArguments(SimpleTypeMarker simpleTypeMarker, CaptureStatus captureStatus) {
        Intrinsics.checkParameterIsNotNull(simpleTypeMarker, ShareHitPoint.f121869d);
        Intrinsics.checkParameterIsNotNull(captureStatus, UpdateKey.STATUS);
    ...
    public boolean areEqualTypeConstructors(TypeConstructor typeConstructor, TypeConstructor typeConstructor2) {
        Intrinsics.checkParameterIsNotNull(typeConstructor, AbstractC60044a.f149675a);
        Intrinsics.checkParameterIsNotNull(typeConstructor2, C63954b.f161494a);
    ...
    public boolean areEqualTypeConstructors(TypeConstructorMarker typeConstructorMarker, TypeConstructorMarker typeConstructorMarker2) {
        Intrinsics.checkParameterIsNotNull(typeConstructorMarker, AbstractC60044a.f149675a);
        Intrinsics.checkParameterIsNotNull(typeConstructorMarker2, C63954b.f161494a);
