...
public class TypeCheckingProcedure {
    ...
    public static /* synthetic */ class C692771 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                kotlin.reflect.jvm.internal.impl.types.checker.TypeCheckingProcedure.C692771.$SwitchMap$org$jetbrains$kotlin$types$Variance = r0
            ...
            L_0x0012:
                int[] r0 = kotlin.reflect.jvm.internal.impl.types.checker.TypeCheckingProcedure.C692771.$SwitchMap$org$jetbrains$kotlin$types$Variance     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = kotlin.reflect.jvm.internal.impl.types.checker.TypeCheckingProcedure.C692771.$SwitchMap$org$jetbrains$kotlin$types$Variance     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.types.checker.TypeCheckingProcedure.C692771.<clinit>():void");
        }
    }
    ...
    public enum EnrichedProjectionKind {
        ...
        public static EnrichedProjectionKind fromVariance(Variance variance) {
            ...
            int i = C692771.$SwitchMap$org$jetbrains$kotlin$types$Variance[variance.ordinal()];
            if (i == 1) {
    ...
    private static KotlinType getInType(TypeParameterDescriptor typeParameterDescriptor, TypeProjection typeProjection) {
        ...
        if (z) {
            kotlinType = DescriptorUtilsKt.getBuiltIns(typeParameterDescriptor).getNothingType();
        } else {
    ...
    private static KotlinType getOutType(TypeParameterDescriptor typeParameterDescriptor, TypeProjection typeProjection) {
        ...
        if (z) {
            kotlinType = DescriptorUtilsKt.getBuiltIns(typeParameterDescriptor).getNullableAnyType();
        } else {
            kotlinType = typeProjection.getType();
        }
        if (kotlinType == null) {
    ...
    public boolean isSubtypeOf(KotlinType kotlinType, KotlinType kotlinType2) {
        ...
        } else if (!kotlinType.isMarkedNullable() || kotlinType2.isMarkedNullable()) {
            return true;
        } else {
            return false;
        }
