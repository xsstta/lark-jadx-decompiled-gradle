...
public final class AnnotationTypeQualifierResolverKt {
    ...
    private static final Set<FqName> BUILT_IN_TYPE_QUALIFIER_FQ_NAMES = am.m265689a((Object[]) new FqName[]{JvmAnnotationNamesKt.getJAVAX_NONNULL_ANNOTATION(), JvmAnnotationNamesKt.getJAVAX_CHECKFORNULL_ANNOTATION()});
