    ...
    public final class ClassEnhancementBuilder {
        ...
        public final class FunctionEnhancementBuilder {
            ...
            public final void returns(JvmPrimitiveType jvmPrimitiveType) {
                Intrinsics.checkParameterIsNotNull(jvmPrimitiveType, ShareHitPoint.f121869d);
            ...
            public final void parameter(String str, JavaTypeQualifiers... javaTypeQualifiersArr) {
                ...
                if (z) {
                    ...
                    Iterable<IndexedValue> n = C69043h.m265789n(javaTypeQualifiersArr);
                    ...
                    for (IndexedValue xVar : n) {
                        linkedHashMap.put(Integer.valueOf(xVar.mo239099a()), (JavaTypeQualifiers) xVar.mo239100b());
                    }
