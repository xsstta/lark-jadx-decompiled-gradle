                ...
                if (z) {
                    ...
                    if (!(indices instanceof Collection) || !((Collection) indices).isEmpty()) {
                        ...
                        while (it.hasNext()) {
                            ...
                            if (!doesValueConformToExpectedType((ConstantValue) ((List) arrayValue.getValue()).get(b), arrayElementType, arrayElement)) {
                                return false;
                            }
                        }
                    }
        ...
        if (type != null) {
            switch (WhenMappings.$EnumSwitchMapping$0[type.ordinal()]) {
                ...
                case 3:
                    ...
                    if (booleanValue) {
                        constantValue2 = new UShortValue(intValue2);
                    } else {
                        constantValue2 = new ShortValue(intValue2);
                    }
                    return constantValue2;
                case 4:
                    int intValue3 = (int) value.getIntValue();
                    if (booleanValue) {
                        constantValue3 = new UIntValue(intValue3);
                    } else {
                        constantValue3 = new IntValue(intValue3);
                    }
                    return constantValue3;
                case 5:
                    long intValue4 = value.getIntValue();
                    if (booleanValue) {
                        constantValue4 = new ULongValue(intValue4);
                    } else {
                        constantValue4 = new LongValue(intValue4);
                    }
