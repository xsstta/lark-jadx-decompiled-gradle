...
public final class MemberDeserializer$getAnnotations$1 extends Lambda implements Function0<List<? extends AnnotationDescriptor>> {
    ...
    public final List<? extends AnnotationDescriptor> invoke() {
        ...
        if (asProtoContainer != null) {
            list = CollectionsKt.toList(this.this$0.f173274c.getComponents().getAnnotationAndConstantLoader().loadCallableAnnotations(asProtoContainer, this.$proto, this.$kind));
        } else {
            list = null;
        }
        if (list != null) {
