...
public final class KotlinTypeFactory$simpleTypeWithNonTrivialMemberScope$1 extends Lambda implements Function1<KotlinTypeRefiner, SimpleType> {
    ...
    public final SimpleType invoke(KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        KotlinTypeFactory.ExpandedTypeOrRefinedConstructor refineConstructor = KotlinTypeFactory.INSTANCE.refineConstructor(this.$constructor, kotlinTypeRefiner, this.$arguments);
