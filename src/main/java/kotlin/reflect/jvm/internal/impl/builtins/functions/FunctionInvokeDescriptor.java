...
public final class FunctionInvokeDescriptor extends SimpleFunctionDescriptorImpl {
    ...
    public static final class Factory {
        ...
        public final FunctionInvokeDescriptor create(FunctionClassDescriptor functionClassDescriptor, boolean z) {
            ...
            for (IndexedValue xVar : withIndex) {
                arrayList2.add(FunctionInvokeDescriptor.Factory.createValueParameter(functionInvokeDescriptor, xVar.mo239099a(), (TypeParameterDescriptor) xVar.mo239100b()));
            }
    ...
    private final FunctionDescriptor replaceParameterNames(List<Name> list) {
        ...
        if (!_Assertions.f173221a || z) {
            ...
            FunctionDescriptorImpl.CopyConfiguration original = newCopyBuilder.setHasSynthesizedParameterNames(z3).setValueParameters((List<ValueParameterDescriptor>) arrayList2).setOriginal((CallableMemberDescriptor) getOriginal());
