...
public final class JavaToKotlinClassMap {
    ...
    private final boolean isKotlinFunctionWithBigArity(FqNameUnsafe fqNameUnsafe, String str) {
        ...
        if (!z || StringsKt.startsWith$default((CharSequence) str2, '0', false, 2, (Object) null) || (intOrNull = StringsKt.toIntOrNull(substringAfter)) == null || intOrNull.intValue() < 23) {
            return false;
        }
        return true;
    }
    ...
    public final Collection<ClassDescriptor> mapPlatformClass(FqName fqName, KotlinBuiltIns kotlinBuiltIns) {
        ...
        if (fqName2 == null) {
            return am.m265686a(mapJavaToKotlin$default);
        }
