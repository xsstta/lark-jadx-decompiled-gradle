...
public class PropertyDescriptorImpl extends VariableDescriptorWithInitializerImpl implements PropertyDescriptor {
    ...
    public PropertyDescriptor getOriginal() {
        ...
        if (propertyDescriptor2 == this) {
            propertyDescriptor = this;
        } else {
            propertyDescriptor = propertyDescriptor2.getOriginal();
        }
        if (propertyDescriptor == null) {
            $$$reportNull$$$0(33);
        }
    ...
    private static Visibility normalizeVisibility(Visibility visibility2, CallableMemberDescriptor.Kind kind2) {
        if (kind2 != CallableMemberDescriptor.Kind.FAKE_OVERRIDE || !Visibilities.isPrivate(visibility2.normalize())) {
            return visibility2;
        }
