...
public final class CodedOutputStream {
    ...
    public void writeRawVarint32(int i) throws IOException {
        while ((i & -128) != 0) {
            writeRawByte((i & SmActions.ACTION_ONTHECALL_ENTRY) | SmActions.ACTION_ONTHECALL_EXIT);
            i >>>= 7;
        }
        writeRawByte(i);
    }
    ...
    public void writeRawVarint64(long j) throws IOException {
        while ((-128 & j) != 0) {
            writeRawByte((((int) j) & SmActions.ACTION_ONTHECALL_ENTRY) | SmActions.ACTION_ONTHECALL_EXIT);
            j >>>= 7;
        }
        writeRawByte((int) j);
    }
