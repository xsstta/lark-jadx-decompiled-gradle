...
public final class LazyJavaTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    /* renamed from: c */
    private final LazyJavaResolverContext f173272c;
    ...
    public List<KotlinType> resolveUpperBounds() {
        ...
        if (upperBounds.isEmpty()) {
            SimpleType anyType = this.f173272c.getModule().getBuiltIns().getAnyType();
            Intrinsics.checkExpressionValueIsNotNull(anyType, "c.module.builtIns.anyType");
            SimpleType nullableAnyType = this.f173272c.getModule().getBuiltIns().getNullableAnyType();
        ...
        while (it.hasNext()) {
            arrayList.add(this.f173272c.getTypeResolver().transformJavaType(it.next(), JavaTypeResolverKt.toAttributes$default(TypeUsage.COMMON, false, this, 1, null)));
        }
        return arrayList;
    }
    ...
    public LazyJavaTypeParameterDescriptor(LazyJavaResolverContext lazyJavaResolverContext, JavaTypeParameter javaTypeParameter2, int i, DeclarationDescriptor declarationDescriptor) {
        ...
        this.f173272c = lazyJavaResolverContext;
