...
public final class DescriptorRendererOptionsImpl implements DescriptorRendererOptions {
    ...
    private final ReadWriteProperty excludedAnnotationClasses$delegate = property(am.m265687a());
            ...
            if ((field.getModifiers() & 8) == 0) {
                ...
                if (bVar != null) {
                    ...
                    if (!_Assertions.f173221a || startsWith$default) {
                        ...
                        field.set(descriptorRendererOptionsImpl, descriptorRendererOptionsImpl.property(bVar.getValue(this, new PropertyReference1Impl(Reflection.getOrCreateKotlinClass(DescriptorRendererOptionsImpl.class), name2, sb.toString()))));
                    } else {
    ...
    private final <T> ReadWriteProperty<DescriptorRendererOptionsImpl, T> property(T t) {
        Delegates aVar = Delegates.f173052a;
