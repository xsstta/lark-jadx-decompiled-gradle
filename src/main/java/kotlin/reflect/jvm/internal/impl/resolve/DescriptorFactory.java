...
public class DescriptorFactory {
    ...
    public static boolean isEnumValueOfMethod(FunctionDescriptor functionDescriptor) {
        ...
        if (!functionDescriptor.getName().equals(DescriptorUtils.ENUM_VALUE_OF) || !isEnumSpecialMethod(functionDescriptor)) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isEnumValuesMethod(FunctionDescriptor functionDescriptor) {
        ...
        if (!functionDescriptor.getName().equals(DescriptorUtils.ENUM_VALUES) || !isEnumSpecialMethod(functionDescriptor)) {
            return false;
        }
        return true;
    }
