...
import kotlin.reflect.jvm.C69130b;
...
public abstract class KCallableImpl<R> implements KCallable<R> {
    ...
    public final Type extractContinuationArgument() {
        ...
        Object f = C69043h.m265781f(actualTypeArguments);
        ...
        return (Type) C69043h.m265771c(lowerBounds);
    }
    ...
    public final R callDefaultMethod$kotlin_reflection(Map<KParameter, ? extends Object> map, Continuation<?> cVar) {
        Intrinsics.checkParameterIsNotNull(map, "args");
        List<KParameter> parameters = getParameters();
        ...
        for (KParameter kParameter : parameters) {
            ...
            if (map.containsKey(kParameter)) {
                ...
                arrayList.add(defaultPrimitiveValue(C69130b.m266086a(kParameter.getType())));
                i2 = (1 << (i % 32)) | i2;
                z = true;
            } else {
