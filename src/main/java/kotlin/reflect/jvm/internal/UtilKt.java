...
public final class UtilKt {
    ...
    public static final Class<?> toJavaClass(ClassDescriptor classDescriptor) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(source, ShareHitPoint.f121868c);
    ...
    public static final <M extends MessageLite, D extends CallableDescriptor> D deserializeToDescriptor(Class<?> cls, M m, NameResolver nameResolver, TypeTable typeTable, BinaryVersion binaryVersion, Function2<? super MemberDeserializer, ? super M, ? extends D> kVar) {
        ...
        Intrinsics.checkParameterIsNotNull(kVar, "createDescriptor");
        ...
        return (D) ((CallableDescriptor) kVar.invoke(new MemberDeserializer(new DeserializationContext(deserialization, nameResolver, module, typeTable, empty, binaryVersion, null, null, typeParameterList)), m));
    }
}
