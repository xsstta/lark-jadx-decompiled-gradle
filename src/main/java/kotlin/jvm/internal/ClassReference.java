...
public final class ClassReference implements ClassBasedDeclarationContainer, KClass<Object> {
    ...
    /* renamed from: a */
    public static final Map<Class<? extends Function<?>>, Integer> f173192a;

    /* renamed from: b */
    public static final HashMap<String, String> f173193b;

    /* renamed from: c */
    public static final Map<String, String> f173194c;

    /* renamed from: d */
    public static final Companion f173195d = new Companion(null);

    /* renamed from: f */
    private static final HashMap<String, String> f173196f;

    /* renamed from: g */
    private static final HashMap<String, String> f173197g;

    /* renamed from: e */
    private final Class<?> f173198e;

    @Metadata(bv = {1, 0, 3}, d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\u000b\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0014\u0010\u000f\u001a\u0004\u0018\u00010\n2\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u0005J\u0014\u0010\u0011\u001a\u0004\u0018\u00010\n2\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u0005J\u001c\u0010\u0012\u001a\u00020\u00132\b\u0010\u0014\u001a\u0004\u0018\u00010\u00012\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u0005R&\u0010\u0003\u001a\u001a\u0012\u0010\u0012\u000e\u0012\n\b\u0001\u0012\u0006\u0012\u0002\b\u00030\u00060\u0005\u0012\u0004\u0012\u00020\u00070\u0004X\u0004¢\u0006\u0002\n\u0000R*\u0010\b\u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\tj\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n`\u000bX\u0004¢\u0006\u0002\n\u0000R*\u0010\f\u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\tj\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n`\u000bX\u0004¢\u0006\u0002\n\u0000R*\u0010\r\u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\tj\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n`\u000bX\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\u000e\u001a\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0015"}, d2 = {"Lkotlin/jvm/internal/ClassReference$Companion;", "", "()V", "FUNCTION_CLASSES", "", "Ljava/lang/Class;", "Lkotlin/Function;", "", "classFqNames", "Ljava/util/HashMap;", "", "Lkotlin/collections/HashMap;", "primitiveFqNames", "primitiveWrapperFqNames", "simpleNames", "getClassQualifiedName", "jClass", "getClassSimpleName", "isInstance", "", "value", "kotlin-stdlib"}, mo238835k = 1, mv = {1, 1, 16})
    ...
    public static final class Companion {
        ...
        /* renamed from: b */
        public final String mo239328b(Class<?> cls) {
            String str;
            ...
            if (cls.isArray()) {
                ...
                if (componentType.isPrimitive() && (str = ClassReference.f173193b.get(componentType.getName())) != null) {
                    str2 = str + "Array";
                }
                if (str2 != null) {
                    return str2;
            ...
            String str3 = ClassReference.f173193b.get(cls.getName());
            if (str3 != null) {
                return str3;
            }
        ...
        public final java.lang.String mo239326a(java.lang.Class<?> r8) {
            /*
            // Method dump skipped, instructions count: 190
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlin.jvm.internal.ClassReference.Companion.mo239326a(java.lang.Class):java.lang.String");
        }

        /* renamed from: a */
        public final boolean mo239327a(Object obj, Class<?> cls) {
            Intrinsics.checkParameterIsNotNull(cls, "jClass");
            Map<Class<? extends Function<?>>, Integer> map = ClassReference.f173192a;
            if (map != null) {
                Integer num = map.get(cls);
                if (num != null) {
                    return C69121n.m265983a(obj, num.intValue());
                }
                if (cls.isPrimitive()) {
                    cls = C69113a.m265958c(C69113a.m265955a((Class) cls));
                }
    ...
    public String getQualifiedName() {
        return f173195d.mo239328b(getJClass());
    }

    @Override // kotlin.reflect.KClass
    public String getSimpleName() {
        return f173195d.mo239326a(getJClass());
    }
    ...
    static {
        ...
        f173192a = MapsKt.toMap(arrayList);
        ...
        for (T t : values) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(t, "kotlinName");
        ...
        for (Map.Entry<Class<? extends Function<?>>, Integer> entry : f173192a.entrySet()) {
    ...
    public boolean isInstance(Object obj) {
        return f173195d.mo239327a(obj, getJClass());
    }

    @Override // kotlin.reflect.KClass
    public boolean equals(Object obj) {
        if (!(obj instanceof ClassReference) || !Intrinsics.areEqual(C69113a.m265958c(this), C69113a.m265958c((KClass) obj))) {
            return false;
        }
        return true;
    }
