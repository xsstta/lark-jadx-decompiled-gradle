...
class C69337r extends C69336q {
    ...
    public static final Appendable appendln(Appendable appendable) {
        ...
        Appendable append = appendable.append(SystemProperties.f173373a);
    ...
    public static final StringBuilder appendln(StringBuilder sb) {
        ...
        sb.append(SystemProperties.f173373a);
