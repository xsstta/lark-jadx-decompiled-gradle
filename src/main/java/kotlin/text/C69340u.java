...
public class C69340u extends C69339t {
    ...
    public static final Integer toIntOrNull(String str, int i) {
        ...
        int i6 = -59652323;
        while (i5 < length) {
            int a = C69321a.m266163a(str.charAt(i5), i);
            if (a < 0) {
                return null;
            }
    ...
    public static final java.lang.Long toLongOrNull(java.lang.String r18, int r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.text.C69340u.toLongOrNull(java.lang.String, int):java.lang.Long");
    }
}
