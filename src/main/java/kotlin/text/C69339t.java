...
class C69339t extends C69338s {
    ...
    public static final BigDecimal toBigDecimalOrNull(String str) {
        ...
        try {
            if (ScreenFloatValueRegEx.f173367a.matches(str)) {
                return new BigDecimal(str);
            }
            return null;
    ...
    private static final BigInteger toBigInteger(String str, int i) {
        return new BigInteger(str, C69321a.m266164a(i));
    }

    private static final byte toByte(String str, int i) {
        return Byte.parseByte(str, C69321a.m266164a(i));
    }

    private static final int toInt(String str, int i) {
        return Integer.parseInt(str, C69321a.m266164a(i));
    }

    private static final long toLong(String str, int i) {
        return Long.parseLong(str, C69321a.m266164a(i));
    }

    private static final short toShort(String str, int i) {
        return Short.parseShort(str, C69321a.m266164a(i));
    }

    private static final String toString(int i, int i2) {
        String num = Integer.toString(i, C69321a.m266164a(i2));
    ...
    private static final String toString(byte b, int i) {
        String num = Integer.toString(b, C69321a.m266164a(C69321a.m266164a(i)));
        Intrinsics.checkExpressionValueIsNotNull(num, "java.lang.Integer.toStri…(this, checkRadix(radix))");
        return num;
    }
    ...
    private static final String toString(long j, int i) {
        String l = Long.toString(j, C69321a.m266164a(i));
    ...
    public static final BigInteger toBigIntegerOrNull(String str, int i) {
        ...
        if (length != 1) {
            ...
            while (i2 < length) {
                if (C69321a.m266163a(str.charAt(i2), i) < 0) {
                    return null;
                }
                i2++;
            }
        } else if (C69321a.m266163a(str.charAt(0), i) < 0) {
            return null;
        }
        return new BigInteger(str, C69321a.m266164a(i));
    }
    ...
    private static final String toString(short s, int i) {
        String num = Integer.toString(s, C69321a.m266164a(C69321a.m266164a(i)));
        Intrinsics.checkExpressionValueIsNotNull(num, "java.lang.Integer.toStri…(this, checkRadix(radix))");
        return num;
    }
}
