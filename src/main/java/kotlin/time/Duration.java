...
public final class Duration implements Comparable<Duration> {
    ...
    /* renamed from: c */
    public static final boolean m266207c(double d) {
        return d < ((double) 0);
    }

    /* renamed from: i */
    public static double m266213i(double d) {
        return d;
    }

    /* renamed from: j */
    public static int m266214j(double d) {
        long doubleToLongBits = Double.doubleToLongBits(d);
        return (int) (doubleToLongBits ^ (doubleToLongBits >>> 32));
    }

    /* renamed from: a */
    public final /* synthetic */ double mo242607a() {
        return this.f173382d;
    }

    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u0006\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J&\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\u000b2\n\u0010\r\u001a\u00060\u000ej\u0002`\u000f2\n\u0010\u0010\u001a\u00060\u000ej\u0002`\u000fR\u0016\u0010\u0003\u001a\u00020\u0004ø\u0001\u0000¢\u0006\n\n\u0002\u0010\u0007\u001a\u0004\b\u0005\u0010\u0006R\u0016\u0010\b\u001a\u00020\u0004ø\u0001\u0000¢\u0006\n\n\u0002\u0010\u0007\u001a\u0004\b\t\u0010\u0006\u0002\u0004\n\u0002\b\u0019¨\u0006\u0011"}, d2 = {"Lkotlin/time/Duration$Companion;", "", "()V", "INFINITE", "Lkotlin/time/Duration;", "getINFINITE", "()D", "D", "ZERO", "getZERO", "convert", "", "value", "sourceUnit", "Ljava/util/concurrent/TimeUnit;", "Lkotlin/time/DurationUnit;", "targetUnit", "kotlin-stdlib"}, mo238835k = 1, mv = {1, 1, 16})
    ...
    public static final class Companion {
        ...
        /* renamed from: a */
        public final double mo242613a() {
            return Duration.f173379a;
        }
    ...
    public int hashCode() {
        return m266214j(this.f173382d);
    }

    public String toString() {
        return m266212h(this.f173382d);
    }

    /* renamed from: b */
    public static final double m266204b(double d) {
        return m266213i(-d);
    }

    /* renamed from: d */
    public static final boolean m266208d(double d) {
        return Double.isInfinite(d);
    }

    /* renamed from: f */
    public static final double m266210f(double d) {
        return m266202a(d, TimeUnit.MILLISECONDS);
    }

    /* renamed from: g */
    public static final double m266211g(double d) {
        return m266202a(d, TimeUnit.NANOSECONDS);
    }

    public boolean equals(Object obj) {
        return m266203a(this.f173382d, obj);
    }

    /* renamed from: e */
    public static final double m266209e(double d) {
        if (m266207c(d)) {
            return m266204b(d);
        }
        return d;
    ...
    public /* synthetic */ int compareTo(Duration bVar) {
        return mo242608a(bVar.mo242607a());
    }

    /* renamed from: a */
    public int mo242608a(double d) {
        return m266205b(this.f173382d, d);
    }
    ...
    public static java.lang.String m266212h(double r8) {
        /*
        // Method dump skipped, instructions count: 193
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.time.Duration.m266212h(double):java.lang.String");
    }

    /* renamed from: a */
    public static final double m266201a(double d, double d2) {
        return m266213i(d - d2);
    }

    /* renamed from: a */
    public static final double m266202a(double d, TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return C69353d.m266221a(d, C69352c.m266220a(), timeUnit);
    }

    /* renamed from: b */
    public static int m266205b(double d, double d2) {
