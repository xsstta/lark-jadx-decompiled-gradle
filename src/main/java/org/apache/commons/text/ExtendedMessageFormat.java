...
public class ExtendedMessageFormat extends MessageFormat {
    ...
    private final Map<String, ? extends AbstractC69974b> registry;
    ...
    private Format getFormat(String str) {
        ...
        if (this.registry != null) {
            ...
            AbstractC69974b bVar = (AbstractC69974b) this.registry.get(str);
            if (bVar != null) {
                return bVar.mo246205a(str, str2, getLocale());
            }
        }
        return null;
    }
    ...
    public ExtendedMessageFormat(String str, Map<String, ? extends AbstractC69974b> map) {
    ...
    private void seekNonWs(String str, ParsePosition parsePosition) {
        char[] charArray = str.toCharArray();
        do {
            int a = C69973c.f174835a.mo246202d().mo246198a(charArray, parsePosition.getIndex(), 0, charArray.length);
    ...
    public ExtendedMessageFormat(String str, Locale locale, Map<String, ? extends AbstractC69974b> map) {
        super("");
        setLocale(locale);
        this.registry = map;
        applyPattern(str);
