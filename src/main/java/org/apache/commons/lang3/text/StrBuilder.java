...
public class StrBuilder implements Serializable, Appendable, CharSequence {
    ...
    class C69884a extends Reader {

        /* renamed from: b */
        private int f174725b;

        /* renamed from: c */
        private int f174726c;
        ...
        public void reset() {
            this.f174725b = this.f174726c;
        }

        @Override // java.io.Reader
        public boolean ready() {
            if (this.f174725b < StrBuilder.this.size()) {
                return true;
            }
            return false;
        }
        ...
        public void mark(int i) {
            this.f174726c = this.f174725b;
        }

        @Override // java.io.Reader
        public long skip(long j) {
            if (((long) this.f174725b) + j > ((long) StrBuilder.this.size())) {
                j = (long) (StrBuilder.this.size() - this.f174725b);
            }
            if (j < 0) {
                return 0;
            }
            this.f174725b = (int) (((long) this.f174725b) + j);
            return j;
        }
        ...
        public int read(char[] cArr, int i, int i2) {
            ...
            if (i < 0 || i2 < 0 || i > cArr.length || (i3 = i + i2) > cArr.length || i3 < 0) {
                ...
                if (this.f174725b + i2 > StrBuilder.this.size()) {
                    i2 = StrBuilder.this.size() - this.f174725b;
                }
                StrBuilder strBuilder = StrBuilder.this;
                int i4 = this.f174725b;
    ...
    class C69885b extends C69893c {
        C69885b() {
        }

        /* access modifiers changed from: protected */
        @Override // org.apache.commons.lang3.text.C69893c
        /* renamed from: a */
        public List<String> mo245612a(char[] cArr, int i, int i2) {
            if (cArr == null) {
                return super.mo245612a(StrBuilder.this.buffer, 0, StrBuilder.this.size());
            }
            return super.mo245612a(cArr, i, i2);
        }
    }

    /* renamed from: org.apache.commons.lang3.text.StrBuilder$c */
    class C69886c extends Writer {
    ...
    public int lastIndexOf(AbstractC69888b bVar) {
    ...
    public StrBuilder deleteAll(AbstractC69888b bVar) {
        return replace(bVar, null, 0, this.size, -1);
    }

    public StrBuilder deleteFirst(AbstractC69888b bVar) {
        return replace(bVar, null, 0, this.size, 1);
    }
    ...
    public boolean contains(AbstractC69888b bVar) {
        if (indexOf(bVar, 0) >= 0) {
            return true;
        }
        return false;
    ...
    public int indexOf(AbstractC69888b bVar) {
    ...
    public StrBuilder replaceAll(AbstractC69888b bVar, String str) {
        return replace(bVar, str, 0, this.size, -1);
    }

    public StrBuilder replaceFirst(AbstractC69888b bVar, String str) {
        return replace(bVar, str, 0, this.size, 1);
    }
    ...
    public int indexOf(AbstractC69888b bVar, int i) {
        int i2;
        if (i < 0) {
            i = 0;
        }
        if (bVar != null && i < (i2 = this.size)) {
            ...
            for (int i3 = i; i3 < i2; i3++) {
                if (bVar.mo245622a(cArr, i3, i, i2) > 0) {
                    return i3;
                }
            }
        }
    ...
    public int lastIndexOf(AbstractC69888b bVar, int i) {
        int i2 = this.size;
        if (i >= i2) {
            i = i2 - 1;
        }
        if (bVar != null && i >= 0) {
            ...
            int i3 = i + 1;
            while (i >= 0) {
                if (bVar.mo245622a(cArr, i, 0, i3) > 0) {
                    return i;
                }
                i--;
            }
    ...
    public StrBuilder replace(AbstractC69888b bVar, String str, int i, int i2, int i3) {
    ...
    private StrBuilder replaceImpl(AbstractC69888b bVar, String str, int i, int i2, int i3) {
        int i4;
        if (!(bVar == null || this.size == 0)) {
            ...
            int i5 = i;
            while (i5 < i2 && i3 != 0) {
                int a = bVar.mo245622a(this.buffer, i5, i, i2);
                if (a > 0) {
