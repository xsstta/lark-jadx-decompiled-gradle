...
public class ExtendedMessageFormat extends MessageFormat {
    ...
    private final Map<String, ? extends AbstractC69887a> registry;
    ...
    private Format getFormat(String str) {
        ...
        if (this.registry != null) {
            ...
            AbstractC69887a aVar = (AbstractC69887a) this.registry.get(str);
            if (aVar != null) {
                return aVar.mo245620a(str, str2, getLocale());
            }
        }
        return null;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !super.equals(obj) || ObjectUtils.m268056c(getClass(), obj.getClass())) {
            return false;
        }
        ExtendedMessageFormat extendedMessageFormat = (ExtendedMessageFormat) obj;
        if (ObjectUtils.m268056c(this.toPattern, extendedMessageFormat.toPattern)) {
            return false;
        }
        return !ObjectUtils.m268056c(this.registry, extendedMessageFormat.registry);
    }
    ...
    public ExtendedMessageFormat(String str, Map<String, ? extends AbstractC69887a> map) {
    ...
    private void seekNonWs(String str, ParsePosition parsePosition) {
        char[] charArray = str.toCharArray();
        do {
            int a = AbstractC69888b.m268193c().mo245621a(charArray, parsePosition.getIndex());
    ...
    public ExtendedMessageFormat(String str, Locale locale, Map<String, ? extends AbstractC69887a> map) {
        super("");
        setLocale(locale);
        this.registry = map;
        applyPattern(str);
