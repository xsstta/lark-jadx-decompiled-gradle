...
public class SodiumJNI {
    ...
    public static final native int crypto_kdf_derive_from_key(byte[] bArr, int i, int i2, byte[] bArr2, byte[] bArr3);

    public static final native int crypto_kdf_keybytes();
