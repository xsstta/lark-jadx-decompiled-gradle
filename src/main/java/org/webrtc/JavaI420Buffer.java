...
public class JavaI420Buffer implements VideoFrame.I420Buffer {
    ...
    public static JavaI420Buffer allocate(int i, int i2) {
        ...
        return new JavaI420Buffer(i, i2, slice, i, slice2, i4, nativeAllocateByteBuffer.slice(), i4, new Runnable(nativeAllocateByteBuffer) {
            /* class org.webrtc.$$Lambda$JavaI420Buffer$tLdFcnEJPvUgP_4so0PE2olQFIo */
    ...
    public static JavaI420Buffer allocate(int i, int i2, int i3, int i4) {
        ...
        return new JavaI420Buffer(i, i2, slice, i3, slice2, i5, nativeAllocateByteBuffer.slice(), i5, new Runnable(nativeAllocateByteBuffer) {
            /* class org.webrtc.$$Lambda$JavaI420Buffer$eBIT7JWbpeRBhlaB3aWaWElFt4A */
            public final /* synthetic */ ByteBuffer f$0;
        ...
        if (i3 == i5) {
            if (i4 == i6) {
                ...
                return wrap(i5, i6, slice, strideY2, slice2, strideU2, slice3, strideV2, new Runnable() {
                    /* class org.webrtc.$$Lambda$FfxWPyMokL4ipT13gerwg4i1dc */
