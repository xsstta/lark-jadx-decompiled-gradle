...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, RendererCommon.RendererEvents, VideoSink {
    ...
    public void setRadius(float f) {
        this.radius = Math.max((float) BitmapDescriptorFactory.HUE_RED, f);
    }
    ...
    private void logD(String str) {
        Logging.m268870d("SurfaceViewRenderer", this.resourceName + ": " + str);
    }
    ...
    public void onFrameResolutionChanged(int i, int i2, int i3) {
        ...
        postOrRun(new Runnable(i4, i) {
            /* class org.webrtc.$$Lambda$SurfaceViewRenderer$uj7L95NBBBpJVS0clP3By7sJwBs */
