...
public class CameraEnumerationAndroid {
    static final ArrayList<Size> COMMON_RESOLUTIONS = new ArrayList<>(Arrays.asList(new Size(160, SmEvents.EVENT_NW), new Size(240, 160), new Size(320, 240), new Size(MediaPlayer.MEDIA_PLAYER_OPTION_USE_CODEC_POOL, 240), new Size(480, 320), new Size(640, 360), new Size(640, 480), new Size(768, 480), new Size(854, 480), new Size(800, 600), new Size(960, 540), new Size(960, 640), new Size(1024, 576), new Size(1024, 600), new Size(1280, 720), new Size(1280, 1024), new Size(1920, 1080), new Size(1920, CalendarWorkHourUtil.f83805a), new Size(2560, CalendarWorkHourUtil.f83805a), new Size(3840, 2160)));
    ...
    public static CaptureFormat.FramerateRange getClosestSupportedFramerateRange(List<CaptureFormat.FramerateRange> list, final int i) {
        return (CaptureFormat.FramerateRange) Collections.min(list, new ClosestComparator<CaptureFormat.FramerateRange>() {
            /* class org.webrtc.CameraEnumerationAndroid.C701131 */
    ...
    public static Size getClosestSupportedSize(List<Size> list, final int i, final int i2) {
        return (Size) Collections.min(list, new ClosestComparator<Size>() {
            /* class org.webrtc.CameraEnumerationAndroid.C701142 */
