...
public class GlShader {
    ...
    private static int compileShader(int i, String str) {
        ...
        if (glCreateShader != 0) {
            ...
            Log.e("GlShader", "Compile error " + GLES20.glGetShaderInfoLog(glCreateShader) + " in shader:\n" + str);
    ...
    public GlShader(String str, String str2) {
        ...
        if (glCreateProgram != 0) {
            ...
            Log.e("GlShader", "Could not link program: " + GLES20.glGetProgramInfoLog(this.program));
