...
class NativeLibrary {
    ...
    static class DefaultLoader implements NativeLibraryLoader {
        ...
        public boolean load(String str) {
            ...
            Logging.m268870d(str2, "Loading library: " + str);
            try {
                C1711a.m7628a(str);
                return true;
            } catch (UnsatisfiedLinkError e) {
                String str3 = NativeLibrary.TAG;
                Logging.m268872e(str3, "Failed to load native library: " + str, e);
                return false;
            }
        }
    }
    ...
    static void initialize(NativeLibraryLoader nativeLibraryLoader, String str) {
        synchronized (lock) {
            if (libraryLoaded) {
                Logging.m268870d(TAG, "Native library has already been loaded.");
            ...
            String str2 = TAG;
            Logging.m268870d(str2, "Loading native library: " + str);
