...
public class Logging {
    ...
    public static /* synthetic */ class C701261 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                org.webrtc.Logging.C701261.$SwitchMap$org$webrtc$Logging$Severity = r0
                org.webrtc.Logging$Severity r1 = org.webrtc.Logging.Severity.LS_ERROR     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = org.webrtc.Logging.C701261.$SwitchMap$org$webrtc$Logging$Severity     // Catch:{ NoSuchFieldError -> 0x001d }
                org.webrtc.Logging$Severity r1 = org.webrtc.Logging.Severity.LS_WARNING     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = org.webrtc.Logging.C701261.$SwitchMap$org$webrtc$Logging$Severity     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.webrtc.Logging.C701261.<clinit>():void");
        }
    }
    ...
    /* renamed from: d */
    public static void m268870d(String str, String str2) {
        log(Severity.LS_INFO, str, str2);
    }

    /* renamed from: e */
    public static void m268871e(String str, String str2) {
    ...
    /* renamed from: v */
    public static void m268873v(String str, String str2) {
        log(Severity.LS_VERBOSE, str, str2);
    }

    /* renamed from: w */
    public static void m268874w(String str, String str2) {
    ...
    /* renamed from: e */
    public static void m268872e(String str, String str2, Throwable th) {
        log(Severity.LS_ERROR, str, str2);
    ...
    /* renamed from: w */
    public static void m268875w(String str, String str2, Throwable th) {
        log(Severity.LS_WARNING, str, str2);
    ...
    public static void log(Severity severity, String str, String str2) {
        ...
        if (str == null || str2 == null) {
            ...
            int i = C701261.$SwitchMap$org$webrtc$Logging$Severity[severity.ordinal()];
            if (i == 1) {
                level = Level.SEVERE;
            } else if (i == 2) {
                level = Level.WARNING;
