...
public class Camera1Enumerator implements CameraEnumerator {
    ...
    public String[] getDeviceNames() {
        ...
        for (int i = 0; i < Camera.getNumberOfCameras(); i++) {
            ...
            if (deviceName != null) {
                ...
                Logging.m268870d("Camera1Enumerator", "Index: " + i + ". " + deviceName);
            } else {
                Logging.m268871e("Camera1Enumerator", "Index: " + i + ". Failed to query camera name.");
            }
        }
    ...
    private static Camera.CameraInfo getCameraInfo(int i) {
        ...
        try {
            ...
            Logging.m268872e("Camera1Enumerator", "getCameraInfo failed on index " + i, e);
            return null;
        }
    }
    ...
    static int getCameraIndex(String str) {
        Logging.m268870d("Camera1Enumerator", "getCameraIndex: " + str);
        for (int i = 0; i < Camera.getNumberOfCameras(); i++) {
    ...
    private static List<CameraEnumerationAndroid.CaptureFormat> enumerateFormats(int i) {
        int i2;
        Logging.m268870d("Camera1Enumerator", "Get supported formats for camera index " + i + ".");
        long elapsedRealtime = SystemClock.elapsedRealtime();
        Camera camera = null;
        try {
            Logging.m268870d("Camera1Enumerator", "Opening camera with index " + i);
            ...
            try {
                ...
                Logging.m268872e("Camera1Enumerator", "getSupportedFormats() failed on camera index " + i, e);
            }
            long elapsedRealtime2 = SystemClock.elapsedRealtime();
            Logging.m268870d("Camera1Enumerator", "Get supported formats for camera index " + i + " done. Time spent: " + (elapsedRealtime2 - elapsedRealtime) + " ms.");
            return arrayList;
        } catch (RuntimeException e2) {
            Logging.m268872e("Camera1Enumerator", "Open camera failed on camera index " + i, e2);
