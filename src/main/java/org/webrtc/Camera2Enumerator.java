...
public class Camera2Enumerator implements CameraEnumerator {
    ...
    public String[] getDeviceNames() {
        try {
            ...
            Logging.m268871e("Camera2Enumerator", "Camera access exception: " + e);
            return new String[0];
        }
    }
    ...
    static List<CameraEnumerationAndroid.CaptureFormat> getSupportedFormats(CameraManager cameraManager2, String str) {
        ...
        synchronized (map) {
            ...
            Logging.m268870d("Camera2Enumerator", "Get supported formats for camera index " + str + ".");
            ...
            try {
                ...
                for (Size size : supportedSizes) {
                    ...
                    if (j == 0) {
                        ...
                        i = ((int) Math.round(1.0E9d / ((double) j))) * 1000;
                    }
                    arrayList.add(new CameraEnumerationAndroid.CaptureFormat(size.width, size.height, 0, i));
                    Logging.m268870d("Camera2Enumerator", "Format: " + size.width + "x" + size.height + "@" + i);
                }
                cachedSupportedFormats.put(str, arrayList);
                long elapsedRealtime2 = SystemClock.elapsedRealtime();
                Logging.m268870d("Camera2Enumerator", "Get supported formats for camera index " + str + " done. Time spent: " + (elapsedRealtime2 - elapsedRealtime) + " ms.");
                return arrayList;
            } catch (Exception e) {
                Logging.m268871e("Camera2Enumerator", "getCameraCharacteristics(): " + e);
