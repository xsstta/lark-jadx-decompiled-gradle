...
/* renamed from: io.michaelrocks.libphonenumber.android.c */
public class C68244c {
    /* renamed from: a */
    static Map<Integer, List<String>> m264945a() {
        ...
        arrayList48.add("MA");
        arrayList48.add("EH");
        hashMap.put(Integer.valueOf((int) TTVideoEngine.PLAYER_OPTION_SET_SUPER_RES_STRENGTH), arrayList48);
        ArrayList arrayList49 = new ArrayList(1);
        arrayList49.add("DZ");
        hashMap.put(213, arrayList49);
        ArrayList arrayList50 = new ArrayList(1);
        arrayList50.add("TN");
        hashMap.put(Integer.valueOf((int) SmEvents.EVENT_MEETING_LICENSE_TIME_OUT), arrayList50);
        ArrayList arrayList51 = new ArrayList(1);
        arrayList51.add("LY");
        hashMap.put(Integer.valueOf((int) SmEvents.EVENT_AUTO_END), arrayList51);
        ...
        arrayList88.add("UG");
        hashMap.put(Integer.valueOf((int) DynamicModule.f58006b), arrayList88);
        ...
        arrayList136.add("FK");
        hashMap.put(Integer.valueOf((int) ParticipantRepo.f117150c), arrayList136);
