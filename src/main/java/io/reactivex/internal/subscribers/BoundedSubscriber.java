...
public final class BoundedSubscriber<T> extends AtomicReference<AbstractC70022d> implements Disposable, AbstractC68325i<T>, AbstractC70022d {
    ...
    public void onNext(T t) {
        if (!isDisposed()) {
            try {
                ...
                if (i == this.limit) {
                    this.consumed = 0;
                    ((AbstractC70022d) get()).request((long) this.limit);
                    return;
                }
                this.consumed = i;
            } catch (Throwable th) {
    ...
    public BoundedSubscriber(Consumer<? super T> consumer, Consumer<? super Throwable> consumer2, AbstractC68309a aVar, Consumer<? super AbstractC70022d> consumer3, int i) {
