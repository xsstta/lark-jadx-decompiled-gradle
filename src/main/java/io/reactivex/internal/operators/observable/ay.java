...
public final class ay<T, R> extends AbstractC68651a<T, R> {

    /* renamed from: b */
    final Function<? super T, ? extends AbstractC68990l<? extends R>> f172247b;

    /* renamed from: c */
    final boolean f172248c;

    /* renamed from: io.reactivex.internal.operators.observable.ay$a */
    static final class C68692a<T, R> extends AtomicInteger implements Disposable, AbstractC69009q<T> {
        ...
        /* renamed from: io.reactivex.internal.operators.observable.ay$a$a */
        final class C68693a extends AtomicReference<Disposable> implements Disposable, AbstractC68989k<R> {
            ...
            public void onComplete() {
                C68692a.this.innerComplete(this);
            }
            ...
            public void onError(Throwable th) {
                C68692a.this.innerError(this, th);
            }

            @Override // io.reactivex.AbstractC68989k
            public void onSuccess(R r) {
                C68692a.this.innerSuccess(this, r);
            }
        }
        ...
        /* access modifiers changed from: package-private */
        public void innerComplete(C68692a<T, R>.C68693a aVar) {
        ...
        /* access modifiers changed from: package-private */
        public void innerError(C68692a<T, R>.C68693a aVar, Throwable th) {
            this.set.mo237941c(aVar);
            if (this.errors.addThrowable(th)) {
                if (!this.delayErrors) {
                    this.upstream.dispose();
        ...
        /* access modifiers changed from: package-private */
        public void innerSuccess(C68692a<T, R>.C68693a aVar, R r) {
            this.set.mo237941c(aVar);
            if (get() == 0) {
                boolean z = false;
                if (compareAndSet(0, 1)) {
        ...
        C68692a(AbstractC69009q<? super R> qVar, Function<? super T, ? extends AbstractC68990l<? extends R>> function, boolean z) {
    ...
    public void subscribeActual(AbstractC69009q<? super R> qVar) {
        this.f172123a.subscribe(new C68692a(qVar, this.f172247b, this.f172248c));
    }

    public ay(ObservableSource<T> observableSource, Function<? super T, ? extends AbstractC68990l<? extends R>> function, boolean z) {
        super(observableSource);
        this.f172247b = function;
        this.f172248c = z;
    }
}
