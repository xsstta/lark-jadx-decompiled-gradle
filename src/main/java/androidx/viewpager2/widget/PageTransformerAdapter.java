...
public final class PageTransformerAdapter extends ViewPager2.AbstractC1603e {
    private final LinearLayoutManager mLayoutManager;
    private ViewPager2.AbstractC1608g mPageTransformer;
    ...
    /* access modifiers changed from: package-private */
    public ViewPager2.AbstractC1608g getPageTransformer() {
        return this.mPageTransformer;
    }

    /* access modifiers changed from: package-private */
    public void setPageTransformer(ViewPager2.AbstractC1608g gVar) {
    ...
    public void onPageScrolled(int i, float f, int i2) {
        if (this.mPageTransformer != null) {
            ...
            for (int i3 = 0; i3 < this.mLayoutManager.getChildCount(); i3++) {
                ...
                if (childAt != null) {
                    this.mPageTransformer.mo8353a(childAt, ((float) (this.mLayoutManager.getPosition(childAt) - i)) + f2);
                } else {
