...
public abstract class Lifecycle {
    ...
    public enum Event {
        ...
        public static Event downFrom(State state) {
            int i = C11171.f4179a[state.ordinal()];
            if (i == 1) {
                return ON_DESTROY;
            }
            if (i == 2) {
    ...
    static /* synthetic */ class C11171 {
        ...
        /* renamed from: b */
        static final /* synthetic */ int[] f4180b;
        ...
        static {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.Lifecycle.C11171.<clinit>():void");
        }
    }
