...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* renamed from: a */
    private static int m1621a(View view) {
        int q = ViewCompat.m4102q(view);
        if (q > 0) {
            return q;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m1621a(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: b */
    private void m1624b(int i, int i2) {
    ...
    /* renamed from: a */
    private boolean m1623a(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        m1624b(childCount, i2);
        return true;
    }

    /* renamed from: a */
    private void m1622a(View view, int i, int i2, int i3, int i4) {
