...
public class C0533e extends AbstractC0528b {

    /* renamed from: a */
    private double[] f1959a;

    /* renamed from: b */
    private double[][] f1960b;

    /* renamed from: c */
    private double[][] f1961c;

    /* renamed from: a */
    private static double m2444a(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d2 * d2;
        double d8 = d7 * d2;
        double d9 = 3.0d * d7;
        double d10 = d * d6;
    ...
    /* renamed from: b */
    private static double m2445b(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d2 * d2;
        double d8 = d2 * 6.0d;
        double d9 = 3.0d * d;
    ...
    public double mo3098a(double d, int i) {
        ...
        int i2 = 0;
        if (d <= dArr[0]) {
            return this.f1960b[0][i];
        }
        int i3 = length - 1;
        if (d >= dArr[i3]) {
            return this.f1960b[i3][i];
        }
        while (i2 < i3) {
            double[] dArr2 = this.f1959a;
            if (d == dArr2[i2]) {
                return this.f1960b[i2][i];
            }
            int i4 = i2 + 1;
            if (d < dArr2[i4]) {
                double d2 = dArr2[i4] - dArr2[i2];
                double d3 = (d - dArr2[i2]) / d2;
                double[][] dArr3 = this.f1960b;
                double d4 = dArr3[i2][i];
                double d5 = dArr3[i4][i];
                double[][] dArr4 = this.f1961c;
                return m2444a(d2, d3, d4, d5, dArr4[i2][i], dArr4[i4][i]);
            }
            i2 = i4;
        }
        return 0.0d;
    ...
    public double mo3102b(double d, int i) {
        ...
        while (i2 < length - 1) {
            ...
            if (d2 <= dArr2[i4]) {
                ...
                double d5 = dArr3[i4][i];
                double[][] dArr4 = this.f1961c;
                return m2445b(d3, (d2 - dArr2[i2]) / d3, d4, d5, dArr4[i2][i], dArr4[i4][i]) / d3;
            }
            i2 = i4;
        }
        return 0.0d;
    ...
    public C0533e(double[] dArr, double[][] dArr2) {
        int length = dArr.length;
    ...
    public void mo3099a(double d, double[] dArr) {
        ...
        int i = 0;
        int length2 = this.f1960b[0].length;
        if (d <= dArr2[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                dArr[i2] = this.f1960b[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        while (i4 < i3) {
            ...
            if (d < dArr3[i6]) {
                ...
                while (i < length2) {
                    ...
                    double[][] dArr5 = this.f1961c;
                    dArr[i] = m2444a(d2, d3, d4, d5, dArr5[i4][i], dArr5[i6][i]);
                    i++;
                }
                return;
            }
        ...
        while (i2 < length - 1) {
            ...
            if (d2 <= dArr3[i3]) {
                ...
                for (int i4 = 0; i4 < length2; i4++) {
                    ...
                    double[][] dArr5 = this.f1961c;
                    dArr[i4] = m2445b(d3, d4, d5, d6, dArr5[i2][i4], dArr5[i3][i4]) / d3;
                }
                return;
            }
            i2 = i3;
    ...
    public void mo3100a(double d, float[] fArr) {
        ...
        if (d <= dArr[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                fArr[i2] = (float) this.f1960b[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        while (i4 < i3) {
            if (d == this.f1959a[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    fArr[i5] = (float) this.f1960b[i4][i5];
                }
            }
            double[] dArr2 = this.f1959a;
            int i6 = i4 + 1;
            if (d < dArr2[i6]) {
                ...
                while (i < length2) {
                    ...
                    double[][] dArr4 = this.f1961c;
                    fArr[i] = (float) m2444a(d2, d3, d4, d5, dArr4[i4][i], dArr4[i6][i]);
                    i++;
                }
                return;
            }
