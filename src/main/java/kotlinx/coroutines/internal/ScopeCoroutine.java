...
public class ScopeCoroutine<T> extends AbstractCoroutine<T> implements CoroutineStackFrame {
    ...
    /* renamed from: c */
    public final Continuation<T> f173864c;
    ...
    public final CoroutineStackFrame getCallerFrame() {
        return (CoroutineStackFrame) this.f173864c;
    }

    /* renamed from: q */
    public final Job mo243051q() {
        return (Job) this.a_.get(Job.f173460b);
    }
    ...
    public void mo242633c(Object obj) {
        Continuation<T> cVar = this.f173864c;
        cVar.resumeWith(C69584w.m267323a(obj, cVar));
    }
    ...
    public ScopeCoroutine(CoroutineContext fVar, Continuation<? super T> cVar) {
        super(fVar, true);
        this.f173864c = cVar;
    }
}
