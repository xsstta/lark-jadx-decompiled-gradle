...
@DebugMetadata(mo239172c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$2", mo239173f = "Zip.kt", mo239174i = {0}, mo239175l = {253}, mo239176m = "invokeSuspend", mo239177n = {"$this$flow"}, mo239178s = {"L$0"})
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransform$2 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public FlowKt__ZipKt$combineTransform$$inlined$combineTransform$2(Flow[] aVarArr, Continuation cVar, Function5 qVar) {
        super(2, cVar);
        this.$flows = aVarArr;
    ...
    public final Object invoke(Object obj, Continuation<? super Unit> cVar) {
        return ((FlowKt__ZipKt$combineTransform$$inlined$combineTransform$2) create(obj, cVar)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    @DebugMetadata(mo239172c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$2$2", mo239173f = "Zip.kt", mo239174i = {}, mo239175l = {}, mo239176m = "invokeSuspend", mo239177n = {}, mo239178s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$2$2 */
    public static final class C693942 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
        Object L$0;
        Object L$1;
        int label;
        private FlowCollector p$;
        ...
        public final Continuation<Unit> create(FlowCollector<? super R> bVar, Object[] objArr, Continuation<? super Unit> cVar) {
            C693942 r0 = new C693942(this.this$0, cVar);
            r0.p$ = bVar;
            r0.p$0 = objArr;
            return r0;
        }
        ...
        public final Object invoke(Object obj, Object[] objArr, Continuation<? super Unit> cVar) {
            return ((C693942) create((FlowCollector) obj, objArr, cVar)).invokeSuspend(Unit.INSTANCE);
        }

        public final Object invokeSuspend$$forInline(Object obj) {
            FlowCollector bVar = this.p$;
            Object[] objArr = this.p$0;
            this.this$0.$transform$inlined.invoke(bVar, objArr[0], objArr[1], objArr[2], this);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (C69470f.m266891a(bVar, this.$flows, new Function0<Object[]>(this) {
                /* class kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$2.C693931 */
                final /* synthetic */ FlowKt__ZipKt$combineTransform$$inlined$combineTransform$2 this$0;
