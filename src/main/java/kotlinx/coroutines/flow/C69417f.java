...
final /* synthetic */ class C69417f {
    ...
    public static final class C69418a implements FlowCollector<T> {

        /* renamed from: a */
        final /* synthetic */ Function2 f173566a;

        @Override // kotlinx.coroutines.flow.FlowCollector
        public Object emit(T t, Continuation<? super Unit> cVar) {
            return this.f173566a.invoke(t, cVar);
        }
    }

    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0019\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u0019\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00028\u0000H@ø\u0001\u0000¢\u0006\u0002\u0010\u0007R\u000e\u0010\u0002\u001a\u00020\u0003X\u000e¢\u0006\u0002\n\u0000\u0002\u0004\n\u0002\b\u0019¨\u0006\b"}, d2 = {"kotlinx/coroutines/flow/FlowKt__CollectKt$collectIndexed$2", "Lkotlinx/coroutines/flow/FlowCollector;", "index", "", "emit", "", "value", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, mo238835k = 1, mv = {1, 1, 16})
    /* renamed from: kotlinx.coroutines.flow.f$b */
    public static final class C69419b implements FlowCollector<T> {

        /* renamed from: a */
        final /* synthetic */ Function3 f173567a;

        /* renamed from: b */
        private int f173568b;

        @Override // kotlinx.coroutines.flow.FlowCollector
        public Object emit(T t, Continuation<? super Unit> cVar) {
            Function3 oVar = this.f173567a;
            int i = this.f173568b;
            this.f173568b = i + 1;
            if (i >= 0) {
                return oVar.invoke(C69089a.m265839a(i), t, cVar);
            }
