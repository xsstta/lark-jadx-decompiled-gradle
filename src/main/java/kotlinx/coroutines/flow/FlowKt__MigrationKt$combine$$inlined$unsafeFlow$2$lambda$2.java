...
@DebugMetadata(mo239172c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2", mo239173f = "Zip.kt", mo239174i = {0, 0}, mo239175l = {240}, mo239176m = "invokeSuspend", mo239177n = {"$receiver", "it"}, mo239178s = {"L$0", "L$1"})
public final class FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
    ...
    public FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2(Continuation cVar, C69532o.C69537e eVar) {
        super(3, cVar);
        this.this$0 = eVar;
    }

    public final Continuation<Unit> create(FlowCollector<? super R> bVar, T[] tArr, Continuation<? super Unit> cVar) {
        FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2 flowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2 = new FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2(cVar, this.this$0);
        flowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2.p$ = bVar;
    ...
    public final Object invoke(Object obj, Object obj2, Continuation<? super Unit> cVar) {
        return ((FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2) create((FlowCollector) obj, (Object[]) obj2, cVar)).invokeSuspend(Unit.INSTANCE);
    }

    public final Object invokeSuspend$$forInline(Object obj) {
        FlowCollector bVar = this.p$;
        Object invoke = this.this$0.f173771b.invoke(this.p$0, this);
        C69117h.m265970a(0);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object invoke = this.this$0.f173771b.invoke(objArr, this);
            this.L$0 = bVar;
            this.L$1 = objArr;
            this.label = 1;
