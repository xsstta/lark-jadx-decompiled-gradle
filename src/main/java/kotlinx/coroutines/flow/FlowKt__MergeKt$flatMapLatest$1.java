...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u00042\u0006\u0010\u0005\u001a\u0002H\u0002H@¢\u0006\u0004\b\u0006\u0010\u0007"}, d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;", "it", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"}, mo238835k = 3, mv = {1, 1, 16})
@DebugMetadata(mo239172c = "kotlinx.coroutines.flow.FlowKt__MergeKt$flatMapLatest$1", mo239173f = "Merge.kt", mo239174i = {0, 0, 1, 1, 1, 1}, mo239175l = {190, SmEvents.EVENT_MEETING_LICENSE_TIME_OUT}, mo239176m = "invokeSuspend", mo239177n = {"$this$transformLatest", "it", "$this$transformLatest", "it", "$this$emitAll$iv", "flow$iv"}, mo239178s = {"L$0", "L$1", "L$0", "L$1", "L$2", "L$3"})
public final class FlowKt__MergeKt$flatMapLatest$1 extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
    ...
    public FlowKt__MergeKt$flatMapLatest$1(Function2 kVar, Continuation cVar) {
        super(3, cVar);
        this.$transform = kVar;
    }
    ...
    public final Continuation<Unit> create(FlowCollector<? super R> bVar, T t, Continuation<? super Unit> cVar) {
        ...
        flowKt__MergeKt$flatMapLatest$1.p$ = bVar;
    ...
    public final Object invoke(Object obj, Object obj2, Continuation<? super Unit> cVar) {
        return ((FlowKt__MergeKt$flatMapLatest$1) create((FlowCollector) obj, obj2, cVar)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        C69117h.m265970a(0);
        ((Flow) this.$transform.invoke(obj2, this)).mo242938a(bVar, this);
        C69117h.m265970a(2);
        C69117h.m265970a(1);
