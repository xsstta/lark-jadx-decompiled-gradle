...
public final class LazyStandaloneCoroutine extends StandaloneCoroutine {
    ...
    /* renamed from: c */
    private final Continuation<Unit> f173484c;

    /* access modifiers changed from: protected */
    @Override // kotlinx.coroutines.AbstractCoroutine
    public void cG_() {
        C69358a.m266240a(this.f173484c, this);
    }

    public LazyStandaloneCoroutine(CoroutineContext fVar, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> kVar) {
        super(fVar, false);
        this.f173484c = C69086a.m265827a(kVar, this, this);
    }
}
