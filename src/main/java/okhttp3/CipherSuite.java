...
public final class CipherSuite {
    ...
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_256_CBC_SHA256 = of("TLS_DHE_RSA_WITH_AES_256_CBC_SHA256", ActivityIdentificationData.WALKING);
    ...
    public static final CipherSuite TLS_DH_anon_WITH_AES_256_CBC_SHA256 = of("TLS_DH_anon_WITH_AES_256_CBC_SHA256", SmEvents.EVENT_NR);
    ...
    public static final CipherSuite TLS_PSK_WITH_AES_256_CBC_SHA = of("TLS_PSK_WITH_AES_256_CBC_SHA", SmActions.ACTION_IDLE_ENTRY);
    ...
    static {
        C696491 r0 = new Comparator<String>() {
            /* class okhttp3.CipherSuite.C696491 */
