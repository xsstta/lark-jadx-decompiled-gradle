...
public final class ConnectionPool {
    ...
    public ConnectionPool(int i, long j, TimeUnit timeUnit) {
        this.cleanupRunnable = new Runnable() {
            /* class okhttp3.ConnectionPool.RunnableC696501 */
            ...
            public void run() {
                ...
                L_0x002d:
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: okhttp3.ConnectionPool.RunnableC696501.run():void");
            }
        };
