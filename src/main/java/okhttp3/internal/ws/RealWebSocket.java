...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        newWebSocketCall.enqueue(new Callback() {
            /* class okhttp3.internal.ws.RealWebSocket.C696882 */
    ...
    public static abstract class Streams implements Closeable {
        ...
        public final AbstractC69698d sink;
        public final AbstractC69699e source;

        public Streams(boolean z, AbstractC69699e eVar, AbstractC69698d dVar) {
            this.client = z;
            this.source = eVar;
            this.sink = dVar;
        }
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2, long j) {
        if ("GET".equals(request.method())) {
            ...
            this.writerRunnable = new Runnable() {
                /* class okhttp3.internal.ws.RealWebSocket.RunnableC696871 */
