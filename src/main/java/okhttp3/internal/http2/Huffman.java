...
class Huffman {
    ...
    public static final class Node {
        ...
        Node() {
            this.children = new Node[DynamicModule.f58006b];
        }
    ...
    /* access modifiers changed from: package-private */
    public void encode(ByteString byteString, AbstractC69698d dVar) throws IOException {
        int i = 0;
        long j = 0;
        byte b = 0;
        while (i < byteString.size()) {
            ...
            while (i4 >= 8) {
                i4 = (i4 == 1 ? 1 : 0) - 8;
                dVar.mo244562k((int) (j >> i4));
            }
            i++;
            b = i4;
        }
        if (b > 0) {
            dVar.mo244562k((int) (((long) (255 >>> b)) | (j << (8 - b))));
        }
    }
