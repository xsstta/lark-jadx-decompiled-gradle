...
public final class Http2Reader implements Closeable {
    ...
    public interface Handler {
        ...
        void data(boolean z, int i, AbstractC69699e eVar, int i2) throws IOException;
    ...
    /* access modifiers changed from: package-private */
    public static final class ContinuationSource implements AbstractC69723u {
        byte flags;
        int left;
        int length;
        short padding;
        ...
        ContinuationSource(AbstractC69699e eVar) {
            this.source = eVar;
        }
    ...
    static int readMedium(AbstractC69699e eVar) throws IOException {
    ...
    Http2Reader(AbstractC69699e eVar, boolean z) {
        this.source = eVar;
        this.client = z;
