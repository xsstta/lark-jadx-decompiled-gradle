...
public final class CacheInterceptor implements Interceptor {
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        AbstractC69722t body;
        if (cacheRequest == null || (body = cacheRequest.body()) == null) {
            return response;
        }
        final AbstractC69699e source = response.body().source();
        final AbstractC69698d a = C69705k.m267589a(body);
        return response.newBuilder().body(new RealResponseBody(response.header("Content-Type"), response.body().contentLength(), C69705k.m267590a(new AbstractC69723u() {
            /* class okhttp3.internal.cache.CacheInterceptor.C696651 */
            ...
            public long read(C69694c cVar, long j) throws IOException {
                try {
                    ...
                    cVar.mo244522a(a.buffer(), cVar.mo244510a() - read, read);
                    a.mo244560j();
                    return read;
                } catch (IOException e) {
                    if (!this.cacheRequestClosed) {
