...
public abstract class OutputStreamRequestBody extends RequestBody {
    ...
    public final C69724v timeout() {
        return this.timeout;
    }

    /* access modifiers changed from: protected */
    public void initOutputStream(final AbstractC69698d dVar, final long j) {
        this.timeout = dVar.timeout();
        this.expectedContentLength = j;
        this.outputStream = new OutputStream() {
            /* class okhttp3.internal.huc.OutputStreamRequestBody.C696851 */
