...
public abstract class HuaweiApiAvailability {
    ...
    public static final int HMS_SDK_VERSION_CODE = 50005300;
    public static final String HMS_SDK_VERSION_NAME = "5.0.5.300";
    ...
    /* renamed from: a */
    private static final Map<String, Integer> f57800a;

    public abstract AbstractC23432f<Void> checkApiAccessible(HuaweiApi<?> huaweiApi, HuaweiApi<?>... huaweiApiArr);

    public abstract AbstractC23432f<Void> checkApiAccessible(HuaweiApiCallable huaweiApiCallable, HuaweiApiCallable... huaweiApiCallableArr);
    ...
    public abstract AbstractC23432f<Void> getHuaweiServicesReady(Activity activity);
