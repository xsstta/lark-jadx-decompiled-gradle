...
public class C23532f extends C23531e {
    /* access modifiers changed from: protected */
    @Override // com.huawei.hms.core.aidl.C23531e
    /* renamed from: a */
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (obj.getClass().isPrimitive() || (obj instanceof String) || (obj instanceof Serializable)) {
                ...
                if (i3 == 1) {
                    ...
                    arrayList.add(mo82641a(bundle2, (IMessageEntity) ((Class) ((ParameterizedType) type).getActualTypeArguments()[0]).newInstance()));
                } else {
    ...
    public void mo82644a(String str, List list, Bundle bundle) {
        ...
        for (int i = 0; i < list.size(); i++) {
            mo82643a("_list_item_" + i, list.get(i), bundle2);
        }
