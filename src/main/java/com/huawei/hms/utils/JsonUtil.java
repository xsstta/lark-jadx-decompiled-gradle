...
public class JsonUtil {
    ...
    private static byte[] readByte(JSONObject jSONObject) throws JSONException {
        try {
            ...
            HMSLog.m86964e(TAG, "readByte failed : " + e.getMessage());
            return null;
        }
    }
    ...
    public static String createJsonString(IMessageEntity iMessageEntity) {
        if (iMessageEntity == null) {
            HMSLog.m86964e(TAG, "createJsonString error, the input IMessageEntity is null");
            return "";
        }
        try {
            return createInnerJsonString(iMessageEntity);
        } catch (IllegalAccessException e) {
            HMSLog.m86964e(TAG, "catch IllegalAccessException " + e.getMessage());
            return "";
        } catch (JSONException e2) {
            HMSLog.m86964e(TAG, "catch JSONException " + e2.getMessage());
            return "";
        }
    }
    ...
    private static void setAccessible(final Field field, final boolean z) {
        AccessController.doPrivileged(new PrivilegedAction() {
            /* class com.huawei.hms.utils.JsonUtil.C238031 */
    ...
    public static Object getInfoFromJsonobject(String str, String str2) {
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
            try {
                ...
                HMSLog.m86964e(TAG, "getInfoFromJsonobject:parser json error :" + str2);
            }
        }
        return null;
    }
                ...
                for (Field field : declaredFields) {
                    if (field.isAnnotationPresent(Packed.class)) {
                        try {
                            ...
                            HMSLog.m86964e(TAG, "jsonToEntity, set value of the field exception, field name:" + field.getName());
                        }
                    }
                }
            }
        } catch (JSONException e) {
            HMSLog.m86964e(TAG, "catch JSONException when parse jsonString" + e.getMessage());
        }
    ...
    private static void writeByte(String str, byte[] bArr, JSONObject jSONObject) throws JSONException {
        ...
        try {
            ...
            HMSLog.m86964e(TAG, "writeByte failed : " + e.getMessage());
        }
        ...
        if (obj instanceof String) {
            ...
            if (obj instanceof IMessageEntity) {
                try {
                    ...
                    HMSLog.m86964e(TAG, "IllegalAccessException , " + e);
                }
            }
            return false;
        }
            ...
            try {
                ...
                if (i != 1) {
                    if (i != 0) {
                        ...
                        HMSLog.m86964e(TAG, "cannot support type : " + i);
                    }
                }
