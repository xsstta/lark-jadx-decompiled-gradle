...
public class PackageManagerHelper {
    ...
    /* renamed from: a */
    public final PackageManager f58972a;
    ...
    public PackageManagerHelper(Context context) {
        this.f58972a = context.getPackageManager();
    }

    public int getPackageVersionCode(String str) {
        try {
            PackageInfo packageInfo = this.f58972a.getPackageInfo(str, 16);
            if (packageInfo != null) {
    ...
    public PackageStates getPackageStates(String str) {
        ...
        try {
            if (this.f58972a.getApplicationInfo(str, 0).enabled) {
    ...
    /* renamed from: a */
    public final byte[] mo85520a(String str) {
        try {
            PackageInfo packageInfo = this.f58972a.getPackageInfo(str, 64);
            if (!(packageInfo == null || packageInfo.signatures == null || packageInfo.signatures.length <= 0)) {
                return packageInfo.signatures[0].toByteArray();
            }
        } catch (PackageManager.NameNotFoundException e) {
            HMSLog.m86964e("PackageManagerHelper", "Failed to get application signature certificate fingerprint." + e.getMessage());
        }
        HMSLog.m86964e("PackageManagerHelper", "Failed to get application signature certificate fingerprint.");
        return new byte[0];
    }

    public boolean hasProvider(String str, String str2) {
        try {
            PackageInfo packageInfo = this.f58972a.getPackageInfo(str, 8);
    ...
    public boolean verifyPackageArchive(String str, String str2, String str3) {
        PackageInfo packageArchiveInfo = this.f58972a.getPackageArchiveInfo(str, 64);
