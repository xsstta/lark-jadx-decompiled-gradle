...
public class ForegroundInnerHeader {
    ...
    public String toJson() {
        ...
        try {
            ...
            HMSLog.m86964e("ForegroundInnerHeader", "ForegroundInnerHeader toJson failed: " + e.getMessage());
        }
    ...
    public void fromJson(String str) {
        try {
            ...
            HMSLog.m86964e("ForegroundInnerHeader", "fromJson failed: " + e.getMessage());
        }
    }
}
