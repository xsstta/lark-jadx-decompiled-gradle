    ...
    public static byte[] decode(String str) {
        ...
        if (str != null) {
            try {
                ...
                HMSLog.m86964e(TAG, "decode failed : " + e.getMessage());
            }
        }
        return bArr;
    }
    ...
    public static byte[] decodeUrlSafe(String str) {
        ...
        if (str != null) {
            try {
                ...
                HMSLog.m86964e(TAG, "decodeUrlSafe failed : " + e.getMessage());
            }
        }
        return bArr;
    }
    ...
    public static byte[] decodeUrlSafeNoPadding(String str) {
        ...
        if (str != null) {
            try {
                ...
                HMSLog.m86964e(TAG, "decodeUrlSafeNoPadding failed : " + e.getMessage());
            }
        }
        return bArr;
    }
