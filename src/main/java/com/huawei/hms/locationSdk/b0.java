...
public class b0 extends c0<C23667r, Void> {
    ...
    public void doExecute(C23667r rVar, ResponseErrorCode responseErrorCode, String str, C23433g<Void> gVar) {
        try {
            u0.m86106c("AddGeofencesTaskApiCall", this.f58396a, "doExecute");
            ...
            u0.m86105b("AddGeofencesTaskApiCall", str2, "doExecute exception:" + e.getMessage());
            gVar.mo81845a(e);
        } catch (Exception unused) {
            u0.m86105b("AddGeofencesTaskApiCall", this.f58396a, "doExecute exception");
