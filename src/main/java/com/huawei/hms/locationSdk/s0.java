...
public class s0 extends c0<C23663p, Void> {
    ...
    public void doExecute(C23663p pVar, ResponseErrorCode responseErrorCode, String str, C23433g<Void> gVar) {
        try {
            u0.m86106c("SetMockModeTaskApiCall", this.f58396a, "doExecute");
            z0.m86140a().mo83549a(gVar, responseErrorCode, null);
        } catch (Exception unused) {
            u0.m86105b("SetMockModeTaskApiCall", this.f58396a, "doExecute exception");
