...
public class StringUtils {
    ...
    public static String byte2Str(byte[] bArr) {
        ...
        try {
            ...
            Logger.m85375w("StringUtils.byte2str error: UnsupportedEncodingException", e);
            return "";
        }
    }
    ...
    public static byte[] getBytes(String str) {
        ...
        try {
            ...
            Logger.m85375w(TAG, "the content has error while it is converted to bytes");
            return bArr;
        }
    }
    ...
    public static byte[] str2Byte(String str) {
        ...
        try {
            ...
            Logger.m85375w("StringUtils.str2Byte error: UnsupportedEncodingException", e);
            return new byte[0];
        }
    }
    ...
    public static int stringToInteger(String str, int i) {
        ...
        try {
            ...
            Logger.m85376w(TAG, "String to Integer catch NumberFormatException.", e);
            return i;
        }
    }
    ...
    public static long stringToLong(String str, long j) {
        ...
        try {
            ...
            Logger.m85376w(TAG, "String to Long catch NumberFormatException.", e);
            return j;
        }
    }
