...
public class UpdateSdkFileProvider extends ContentProvider {
    ...
    private static AbstractC23904a mWStrategy;
    ...
    private static synchronized AbstractC23904a createWiseDistPathStrategy(Context context, String str) {
        AbstractC23904a aVar;
        synchronized (UpdateSdkFileProvider.class) {
            if (mWStrategy == null) {
                mWStrategy = new C23905b(str);
                if (context.getFilesDir() != null) {
                    mWStrategy.mo85717a("updatesdkapk", buildPath(context.getFilesDir(), "/"));
                }
            }
            aVar = mWStrategy;
        }
    ...
    public static Uri getUriForFile(Context context, String str, File file) {
        ...
        return mWStrategy.mo85715a(file);
    }
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) throws FileNotFoundException {
        ...
        File a = mWStrategy.mo85716a(uri);
        if (a.getName().endsWith("apk")) {
            return ParcelFileDescriptor.open(a, 268435456);
        }
        C23834a.m87118b(TAG, "can not open this file.");
        return null;
    }
