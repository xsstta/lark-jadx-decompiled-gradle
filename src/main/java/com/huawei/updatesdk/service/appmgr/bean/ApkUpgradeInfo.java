...
public class ApkUpgradeInfo extends AbstractC23866b implements Parcelable, Serializable {
    public static final int APP_MUST_UPDATE = 1;
    public static final Parcelable.Creator<ApkUpgradeInfo> CREATOR = new C23906a();
    ...
    static class C23906a implements Parcelable.Creator<ApkUpgradeInfo> {
        C23906a() {
        }
