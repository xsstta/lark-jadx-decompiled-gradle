...
final class zzub extends zzua {
    ...
    private static int zza(byte[] bArr, int i, long j, int i2) {
        ...
        if (i2 == 1) {
            return zzty.zzb(i, zztv.zza(bArr, j));
        }
        if (i2 == 2) {
            return zzty.zzb(i, zztv.zza(bArr, j), zztv.zza(bArr, j + 1));
        }
    ...
    public final int zza(int r16, byte[] r17, int r18, int r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.libraries.places.internal.zzub.zza(int, byte[], int, int):int");
    }
    ...
    public final int zza(java.lang.CharSequence r23, byte[] r24, int r25, int r26) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.libraries.places.internal.zzub.zza(java.lang.CharSequence, byte[], int, int):int");
    }
}
