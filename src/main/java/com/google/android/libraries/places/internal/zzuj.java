...
public interface zzuj {
    ...
    void zza(int i, zzpx zzpx) throws IOException;

    <K, V> void zza(int i, zzsb<K, V> zzsb, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzsx zzsx) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzsx zzsx) throws IOException;
    ...
    void zzb(int i, Object obj, zzsx zzsx) throws IOException;

    void zzb(int i, List<zzpx> list) throws IOException;

    void zzb(int i, List<?> list, zzsx zzsx) throws IOException;
