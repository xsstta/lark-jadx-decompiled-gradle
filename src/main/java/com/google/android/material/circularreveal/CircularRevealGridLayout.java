...
public class CircularRevealGridLayout extends GridLayout implements AbstractC22213b {

    /* renamed from: a */
    private final CircularRevealHelper f54275a;

    @Override // com.google.android.material.circularreveal.AbstractC22213b
    public void Y_() {
        this.f54275a.mo77254b();
    }

    @Override // com.google.android.material.circularreveal.AbstractC22213b
    /* renamed from: a */
    public void mo77235a() {
        this.f54275a.mo77249a();
    }
    ...
    public Drawable getCircularRevealOverlayDrawable() {
        return this.f54275a.mo77257e();
    }

    @Override // com.google.android.material.circularreveal.AbstractC22213b
    public int getCircularRevealScrimColor() {
        return this.f54275a.mo77256d();
    }

    @Override // com.google.android.material.circularreveal.AbstractC22213b
    public AbstractC22213b.C22218d getRevealInfo() {
        return this.f54275a.mo77255c();
    }

    public boolean isOpaque() {
        CircularRevealHelper circularRevealHelper = this.f54275a;
    ...
    public void setCircularRevealOverlayDrawable(Drawable drawable) {
        this.f54275a.mo77252a(drawable);
    }

    @Override // com.google.android.material.circularreveal.AbstractC22213b
    public void setCircularRevealScrimColor(int i) {
        this.f54275a.mo77250a(i);
    }

    @Override // com.google.android.material.circularreveal.AbstractC22213b
    public void setRevealInfo(AbstractC22213b.C22218d dVar) {
        this.f54275a.mo77253a(dVar);
    }
    ...
    public CircularRevealGridLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f54275a = new CircularRevealHelper(this);
    }
}
