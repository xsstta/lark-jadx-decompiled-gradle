...
public class CircularRevealCardView extends MaterialCardView implements AbstractC22213b {

    /* renamed from: e */
    private final CircularRevealHelper f54296e;

    @Override // com.google.android.material.circularreveal.AbstractC22213b
    public void Y_() {
        this.f54296e.mo77254b();
    }

    @Override // com.google.android.material.circularreveal.AbstractC22213b
    /* renamed from: a */
    public void mo77235a() {
        this.f54296e.mo77249a();
    }
    ...
    public Drawable getCircularRevealOverlayDrawable() {
        return this.f54296e.mo77257e();
    }

    @Override // com.google.android.material.circularreveal.AbstractC22213b
    public int getCircularRevealScrimColor() {
        return this.f54296e.mo77256d();
    }

    @Override // com.google.android.material.circularreveal.AbstractC22213b
    public AbstractC22213b.C22218d getRevealInfo() {
        return this.f54296e.mo77255c();
    }

    public boolean isOpaque() {
        CircularRevealHelper circularRevealHelper = this.f54296e;
    ...
    public void setCircularRevealOverlayDrawable(Drawable drawable) {
        this.f54296e.mo77252a(drawable);
    }

    @Override // com.google.android.material.circularreveal.AbstractC22213b
    public void setCircularRevealScrimColor(int i) {
        this.f54296e.mo77250a(i);
    }

    @Override // com.google.android.material.circularreveal.AbstractC22213b
    public void setRevealInfo(AbstractC22213b.C22218d dVar) {
        this.f54296e.mo77253a(dVar);
    }
    ...
    public CircularRevealCardView(Context context, AttributeSet attributeSet) {
        ...
        this.f54296e = new CircularRevealHelper(this);
    }
}
