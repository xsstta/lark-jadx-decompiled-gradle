    ...
    public static abstract class Stub extends zzb implements IFragmentWrapper {
        ...
        public static class zza extends com.google.android.gms.internal.common.zza implements IFragmentWrapper {
            ...
            public final Bundle getArguments() throws RemoteException {
                ...
                Bundle bundle = (Bundle) C21910a.m79218a(zza, Bundle.CREATOR);
                zza.recycle();
                return bundle;
            }
        ...
        public final boolean zza(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 2:
                    ...
                    C21910a.m79219a(parcel2, zzae);
                    return true;
                case 3:
                    Bundle arguments = getArguments();
                    parcel2.writeNoException();
                    C21910a.m79223b(parcel2, arguments);
                    return true;
                case 4:
                    int id = getId();
                    parcel2.writeNoException();
                ...
                case 5:
                    ...
                    parcel2.writeNoException();
                    C21910a.m79219a(parcel2, zzaf);
                    return true;
                case 6:
                    IObjectWrapper zzag = zzag();
                    parcel2.writeNoException();
                    C21910a.m79219a(parcel2, zzag);
                    return true;
                case 7:
                    boolean retainInstance = getRetainInstance();
                    parcel2.writeNoException();
                    C21910a.m79221a(parcel2, retainInstance);
                    return true;
                case 8:
                    String tag = getTag();
                    parcel2.writeNoException();
                ...
                case 11:
                    ...
                    parcel2.writeNoException();
                    C21910a.m79221a(parcel2, userVisibleHint);
                    return true;
                case HwBuildEx.VersionCodes.EMUI_5_1 /*{ENCODED_INT: 12}*/:
                    IObjectWrapper zzai = zzai();
                    parcel2.writeNoException();
                    C21910a.m79219a(parcel2, zzai);
                    return true;
                case 13:
                    boolean isAdded = isAdded();
                    parcel2.writeNoException();
                    C21910a.m79221a(parcel2, isAdded);
                    return true;
                case 14:
                    boolean isDetached = isDetached();
                    parcel2.writeNoException();
                    C21910a.m79221a(parcel2, isDetached);
                    return true;
                case 15:
                    boolean isHidden = isHidden();
                    parcel2.writeNoException();
                    C21910a.m79221a(parcel2, isHidden);
                    return true;
                case 16:
                    boolean isInLayout = isInLayout();
                    parcel2.writeNoException();
                    C21910a.m79221a(parcel2, isInLayout);
                    return true;
                case 17:
                    boolean isRemoving = isRemoving();
                    parcel2.writeNoException();
                    C21910a.m79221a(parcel2, isRemoving);
                    return true;
                case 18:
                    boolean isResumed = isResumed();
                    parcel2.writeNoException();
                    C21910a.m79221a(parcel2, isResumed);
                    return true;
                case 19:
                    boolean isVisible = isVisible();
                    parcel2.writeNoException();
                    C21910a.m79221a(parcel2, isVisible);
                    return true;
                case 20:
                    ...
                    return true;
                case 21:
                    setHasOptionsMenu(C21910a.m79222a(parcel));
                    parcel2.writeNoException();
                    return true;
                case 22:
                    setMenuVisibility(C21910a.m79222a(parcel));
                    parcel2.writeNoException();
                    return true;
                case 23:
                    setRetainInstance(C21910a.m79222a(parcel));
                    parcel2.writeNoException();
                    return true;
                case 24:
                    setUserVisibleHint(C21910a.m79222a(parcel));
                    parcel2.writeNoException();
                    return true;
                case AvailableCode.ERROR_ON_ACTIVITY_RESULT /*{ENCODED_INT: 25}*/:
                    startActivity((Intent) C21910a.m79218a(parcel, Intent.CREATOR));
                    parcel2.writeNoException();
                    return true;
                case 26:
                    startActivityForResult((Intent) C21910a.m79218a(parcel, Intent.CREATOR), parcel.readInt());
                    parcel2.writeNoException();
                    return true;
