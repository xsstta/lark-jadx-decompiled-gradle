...
import com.google.android.gms.common.internal.C21735af;
...
public class GoogleApiAvailabilityLight {
    ...
    public Intent getErrorResolutionIntent(Context context, int i, String str) {
        if (i == 1 || i == 2) {
            if (context == null || !C21810d.m79085b(context)) {
                return C21735af.m78937a("com.google.android.gms", zza(context, str));
            }
            return C21735af.m78935a();
        } else if (i != 3) {
            return null;
        } else {
            return C21735af.m78936a("com.google.android.gms");
        }
    }
