...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public static final Parcelable.Creator<ConnectionResult> CREATOR = new C21702d();
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add(HiAnalyticsConstant.HaKey.BI_KEY_RESULT, zza(this.zzh)).add(CommonCode.MapKey.HAS_RESOLUTION, this.zzi).add("message", this.zzj).toString();
    }
