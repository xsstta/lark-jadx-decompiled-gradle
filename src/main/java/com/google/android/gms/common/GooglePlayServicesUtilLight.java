...
import com.google.android.gms.common.util.C21816j;
...
public class GooglePlayServicesUtilLight {
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        ...
        if (!"com.google.android.gms".equals(context.getPackageName()) && !zzal.get()) {
            int b = C21737ah.m78942b(context);
            if (b != 0) {
        ...
        return zza(context, !C21810d.m79085b(context) && !C21810d.m79087d(context), i);
    }
    ...
    private static int zza(Context context, boolean z, int i) {
        ...
        try {
            ...
            if (!GoogleSignatureVerifier.zza(packageInfo2, true)) {
                ...
                return 9;
            } else if (C21816j.m79096a(packageInfo2.versionCode) < C21816j.m79096a(i)) {
    ...
    public static int getClientVersion(Context context) {
        ...
        return C21805b.m79077a(context, context.getPackageName());
    }
    ...
    public static boolean isSidewinderDevice(Context context) {
        return C21810d.m79086c(context);
    }
