...
import com.google.android.gms.common.util.C21815i;
...
public class WakeLockTracker {
    ...
    public void registerAcquireEvent(Context context, Intent intent, String str, String str2, String str3, int i, String str4) {
        registerEvent(context, intent.getStringExtra("WAKE_LOCK_KEY"), 7, str, str2, str3, i, Arrays.asList(str4));
    }
    ...
    public void registerEvent(Context context, String str, int i, String str2, String str3, String str4, int i2, List<String> list, long j) {
        if (zzw()) {
            if (TextUtils.isEmpty(str)) {
                ...
                zza(context, new WakeLockEvent(System.currentTimeMillis(), i, str2, i2, StatsUtils.zza(list), str, SystemClock.elapsedRealtime(), C21815i.m79093a(context), str3, StatsUtils.zzi(context.getPackageName()), C21815i.m79095b(context), j, str4, false));
            }
        }
    }
    ...
    public void registerDeadlineEvent(Context context, String str, String str2, String str3, int i, List<String> list, boolean z, long j) {
        if (zzw()) {
            zza(context, new WakeLockEvent(System.currentTimeMillis(), 16, str, i, StatsUtils.zza(list), null, j, C21815i.m79093a(context), str2, StatsUtils.zzi(context.getPackageName()), C21815i.m79095b(context), 0, str3, z));
        }
    }

    private static void zza(Context context, WakeLockEvent wakeLockEvent) {
        try {
            context.startService(new Intent().setComponent(C21802a.f53192a).putExtra("com.google.android.gms.common.stats.EXTRA_LOG_EVENT", wakeLockEvent));
        } catch (Exception e) {
