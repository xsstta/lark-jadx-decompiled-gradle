...
public final class zzg extends zza implements zze {
    ...
    public final Bundle zza(String str, Bundle bundle) throws RemoteException {
        ...
        C21874m.m79187a(obtainAndWriteInterfaceToken, bundle);
        Parcel transactAndReadException = transactAndReadException(2, obtainAndWriteInterfaceToken);
        Bundle bundle2 = (Bundle) C21874m.m79185a(transactAndReadException, Bundle.CREATOR);
    ...
    public final AccountChangeEventsResponse zza(AccountChangeEventsRequest accountChangeEventsRequest) throws RemoteException {
        Parcel obtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
        C21874m.m79187a(obtainAndWriteInterfaceToken, accountChangeEventsRequest);
        Parcel transactAndReadException = transactAndReadException(3, obtainAndWriteInterfaceToken);
        AccountChangeEventsResponse accountChangeEventsResponse = (AccountChangeEventsResponse) C21874m.m79185a(transactAndReadException, AccountChangeEventsResponse.CREATOR);
        transactAndReadException.recycle();
    ...
    public final Bundle zza(Account account) throws RemoteException {
        ...
        Bundle bundle = (Bundle) C21874m.m79185a(transactAndReadException, Bundle.CREATOR);
        transactAndReadException.recycle();
        return bundle;
    }
