...
public interface SplitInstallManager {
    ...
    boolean startConfirmationDialogForResult(SplitInstallSessionState splitInstallSessionState, AbstractC22617a aVar, int i) throws IntentSender.SendIntentException;
