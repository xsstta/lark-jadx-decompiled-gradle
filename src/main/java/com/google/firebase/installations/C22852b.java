...
class C22852b {
    ...
    /* renamed from: a */
    private final FileChannel f56487a;

    /* renamed from: b */
    private final FileLock f56488b;

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public void mo79379a() {
        try {
            this.f56488b.release();
            this.f56487a.close();
        } catch (IOException e) {
    ...
    private C22852b(FileChannel fileChannel, FileLock fileLock) {
        this.f56487a = fileChannel;
        this.f56488b = fileLock;
    }
    ...
    static com.google.firebase.installations.C22852b m82972a(android.content.Context r4, java.lang.String r5) {
        /*
            r0 = 0
        ...
        L_0x0040:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.C22852b.m82972a(android.content.Context, java.lang.String):com.google.firebase.installations.b");
    }
}
