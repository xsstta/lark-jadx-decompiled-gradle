...
public class JsonReader implements Closeable {
    ...
    static {
        AbstractC23018f.INSTANCE = new AbstractC23018f() {
            /* class com.google.gson.stream.JsonReader.C230301 */

            @Override // com.google.gson.internal.AbstractC23018f
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                if (jsonReader instanceof C22963e) {
                    ((C22963e) jsonReader).mo79822a();
                    return;
                }
