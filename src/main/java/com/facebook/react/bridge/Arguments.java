...
public class Arguments {
    ...
    public static /* synthetic */ class C210652 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.facebook.react.bridge.Arguments.C210652.$SwitchMap$com$facebook$react$bridge$ReadableType = r0
            ...
            L_0x0012:
                int[] r0 = com.facebook.react.bridge.Arguments.C210652.$SwitchMap$com$facebook$react$bridge$ReadableType     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = com.facebook.react.bridge.Arguments.C210652.$SwitchMap$com$facebook$react$bridge$ReadableType     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = com.facebook.react.bridge.Arguments.C210652.$SwitchMap$com$facebook$react$bridge$ReadableType     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = com.facebook.react.bridge.Arguments.C210652.$SwitchMap$com$facebook$react$bridge$ReadableType     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = com.facebook.react.bridge.Arguments.C210652.$SwitchMap$com$facebook$react$bridge$ReadableType     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.bridge.Arguments.C210652.<clinit>():void");
        }
    }
    ...
    public static <T> WritableNativeArray makeNativeArray(final Object obj) {
        ...
        return makeNativeArray((List) new AbstractList() {
            /* class com.facebook.react.bridge.Arguments.C210641 */
    ...
    public static Bundle toBundle(ReadableMap readableMap) {
        ...
        while (keySetIterator.hasNextKey()) {
            ...
            switch (C210652.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(nextKey).ordinal()]) {
                case 1:
    ...
    public static ArrayList toList(ReadableArray readableArray) {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            switch (C210652.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                case 1:
                    arrayList.add(null);
                    break;
                case 2:
