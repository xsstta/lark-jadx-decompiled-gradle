...
public class JsonWriterHelper {
    ...
    public static /* synthetic */ class C210921 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.facebook.react.bridge.JsonWriterHelper.C210921.$SwitchMap$com$facebook$react$bridge$ReadableType = r0
            ...
            L_0x0012:
                int[] r0 = com.facebook.react.bridge.JsonWriterHelper.C210921.$SwitchMap$com$facebook$react$bridge$ReadableType     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = com.facebook.react.bridge.JsonWriterHelper.C210921.$SwitchMap$com$facebook$react$bridge$ReadableType     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = com.facebook.react.bridge.JsonWriterHelper.C210921.$SwitchMap$com$facebook$react$bridge$ReadableType     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = com.facebook.react.bridge.JsonWriterHelper.C210921.$SwitchMap$com$facebook$react$bridge$ReadableType     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = com.facebook.react.bridge.JsonWriterHelper.C210921.$SwitchMap$com$facebook$react$bridge$ReadableType     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.bridge.JsonWriterHelper.C210921.<clinit>():void");
        }
    }
    ...
    private static void dynamicValue(JsonWriter jsonWriter, Dynamic dynamic) throws IOException {
        switch (C210921.$SwitchMap$com$facebook$react$bridge$ReadableType[dynamic.getType().ordinal()]) {
            case 1:
                jsonWriter.nullValue();
                return;
            case 2:
    ...
    public static void readableArrayValue(JsonWriter jsonWriter, ReadableArray readableArray) throws IOException {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            try {
                switch (C210921.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                    case 1:
                        jsonWriter.nullValue();
                        break;
                    case 2:
    ...
    private static void readableMapValue(JsonWriter jsonWriter, ReadableMap readableMap) throws IOException {
        ...
        try {
            ...
            while (keySetIterator.hasNextKey()) {
                ...
                switch (C210921.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(nextKey).ordinal()]) {
                    case 1:
                        jsonWriter.nullValue();
                        break;
                    case 2:
