...
public class IntentModule extends ReactContextBaseJavaModule {
    ...
    static /* synthetic */ class C211951 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.facebook.react.modules.intent.IntentModule.C211951.f51670a = r0
            ...
            L_0x0012:
                int[] r0 = com.facebook.react.modules.intent.IntentModule.C211951.f51670a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = com.facebook.react.modules.intent.IntentModule.C211951.f51670a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.modules.intent.IntentModule.C211951.<clinit>():void");
        }
    }
    ...
    public void sendIntent(String str, ReadableArray readableArray, Promise promise) {
        ...
        if (readableArray != null) {
            for (int i = 0; i < readableArray.size(); i++) {
                ...
                int i2 = C211951.f51670a[map.getType(nextKey).ordinal()];
                if (i2 == 1) {
