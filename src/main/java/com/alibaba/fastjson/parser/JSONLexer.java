...
public final class JSONLexer {
    ...
    public static final boolean[] firstIdentifierFlags = new boolean[DynamicModule.f58006b];
    public static final boolean[] identifierFlags = new boolean[DynamicModule.f58006b];
    ...
    /* JADX WARNING: Removed duplicated region for block: B:122:0x020d A[Catch:{ NumberFormatException -> 0x0255 }] */
    /* JADX WARNING: Removed duplicated region for block: B:131:0x0225 A[Catch:{ NumberFormatException -> 0x0255 }] */
    /* JADX WARNING: Removed duplicated region for block: B:136:0x0230 A[Catch:{ NumberFormatException -> 0x0255 }] */
    /* JADX WARNING: Removed duplicated region for block: B:143:0x0245 A[Catch:{ NumberFormatException -> 0x0255 }] */
    /* JADX WARNING: Removed duplicated region for block: B:145:0x024b A[Catch:{ NumberFormatException -> 0x0255 }] */
    ...
    public JSONLexer(String str, int i) {
        ...
        this.sbuf = cArr;
        if (cArr == null) {
            this.sbuf = new char[MediaPlayer.MEDIA_PLAYER_OPTION_APPID];
        }
        this.features = i;
        this.text = str;
        ...
        this.disableCircularReferenceDetect = (Feature.DisableCircularReferenceDetect.mask & i) == 0 ? false : z;
    }
        ...
        if (indexOf != -1) {
            ...
            if (!z) {
                ...
                if (z) {
                    ...
                    str = symbolTable.addSymbol(sub_chars, 0, i2, i6);
                } else {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:101:0x01f9 A[RETURN] */
    ...
    public static final byte[] decodeFast(String str, int i, int i2) {
        ...
        while (i11 < i10) {
            ...
            int i13 = i + 1;
            int i14 = i13 + 1;
            int i15 = (iArr[str.charAt(i)] << 18) | (iArr[str.charAt(i13)] << 12);
            int i16 = i14 + 1;
        ...
        if (i11 < i9) {
            int i23 = 0;
            while (i <= i7 - i3) {
                i6 |= IA[str.charAt(i)] << (18 - (i23 * 6));
                i23++;
                i++;
            }
            int i24 = 16;
            while (i11 < i9) {
                bArr[i11] = (byte) (i6 >> i24);
                i24 -= 8;
                i11++;
            }
        }
