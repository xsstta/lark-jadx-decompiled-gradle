    ...
    static /* synthetic */ class C19101 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.alibaba.fastjson.PropertyNamingStrategy.C19101.$SwitchMap$com$alibaba$fastjson$PropertyNamingStrategy = r0
            ...
            L_0x0012:
                int[] r0 = com.alibaba.fastjson.PropertyNamingStrategy.C19101.$SwitchMap$com$alibaba$fastjson$PropertyNamingStrategy     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = com.alibaba.fastjson.PropertyNamingStrategy.C19101.$SwitchMap$com$alibaba$fastjson$PropertyNamingStrategy     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = com.alibaba.fastjson.PropertyNamingStrategy.C19101.$SwitchMap$com$alibaba$fastjson$PropertyNamingStrategy     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.alibaba.fastjson.PropertyNamingStrategy.C19101.<clinit>():void");
        }
    }

    public String translate(String str) {
        char charAt;
        int i = C19101.$SwitchMap$com$alibaba$fastjson$PropertyNamingStrategy[ordinal()];
        int i2 = 0;
        if (i == 1) {
