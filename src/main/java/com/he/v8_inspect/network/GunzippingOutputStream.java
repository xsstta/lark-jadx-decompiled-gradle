...
public class GunzippingOutputStream extends FilterOutputStream {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:4:0x0006, code lost:
        r0 = r0.getCause();
        com.he.v8_inspect.utils.ExceptionUtil.propagateIfInstanceOf(r0, java.io.IOException.class);
        com.he.v8_inspect.utils.ExceptionUtil.propagate(r0);
     */
    ...
    private static <T> T getAndRethrow(java.util.concurrent.Future<T> r2) throws java.io.IOException {
        ...
        L_0x0005:
            ...
            com.he.v8_inspect.utils.ExceptionUtil.propagateIfInstanceOf(r0, r1)
            com.he.v8_inspect.utils.ExceptionUtil.propagate(r0)
            goto L_0x0000
        */
        throw new UnsupportedOperationException("Method not decompiled: com.he.v8_inspect.network.GunzippingOutputStream.getAndRethrow(java.util.concurrent.Future):java.lang.Object");
    }
