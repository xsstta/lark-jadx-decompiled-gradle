...
public class C2598z implements AbstractC2604b {
    ...
    public View mo11274a(Context context, ViewGroup viewGroup, boolean z) throws Exception {
        ...
        TextChatView2 textChatView2 = new TextChatView2(context);
        textChatView2.setId(R.id.text_content);
        ...
        C0178a.m580a(textChatView2);
        if (textChatView2.getParent() == null) {
            linearLayout.addView(textChatView2, layoutParams);
        }
        ViewStub viewStub = new ViewStub(context);
        viewStub.setId(R.id.text_translate_content);
        viewStub.setLayoutResource(R.layout.text_translate_light_content2);
