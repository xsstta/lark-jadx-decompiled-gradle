...
public class C2593u implements AbstractC2604b {
    ...
    public View mo11274a(Context context, ViewGroup viewGroup, boolean z) throws Exception {
        ...
        postChatView.setId(R.id.translate_post);
        ...
        if (ConstraintLayout.LayoutParams.class.isInstance(layoutParams3)) {
            layoutParams3.f2832x = (int) TypedValue.applyDimension(1, BitmapDescriptorFactory.HUE_RED, resources.getDisplayMetrics());
        }
        if (ViewGroup.MarginLayoutParams.class.isInstance(layoutParams3)) {
            ((ViewGroup.MarginLayoutParams) layoutParams3).topMargin = (int) resources.getDimension(R.dimen.dp_12);
        }
        if (ConstraintLayout.LayoutParams.class.isInstance(layoutParams3)) {
            layoutParams3.f2829u = (int) TypedValue.applyDimension(1, BitmapDescriptorFactory.HUE_RED, resources.getDisplayMetrics());
        }
        if (ConstraintLayout.LayoutParams.class.isInstance(layoutParams3)) {
            layoutParams3.f2802T = true;
        }
        if (ConstraintLayout.LayoutParams.class.isInstance(layoutParams3)) {
            layoutParams3.f2824p = R.id.translate_hint_line;
        }
        if (ConstraintLayout.LayoutParams.class.isInstance(layoutParams3)) {
            layoutParams3.f2827s = 0;
        }
        if (ConstraintLayout.LayoutParams.class.isInstance(layoutParams3)) {
            layoutParams3.f2817i = R.id.translate_divider;
        }
        C0178a.m580a(postChatView);
        if (postChatView.getParent() == null) {
            constraintLayout.addView(postChatView, layoutParams3);
        }
        View view2 = new View(context);
        view2.setId(R.id.translate_hint_line);
        view2.setBackgroundResource(R.drawable.translate_hint_line_bg);
        ConstraintLayout.LayoutParams layoutParams4 = new ConstraintLayout.LayoutParams((int) TypedValue.applyDimension(1, 3.0f, resources.getDisplayMetrics()), (int) TypedValue.applyDimension(1, BitmapDescriptorFactory.HUE_RED, resources.getDisplayMetrics()));
        if (ConstraintLayout.LayoutParams.class.isInstance(layoutParams4)) {
            layoutParams4.f2816h = R.id.translate_post;
        }
        if (ConstraintLayout.LayoutParams.class.isInstance(layoutParams4)) {
            layoutParams4.f2819k = R.id.translate_post;
        }
        if (ConstraintLayout.LayoutParams.class.isInstance(layoutParams4)) {
        ...
        if (view2.getParent() == null) {
            constraintLayout.addView(view2, layoutParams4);
        }
