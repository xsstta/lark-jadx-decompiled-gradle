...
public class C2592t implements AbstractC2604b {
    ...
    public View mo11274a(Context context, ViewGroup viewGroup, boolean z) throws Exception {
        ...
        PostChatView2 postChatView2 = new PostChatView2(context);
        postChatView2.setId(R.id.chat_post);
        ...
        C0178a.m580a(postChatView2);
        if (postChatView2.getParent() == null) {
            linearLayout.addView(postChatView2, layoutParams);
        }
        ...
        viewStub.setLayoutResource(R.layout.post_translate_light_content2);
