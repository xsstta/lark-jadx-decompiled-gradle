...
public class FlowLayout extends ViewGroup {
    ...
    /* renamed from: a */
    protected List<List<View>> f64759a;

    /* renamed from: b */
    protected List<Integer> f64760b;

    /* renamed from: c */
    protected List<Integer> f64761c;

    /* renamed from: d */
    protected int f64762d;

    /* renamed from: e */
    protected List<View> f64763e;
    ...
    public FlowLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f64760b = new ArrayList();
        this.f64761c = new ArrayList();
        ...
        this.f64762d = obtainStyledAttributes.getInt(1, -1);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (measuredWidth + i8 + marginLayoutParams.leftMargin + marginLayoutParams.rightMargin > (width - getPaddingLeft()) - getPaddingRight()) {
                    this.f64760b.add(Integer.valueOf(i7));
                    this.f64759a.add(this.f64763e);
                    this.f64761c.add(Integer.valueOf(i8));
        ...
        int size = this.f64759a.size();
        for (int i10 = 0; i10 < size; i10++) {
            this.f64763e = this.f64759a.get(i10);
            int intValue = this.f64760b.get(i10).intValue();
            int intValue2 = this.f64761c.get(i10).intValue();
            int i11 = this.f64762d;
            if (i11 != -1) {
                if (i11 == 0) {
            ...
            for (int i12 = 0; i12 < this.f64763e.size(); i12++) {
                View view = this.f64763e.get(i12);
