...
/* renamed from: com.larksuite.framework.utils.g */
public class C26277g {
    /* renamed from: a */
    public static Rect m95142a(View view, View view2) {
        Point point = new Point();
        m95141a(view, view2, point);
        return new Rect(point.x, point.y, point.x + view.getWidth(), point.y + view.getHeight());
    }

    /* renamed from: a */
    public static float m95141a(View view, View view2, Point point) {
    ...
    /* renamed from: b */
    public static float m95143b(View view, View view2, Point point) {
        View view3;
        ArrayList arrayList = new ArrayList();
        float[] fArr = {(float) point.x, (float) point.y};
        while (view != view2) {
