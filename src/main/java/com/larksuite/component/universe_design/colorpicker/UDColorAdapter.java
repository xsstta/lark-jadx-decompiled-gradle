...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0018\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\fH\u0016J\u0018\u0010\r\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\fH\u0016R\u000e\u0010\u0005\u001a\u00020\u0006X\u000e¢\u0006\u0002\n\u0000¨\u0006\u000e"}, d2 = {"Lcom/larksuite/component/universe_design/colorpicker/UDColorAdapter;", "Lcom/larksuite/component/universe_design/colorpicker/UDBaseColorPickerAdapter;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "itemImage", "Landroid/graphics/drawable/Drawable;", "onItemBind", "", "view", "Lcom/larksuite/component/universe_design/colorpicker/UDColorItemView;", "itemUD", "Lcom/larksuite/component/universe_design/colorpicker/UDColorItem;", "onItemClicked", "universe-ui-colorpicker_release"}, mo238835k = 1, mv = {1, 1, 16})
/* renamed from: com.larksuite.component.universe_design.colorpicker.c */
public final class UDColorAdapter extends UDBaseColorPickerAdapter {

    /* renamed from: c */
    private Drawable f63169c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public UDColorAdapter(Context context) {
        super(context);
        Intrinsics.checkParameterIsNotNull(context, "context");
        this.f63169c = UDIconUtils.getIconDrawable(context, R.drawable.ic_color_picker_item_selected);
    }
    ...
    public void mo90404a(UDColorItemView uDColorItemView, UDColorItem dVar) {
        ...
        uDColorItemView.getItemImage().setImageDrawable(this.f63169c);
    }
    ...
    public void mo90405b(UDColorItemView uDColorItemView, UDColorItem dVar) {
        ...
        ImageView itemImage = uDColorItemView.getItemImage();
        if (uDColorItemView.isSelected()) {
            drawable2 = this.f63169c;
        }
        itemImage.setImageDrawable(drawable2);
