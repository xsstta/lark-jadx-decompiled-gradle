...
/* renamed from: com.larksuite.component.openplatform.core.plugin.container.l */
public class C24672l extends ApiHandler {
    @Override // com.tt.frontendapiinterface.ApiHandler
    public String getActionName() {
        return "disablePullDownRefresh";
    }
    ...
    public C24672l(String str, int i, AbstractC67619e eVar) {
        super(str, i, eVar);
    }
}
