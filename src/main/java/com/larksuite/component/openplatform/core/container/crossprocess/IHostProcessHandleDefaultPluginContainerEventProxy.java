...
public final class IHostProcessHandleDefaultPluginContainerEventProxy implements IInterface, IHostProcessHandleDefaultPluginContainerEvent {
    private IBinder mRemote;

    public String getInterfaceDescriptor() {
        return "com.larksuite.component.openplatform.core.container.crossprocess.IHostProcessHandleDefaultPluginContainerEvent";
    }
    ...
    public List<IHostProcessHandleEvent.IPCPluginConfig> getAppEnvPluginConfigs() {
        ...
        try {
            obtain.writeInterfaceToken("com.larksuite.component.openplatform.core.container.crossprocess.IHostProcessHandleDefaultPluginContainerEvent");
            ...
            e.printStackTrace();
            Log.m165385e("IHostProcessHandleDefaultPluginContainerEventProxy", "call method getAppEnvPluginConfigs throw RemoteException", e, true);
            obtain2.recycle();
            obtain.recycle();
            return null;
        } catch (Throwable th) {
    ...
    public List<IHostProcessHandleEvent.IPCPluginConfig> getBizEnvPluginConfigsForWebApp() {
        ...
        try {
            ...
            e.printStackTrace();
            Log.m165385e("IHostProcessHandleDefaultPluginContainerEventProxy", "call method getBizEnvPluginConfigsForWebApp throw RemoteException", e, true);
            obtain2.recycle();
            obtain.recycle();
            return null;
        } catch (Throwable th) {
    ...
    public void notifyAppContainerOnDestroy(String str) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.m165385e("IHostProcessHandleDefaultPluginContainerEventProxy", "call method notifyAppContainerOnDestroy throw RemoteException", e, true);
        } catch (Throwable th) {
            obtain2.recycle();
            obtain.recycle();
            throw th;
    ...
    public IHostProcessHandleDefaultPluginContainerEventProxy(Context context, IBinder iBinder) {
    ...
    public void notifyAppContainerOnCreate(String str, LKOpenApiAccessConfig lKOpenApiAccessConfig) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.m165385e("IHostProcessHandleDefaultPluginContainerEventProxy", "call method notifyAppContainerOnCreate throw RemoteException", e, true);
        } catch (Throwable th) {
            obtain2.recycle();
            obtain.recycle();
            throw th;
    ...
    public void sendAsyncHandleResultToHostProcess(long j, String str, int i, String str2) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.m165385e("IHostProcessHandleDefaultPluginContainerEventProxy", "call method sendAsyncHandleResultToHostProcess throw RemoteException", e, true);
        } catch (Throwable th) {
            obtain2.recycle();
            obtain.recycle();
            throw th;
    ...
    public LKBasePluginResult dispatchEventToHostProcess(String str, LKEvent lKEvent, IHostProcessHandleEvent.HandleEventCallback handleEventCallback, long j) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.m165385e("IHostProcessHandleDefaultPluginContainerEventProxy", "call method dispatchEventToHostProcess throw RemoteException", e, true);
        } catch (Throwable th) {
            obtain2.recycle();
            obtain.recycle();
            throw th;
