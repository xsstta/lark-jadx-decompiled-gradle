...
public final class LKUIFrameLayout extends FrameLayout implements ILKUILayout {
    ...
    public LKUIFrameLayout(Context context) {
        this(context, null);
        Intrinsics.checkParameterIsNotNull(context, "context");
    }
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public LKUIFrameLayout(Context context, AttributeSet attributeSet) {
    ...
    public LKUIFrameLayout(Context context, AttributeSet attributeSet, int i) {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ LKUIFrameLayout(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
