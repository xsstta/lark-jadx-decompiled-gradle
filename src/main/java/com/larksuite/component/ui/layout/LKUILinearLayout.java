...
public final class LKUILinearLayout extends LinearLayout implements ILKUILayout {
    ...
    public LKUILinearLayout(Context context) {
        this(context, null);
        Intrinsics.checkParameterIsNotNull(context, "context");
    }
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public LKUILinearLayout(Context context, AttributeSet attributeSet) {
    ...
    public LKUILinearLayout(Context context, AttributeSet attributeSet, int i) {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ LKUILinearLayout(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
