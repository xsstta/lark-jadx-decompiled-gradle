...
public final class LKUIRelativeLayout extends RelativeLayout implements ILKUILayout {
    ...
    public LKUIRelativeLayout(Context context) {
        this(context, null);
        Intrinsics.checkParameterIsNotNull(context, "context");
    }
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public LKUIRelativeLayout(Context context, AttributeSet attributeSet) {
    ...
    public LKUIRelativeLayout(Context context, AttributeSet attributeSet, int i) {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ LKUIRelativeLayout(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
