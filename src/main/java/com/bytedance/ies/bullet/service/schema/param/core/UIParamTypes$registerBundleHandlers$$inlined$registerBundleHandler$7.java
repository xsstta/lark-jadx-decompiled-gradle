...
public final class UIParamTypes$registerBundleHandlers$$inlined$registerBundleHandler$7 extends Lambda implements Function2<Bundle, String, StatusFontMode> {
    public UIParamTypes$registerBundleHandlers$$inlined$registerBundleHandler$7() {
        super(2);
    }
    ...
    public final StatusFontMode invoke(Bundle bundle, String str) {
        ...
        StatusFontMode.Companion aVar = StatusFontMode.Companion;
        Intrinsics.checkExpressionValueIsNotNull(string, "it");
        return aVar.mo52817a(string);
    }
}
