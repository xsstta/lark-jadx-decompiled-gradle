...
public final class UIParamTypes$registerBundleHandlers$$inlined$registerBundleHandler$3 extends Lambda implements Function2<Bundle, String, TopBarType> {
    public UIParamTypes$registerBundleHandlers$$inlined$registerBundleHandler$3() {
        super(2);
    }
    ...
    public final TopBarType invoke(Bundle bundle, String str) {
        ...
        return TopBarType.Companion.mo52819a(bundle.getInt(str));
    }
}
