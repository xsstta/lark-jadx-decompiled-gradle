...
public final class UIParamTypes$registerUriHandlers$$inlined$registerUriQueryHandler$7 extends Lambda implements Function2<Uri, String, StatusFontMode> {
    public UIParamTypes$registerUriHandlers$$inlined$registerUriQueryHandler$7() {
        super(2);
    }
    ...
    public final StatusFontMode invoke(Uri uri, String str) {
        ...
        if (a != null) {
            return StatusFontMode.Companion.mo52817a(a);
        }
        return null;
    }
}
