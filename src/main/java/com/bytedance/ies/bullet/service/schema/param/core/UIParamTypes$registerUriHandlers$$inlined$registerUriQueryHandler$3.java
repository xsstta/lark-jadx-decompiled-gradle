...
public final class UIParamTypes$registerUriHandlers$$inlined$registerUriQueryHandler$3 extends Lambda implements Function2<Uri, String, TopBarType> {
    public UIParamTypes$registerUriHandlers$$inlined$registerUriQueryHandler$3() {
        super(2);
    }
    ...
    public final TopBarType invoke(Uri uri, String str) {
        ...
        if (a != null) {
            return TopBarType.Companion.mo52820a(a);
        }
        return null;
    }
}
