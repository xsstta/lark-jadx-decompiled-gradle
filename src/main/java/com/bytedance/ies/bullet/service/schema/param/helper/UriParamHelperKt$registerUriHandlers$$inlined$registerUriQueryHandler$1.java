...
public final class UriParamHelperKt$registerUriHandlers$$inlined$registerUriQueryHandler$1 extends Lambda implements Function2<Uri, String, Boolean> {
    public UriParamHelperKt$registerUriHandlers$$inlined$registerUriQueryHandler$1() {
        super(2);
    }
    ...
    public final Boolean invoke(Uri uri, String str) {
        ...
        if (a != null) {
            return Boolean.valueOf(Intrinsics.areEqual(a, "1"));
        }
        return null;
    }
}
