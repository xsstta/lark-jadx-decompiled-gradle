...
public final class UIParamTypes$registerUriHandlers$$inlined$registerUriQueryHandler$9 extends Lambda implements Function2<Uri, String, OutAnimationType> {
    public UIParamTypes$registerUriHandlers$$inlined$registerUriQueryHandler$9() {
        super(2);
    }
    ...
    public final OutAnimationType invoke(Uri uri, String str) {
        ...
        if (a != null) {
            return OutAnimationType.Companion.mo52815a(a);
        }
        return null;
    }
}
