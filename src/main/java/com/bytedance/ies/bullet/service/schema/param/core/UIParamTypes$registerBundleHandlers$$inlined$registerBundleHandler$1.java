...
public final class UIParamTypes$registerBundleHandlers$$inlined$registerBundleHandler$1 extends Lambda implements Function2<Bundle, String, UIColor> {
    public UIParamTypes$registerBundleHandlers$$inlined$registerBundleHandler$1() {
        super(2);
    }
    ...
    public final UIColor invoke(Bundle bundle, String str) {
        ...
        UIParamTypes dVar = UIParamTypes.f37973a;
        Intrinsics.checkExpressionValueIsNotNull(string, "it");
        return dVar.mo52859a(string);
    }
}
