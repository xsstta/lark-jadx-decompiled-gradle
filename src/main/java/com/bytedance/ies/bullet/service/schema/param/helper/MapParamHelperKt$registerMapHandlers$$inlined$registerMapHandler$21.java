...
public final class MapParamHelperKt$registerMapHandlers$$inlined$registerMapHandler$21 extends Lambda implements Function2<Map<?, ?>, String, List<? extends String>> {
    final /* synthetic */ String $specificKey;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MapParamHelperKt$registerMapHandlers$$inlined$registerMapHandler$21(String str) {
        super(2);
    ...
    public final List<? extends String> invoke(Map<?, ?> map, String str) {
        ...
        return StringsKt.split$default((CharSequence) str2, new String[]{str3}, false, 0, 6, (Object) null);
    }
}
