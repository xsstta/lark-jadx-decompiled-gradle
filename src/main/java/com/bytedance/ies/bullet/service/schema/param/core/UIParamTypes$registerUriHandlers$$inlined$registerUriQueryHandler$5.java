...
public final class UIParamTypes$registerUriHandlers$$inlined$registerUriQueryHandler$5 extends Lambda implements Function2<Uri, String, NavBtnType> {
    public UIParamTypes$registerUriHandlers$$inlined$registerUriQueryHandler$5() {
        super(2);
    }
    ...
    public final NavBtnType invoke(Uri uri, String str) {
        ...
        if (a != null) {
            return NavBtnType.Companion.mo52811a(a);
        }
        return null;
    }
}
