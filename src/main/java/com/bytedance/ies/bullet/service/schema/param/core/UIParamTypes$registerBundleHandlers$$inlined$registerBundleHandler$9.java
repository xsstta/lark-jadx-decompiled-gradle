...
public final class UIParamTypes$registerBundleHandlers$$inlined$registerBundleHandler$9 extends Lambda implements Function2<Bundle, String, OutAnimationType> {
    public UIParamTypes$registerBundleHandlers$$inlined$registerBundleHandler$9() {
        super(2);
    }
    ...
    public final OutAnimationType invoke(Bundle bundle, String str) {
        ...
        OutAnimationType.Companion aVar = OutAnimationType.Companion;
        Intrinsics.checkExpressionValueIsNotNull(string, "it");
        return aVar.mo52815a(string);
    }
}
