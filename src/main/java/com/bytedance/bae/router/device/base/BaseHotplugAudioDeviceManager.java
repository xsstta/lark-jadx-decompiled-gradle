...
public abstract class BaseHotplugAudioDeviceManager extends BaseAudioDeviceManager implements IAudioDeviceManager.IHotplugDevice {
    ...
    public void registerReceiver() {
        ...
        if (context != null && !this.mBroadcastReceiver.getRegistered()) {
            Intent INVOKEVIRTUAL_com_bytedance_bae_router_device_base_BaseHotplugAudioDeviceManager_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver = INVOKEVIRTUAL_com_bytedance_bae_router_device_base_BaseHotplugAudioDeviceManager_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver(context, this.mBroadcastReceiver, getBroadcastIntentFilter());
            this.mBroadcastReceiver.setRegistered(true);
            if (INVOKEVIRTUAL_com_bytedance_bae_router_device_base_BaseHotplugAudioDeviceManager_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver != null) {
                onStickyIntentFoundWhenRegister(INVOKEVIRTUAL_com_bytedance_bae_router_device_base_BaseHotplugAudioDeviceManager_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver);
            }
        }
    }
    ...
    public static Intent INVOKEVIRTUAL_com_bytedance_bae_router_device_base_BaseHotplugAudioDeviceManager_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver(Context context, BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        try {
