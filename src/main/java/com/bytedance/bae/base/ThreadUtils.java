...
public class ThreadUtils {
    ...
    public static void awaitUninterruptibly(final CountDownLatch countDownLatch) {
        executeUninterruptibly(new BlockingOperation() {
            /* class com.bytedance.bae.base.ThreadUtils.C35032 */
    ...
    public static void joinUninterruptibly(final Thread thread) {
        executeUninterruptibly(new BlockingOperation() {
            /* class com.bytedance.bae.base.ThreadUtils.C35021 */
    ...
    public static void invokeAtFrontUninterruptibly(Handler handler, final Runnable runnable) {
        invokeAtFrontUninterruptibly(handler, new Callable<Void>() {
            /* class com.bytedance.bae.base.ThreadUtils.CallableC35054 */
    ...
    public static <V> V invokeAtFrontUninterruptibly(Handler handler, final Callable<V> callable) {
        if (handler.getLooper().getThread() == Thread.currentThread()) {
            ...
            handler.post(new Runnable() {
                /* class com.bytedance.bae.base.ThreadUtils.RunnableC35043 */
            ...
            RuntimeException runtimeException = new RuntimeException(r1.f11057e);
            runtimeException.setStackTrace(concatStackTraces(r1.f11057e.getStackTrace(), runtimeException.getStackTrace()));
