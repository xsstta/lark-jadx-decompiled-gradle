...
/* renamed from: com.bytedance.geckox.d.o */
public class C14261o extends AbstractC20246k<UpdatePackage, Pair<Uri, UpdatePackage>> {
    ...
    public boolean mo52217a(Throwable th) {
        C14276b.m57603a("gecko-debug-tag", "patch update failed", th);
        if (this.f37504a >= ((UpdatePackage) mo68511h()).getPatch().getUrlList().size()) {
            return false;
        }
