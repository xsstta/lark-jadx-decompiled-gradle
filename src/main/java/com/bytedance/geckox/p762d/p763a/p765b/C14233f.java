...
/* renamed from: com.bytedance.geckox.d.a.b.f */
public class C14233f extends AbstractC20235d<Pair<File, UpdatePackage>, Pair<UpdatePackage, Long>> {
    /* renamed from: a */
    public Object a_(AbstractC20233b<Pair<UpdatePackage, Long>> bVar, Pair<File, UpdatePackage> pair) throws Throwable {
        C14276b.m57604a("gecko-debug-tag", "start active merged single file,channel:", ((UpdatePackage) pair.second).getChannel());
        ...
        if (parentFile.renameTo(file)) {
            try {
                ...
                if (!TextUtils.isEmpty(d)) {
                    ...
                    eventMessageModel.setErrMsg("active merged single file,size 0 file path:" + d);
