...
/* renamed from: com.bytedance.geckox.d.a.b.d */
public class C14231d extends AbstractC20235d<Pair<Uri, UpdatePackage>, Pair<AbstractC14208a, UpdatePackage>> {

    /* renamed from: a */
    private C14218d f37447a;

    /* renamed from: b */
    private File f37448b;

    /* renamed from: f */
    private AbstractC14267a f37449f;
    ...
    public void mo52179a(Object... objArr) {
        ...
        this.f37447a = (C14218d) objArr[0];
        this.f37448b = (File) objArr[1];
        this.f37449f = (AbstractC14267a) objArr[2];
    }
    ...
    public Object a_(AbstractC20233b<Pair<AbstractC14208a, UpdatePackage>> bVar, Pair<Uri, UpdatePackage> pair) throws Throwable {
        ...
        file2.mkdirs();
        AbstractC14208a a = C14212a.m57400a(this.f37447a.mo52133a(), new File(file2, "patch.tmp"), length);
        try {
            this.f37447a.mo52143i().mo52250a(uri, length, new C14210b(a, this.f37449f, updatePackage, length));
            try {
