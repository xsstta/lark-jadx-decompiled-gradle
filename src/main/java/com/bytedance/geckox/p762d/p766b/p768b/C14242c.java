...
/* renamed from: com.bytedance.geckox.d.b.b.c */
public class C14242c extends AbstractC20235d<Pair<Uri, UpdatePackage>, Pair<AbstractC14208a, UpdatePackage>> {

    /* renamed from: a */
    private C14218d f37457a;

    /* renamed from: b */
    private Map<String, String> f37458b;

    /* renamed from: f */
    private AbstractC14267a f37459f;
    ...
    public void mo52179a(Object... objArr) {
        ...
        this.f37457a = (C14218d) objArr[0];
        this.f37458b = (Map) objArr[1];
        this.f37459f = (AbstractC14267a) objArr[2];
    }
    ...
    public Object a_(AbstractC20233b<Pair<AbstractC14208a, UpdatePackage>> bVar, Pair<Uri, UpdatePackage> pair) throws Throwable {
        ...
        String a = C14351b.m57814a(this.f37458b, accessKey, updatePackage.getGroupName(), updatePackage.getChannel());
        if (!TextUtils.isEmpty(a)) {
            ...
            file.mkdirs();
            AbstractC14208a a2 = C14212a.m57400a(this.f37457a.mo52133a(), new File(file, "patch.tmp"), length);
            try {
                this.f37457a.mo52143i().mo52250a(uri, length, new C14210b(a2, this.f37459f, updatePackage, length));
                try {
            ...
            throw new DownloadException("download patch zip failed:can not find the file path for accessKey:" + accessKey, null);
        }
    }
}
