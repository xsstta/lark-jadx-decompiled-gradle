...
/* renamed from: com.bytedance.geckox.d.b.b.f */
public class C14245f extends AbstractC20235d<Pair<File, UpdatePackage>, Pair<UpdatePackage, Long>> {
    /* renamed from: a */
    public Object a_(AbstractC20233b<Pair<UpdatePackage, Long>> bVar, Pair<File, UpdatePackage> pair) throws Throwable {
        C14276b.m57604a("gecko-debug-tag", "start active merged zip file, channel:", ((UpdatePackage) pair.second).getChannel());
