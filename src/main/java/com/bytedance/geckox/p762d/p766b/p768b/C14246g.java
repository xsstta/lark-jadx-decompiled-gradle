...
/* renamed from: com.bytedance.geckox.d.b.b.g */
public class C14246g extends AbstractC20235d<Pair<AbstractC14208a, UpdatePackage>, Pair<File, UpdatePackage>> {
    /* renamed from: a */
    public Object a_(AbstractC20233b<Pair<File, UpdatePackage>> bVar, Pair<AbstractC14208a, UpdatePackage> pair) throws Throwable {
        C14276b.m57604a("gecko-debug-tag", "start unzip merged zip file, channel:", ((UpdatePackage) pair.second).getChannel());
        AbstractC14208a aVar = (AbstractC14208a) pair.first;
        UpdatePackage updatePackage = (UpdatePackage) pair.second;
        File parentFile = aVar.mo52105f().getParentFile();
        try {
            m57512a(0, parentFile, updatePackage, aVar, (DataException) null);
    ...
    /* renamed from: a */
    private void m57512a(int i, File file, UpdatePackage updatePackage, AbstractC14208a aVar, DataException dataException) throws Exception {
        ...
        if (i < 2) {
            try {
                ...
                m57512a(i + 1, file, updatePackage, aVar, e);
            }
        } else {
            C14357e.m57823a(file);
            throw dataException;
