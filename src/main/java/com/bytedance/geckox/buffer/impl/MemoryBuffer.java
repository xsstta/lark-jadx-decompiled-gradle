...
class MemoryBuffer implements AbstractC14208a {
    ...
    /* renamed from: d */
    private AtomicBoolean f37380d;

    /* renamed from: e */
    private File f37381e;
    ...
    public void mo52095a() throws IOException {
        if (!this.f37380d.get()) {
            nFlush(this.f37378b, this.f37381e.getAbsolutePath(), this.f37377a);
            return;
        }
    ...
    public void mo52104e() {
        if (!this.f37380d.getAndSet(true)) {
            nRelease(this.f37378b, this.f37377a);
            this.f37378b = 0;
        }
    }
    ...
    public synchronized long mo52094a(long j) throws IOException {
        if (this.f37380d.get()) {
            ...
            long j2 = this.f37379c;
            long j3 = j + j2;
            this.f37379c = j3;
            if (j3 < 0) {
                this.f37379c = 0;
            } else {
                long j4 = this.f37377a;
                if (j3 > j4) {
                    this.f37379c = j4;
                }
            }
            return this.f37379c - j2;
        }
    }
    ...
    public void mo52101b(long r4) throws java.io.IOException {
        /*
            r3 = this;
            java.util.concurrent.atomic.AtomicBoolean r0 = r3.f37380d
            boolean r0 = r0.get()
        ...
        L_0x001a:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.geckox.buffer.impl.MemoryBuffer.mo52101b(long):void");
    }
    ...
    public int mo52093a(byte[] bArr, int i, int i2) throws IOException {
        if (this.f37380d.get()) {
            ...
            synchronized (this) {
                ...
                nWrite(this.f37378b, j, bArr, i, i2);
                this.f37379c += (long) i2;
                return i2;
            }
        }
    }
    ...
    public int mo52099b(byte[] bArr, int i, int i2) throws IOException {
        if (this.f37380d.get()) {
            ...
            synchronized (this) {
                ...
                nRead(this.f37378b, j, bArr, i, i2);
                this.f37379c += (long) i2;
                return i2;
            }
        }
