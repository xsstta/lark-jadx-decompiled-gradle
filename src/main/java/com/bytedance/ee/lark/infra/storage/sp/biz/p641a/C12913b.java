...
/* renamed from: com.bytedance.ee.lark.infra.storage.sp.biz.a.b */
public class C12913b extends AbstractC12907e {

    /* renamed from: b */
    private IAppContext f34409b;

    /* renamed from: com.bytedance.ee.lark.infra.storage.sp.biz.a.b$1 */
    static /* synthetic */ class C129141 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.bytedance.ee.lark.infra.storage.sp.biz.p641a.C12913b.C129141.f34410a = r0
            ...
            L_0x0012:
                int[] r0 = com.bytedance.ee.lark.infra.storage.sp.biz.p641a.C12913b.C129141.f34410a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bytedance.ee.lark.infra.storage.sp.biz.p641a.C12913b.C129141.<clinit>():void");
        }
    }

    public C12913b(IAppContext iAppContext) {
        super(iAppContext);
        this.f34409b = iAppContext;
    }
    ...
    public String mo48675a(AppBaseStorage.StorageType storageType) {
        int i = C129141.f34410a[storageType.ordinal()];
        if (i == 1) {
            return Storage.getStorageFilePrefix("card_storage_") + this.f34409b.getAppIdentify();
        } else if (i != 2) {
            return super.mo48675a(storageType);
        } else {
            return Storage.getStorageFilePrefix("card_i_storage_") + this.f34409b.getAppIdentify();
        }
    }
}
