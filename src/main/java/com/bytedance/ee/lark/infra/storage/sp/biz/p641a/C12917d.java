...
/* renamed from: com.bytedance.ee.lark.infra.storage.sp.biz.a.d */
public class C12917d extends AbstractC12907e {

    /* renamed from: com.bytedance.ee.lark.infra.storage.sp.biz.a.d$1 */
    static /* synthetic */ class C129181 {

        /* renamed from: a */
        static final /* synthetic */ int[] f34412a;
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.bytedance.ee.lark.infra.storage.sp.biz.p641a.C12917d.C129181.f34412a = r0
            ...
            L_0x0012:
                int[] r0 = com.bytedance.ee.lark.infra.storage.sp.biz.p641a.C12917d.C129181.f34412a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bytedance.ee.lark.infra.storage.sp.biz.p641a.C12917d.C129181.<clinit>():void");
        }
    }

    public C12917d(IAppContext iAppContext) {
        super(iAppContext);
    }
    ...
    public String mo48675a(AppBaseStorage.StorageType storageType) {
        int i = C129181.f34412a[storageType.ordinal()];
        if (i == 1) {
            return Storage.getStorageFilePrefix("webapp_storage_") + this.f34405a.getAppId();
        } else if (i != 2) {
            return super.mo48675a(storageType);
        } else {
            return Storage.getStorageFilePrefix("webapp_i_storage_") + this.f34405a.getAppId();
        }
    }
}
