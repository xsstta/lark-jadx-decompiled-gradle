...
public class GetNodePermPuller extends AbstractC12451a<Params, WikNodePerm> {
    ...
    GetNodePermPuller(NetService netService) {
        super(netService, "/space/api/wiki/v2/perm/node/", 2);
    }
}
