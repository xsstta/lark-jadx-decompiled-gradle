...
public class FavoritePuller extends AbstractC12451a<Params, Result> {
    ...
    FavoritePuller(NetService netService) {
        super(netService, "/space/api/wiki/v2/tree/star/new/", 1);
    }
}
