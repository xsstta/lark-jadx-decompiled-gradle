...
public class UnStarSpacePuller extends AbstractC12451a<Params, Result> {
    ...
    UnStarSpacePuller(NetService netService) {
        super(netService, "/space/api/wiki/v2/space/star/delete/", 1);
    }
}
