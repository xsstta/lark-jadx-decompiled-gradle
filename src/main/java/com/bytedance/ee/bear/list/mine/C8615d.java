...
/* renamed from: com.bytedance.ee.bear.list.mine.d */
public class C8615d extends AbstractC8509a {
    ...
    public void mo30969h() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString("key_module", "personal");
        bundle.putString("key_sub_module", mo33273f());
        bundle.putString("key_token", "mine");
        bundle.putBoolean("key_sort_filter_enable", false);
        bundle.putParcelable("key_sort_strategy", this.f23027i);
        C8140a.m32491a(this.f23019a.getActivity(), C8777j.class, bundle);
        ListAnalysis.m32523a("ccm_space_personal_page_click", "personal", mo33273f(), "filter", "ccm_space_header_filter_view", "", "", C8275a.f22369b.mo32555b(), "", "", false, false, false, 0, null, "");
    }

    /* renamed from: a */
    private String m35994a(int i) {
    ...
    public void mo30965b(boolean z) {
        super.mo30965b(z);
        ListAnalysis.m32518a("ccm_space_personal_page_click", "personal", mo33273f(), "", "", C8275a.f22369b.mo32555b(), "", false, false, false, 0, "");
    }
    ...
    public void mo33268a(FolderSortStrategy folderSortStrategy) {
        ...
        this.f23021c.mo33136a(m35994a(folderSortStrategy.mo31549b()));
        this.f23022d.mo33136a(m35994a(folderSortStrategy.mo31549b()));
    }

    C8615d(C7662a aVar, Context context, C10917c cVar, AppBarLayout appBarLayout) {
    ...
    public void mo33267a(C7667e eVar, Context context, C10917c cVar, View view) {
        if (((AbstractC5197b) KoinJavaComponent.m268610a(AbstractC5197b.class)).mo20801b().mo20777c().f14914a) {
            this.f23024f = new C8614c(context, view, cVar);
            this.f23023e = new C8613b(eVar, context, new C8612a(cVar), this.f23024f, cVar);
            this.f23023e.create();
            return;
        }
