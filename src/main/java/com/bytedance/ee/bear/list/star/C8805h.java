...
/* renamed from: com.bytedance.ee.bear.list.star.h */
public class C8805h extends BaseHomeFragment {
    @Override // com.bytedance.ee.bear.list.homepage.BaseHomeFragment
    /* renamed from: p */
    public int mo33065p() {
        return R.layout.list_home_favorite;
    }

    @Override // com.bytedance.ee.bear.list.homepage.BaseHomeFragment
    /* renamed from: a */
    public AbstractC8509a mo33060a(C7662a aVar, Context context, C10917c cVar, AppBarLayout appBarLayout) {
        return new C8806i(aVar, context, cVar, appBarLayout);
    }
}
