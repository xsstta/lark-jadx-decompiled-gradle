...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\u0018\u00002\u00020\u0001B%\u0012\u000e\u0010\u0002\u001a\n\u0012\u0004\u0012\u00020\u0004\u0018\u00010\u0003\u0012\u000e\u0010\u0005\u001a\n\u0012\u0004\u0012\u00020\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0006J\u0018\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\nH\u0016R\u0016\u0010\u0005\u001a\n\u0012\u0004\u0012\u00020\u0004\u0018\u00010\u0003X\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u0002\u001a\n\u0012\u0004\u0012\u00020\u0004\u0018\u00010\u0003X\u0004¢\u0006\u0002\n\u0000¨\u0006\f"}, d2 = {"Lcom/bytedance/ee/bear/list/share/ShareDocumentItemDiffCallback;", "Lcom/bytedance/ee/bear/list/list/BaseListItemDiffCallback;", "oldList", "", "Lcom/bytedance/ee/bear/list/dto/Document;", "newList", "(Ljava/util/List;Ljava/util/List;)V", "areContentsTheSame", "", "oldItemPosition", "", "newItemPosition", "list_release"}, mo238835k = 1, mv = {1, 1, 15})
/* renamed from: com.bytedance.ee.bear.list.share.s */
public final class ShareDocumentItemDiffCallback extends BaseListItemDiffCallback {

    /* renamed from: a */
    private final List<Document> f23602a;

    /* renamed from: b */
    private final List<Document> f23603b;
    ...
    public ShareDocumentItemDiffCallback(List<? extends Document> list, List<? extends Document> list2) {
        super(list, list2);
        this.f23602a = list;
        this.f23603b = list2;
    }
    ...
    public boolean mo7383b(int i, int i2) {
        boolean z;
        boolean z2;
        List<Document> list = this.f23602a;
        ...
        if (!z) {
            List<Document> list2 = this.f23603b;
            ...
            if (!z2) {
                Document document = this.f23602a.get(i);
                Document document2 = this.f23603b.get(i2);
                if (!super.mo7383b(i, i2) || !Intrinsics.areEqual(document.mo32494y(), document2.mo32494y()) || !Intrinsics.areEqual(document.mo32399O(), document2.mo32399O())) {
                    return false;
                }
                return true;
            }
