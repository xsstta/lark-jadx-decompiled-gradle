...
/* renamed from: com.bytedance.ee.bear.doc.b.d */
public class C5325d extends AbstractC6041b {
    ...
    public String mo21352b() {
        return "mobile_doc_blockmenu_intro";
    }
    ...
    public boolean mo21351a(C6042c cVar, OnBoardingData onBoardingData) {
        ...
        C13479a.m54764b("DocBlockMenuMission", "DocBlockMenuMission " + onBoardingData.toString());
        C13479a.m54764b("DocBlockMenuMission", "screen width " + C13749l.m55736a() + " screen height " + C13749l.m55748b());
        mo21354b(cVar, onBoardingData);
        return true;
    }

    /* access modifiers changed from: protected */
    /* renamed from: b */
    public void mo21354b(C6042c cVar, OnBoardingData onBoardingData) {
        ...
        C13479a.m54764b("DocBlockMenuMission", "heightP: " + b + "; topP: " + b2);
        ...
        cVar.mo39611b(d.getWindow(), eVar2, null);
    }
}
