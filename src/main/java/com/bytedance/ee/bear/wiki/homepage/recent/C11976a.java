...
import com.bytedance.ee.bear.wiki.homepage.spacebanner.C11987b;
import com.bytedance.ee.bear.wiki.homepage.spacebanner.C11988c;
import com.bytedance.ee.bear.wiki.homepage.spacebanner.C11989d;
import com.google.android.material.appbar.AppBarLayout;

/* renamed from: com.bytedance.ee.bear.wiki.homepage.recent.a */
public class C11976a extends AbstractC8509a {

    /* renamed from: k */
    private C11987b f32351k;
    ...
    public C11976a(C7662a aVar, Context context, C10917c cVar, AppBarLayout appBarLayout) {
    ...
    public void mo33267a(C7667e eVar, Context context, C10917c cVar, View view) {
        this.f32351k = new C11987b(context, cVar);
        this.f23024f = new C11989d(context, view, cVar);
        this.f32351k.mo45928b(3);
        this.f23023e = new C11988c(eVar, context, this.f32351k, this.f23024f, cVar);
        this.f23023e.create();
    }
}
