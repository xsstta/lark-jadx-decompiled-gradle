...
import com.bytedance.ee.bear.wiki.homepage.C11970b;
...
public class WikiException extends DocException {
    ...
    public static WikiInfo validate(Context context, C10917c cVar, WikiInfo wikiInfo, boolean z) throws WikiException {
        if (wikiInfo != null) {
                ...
                if (code != 4) {
                    if (code != 920004002) {
                        if (!(code == 920004007 || code == 920004012)) {
                            if (wikiInfo.getObjType() != -1 && !C11970b.m49573a(cVar, wikiInfo.getObjType())) {
            ...
            if (z) {
                throw new WikiException(920004002, context.getString(R.string.Doc_Wiki_PageRemovedTextClickable));
            }
            throw new WikiException(920004002, context.getString(R.string.Doc_Wiki_PageRemovedText));
        }
        throw new WikiException(-8011, "");
    }
}
