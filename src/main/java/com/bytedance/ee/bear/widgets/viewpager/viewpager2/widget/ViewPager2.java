...
import com.bytedance.ee.bear.widgets.viewpager.viewpager2.adapter.StatefulAdapter;
...
public class ViewPager2 extends ViewGroup {
    ...
    private RecyclerView.AdapterDataObserver mCurrentItemDataSetChangeObserver = new DataSetChangeObserver() {
        /* class com.bytedance.ee.bear.widgets.viewpager.viewpager2.widget.ViewPager2.C118731 */

        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver, com.bytedance.ee.bear.widgets.viewpager.viewpager2.widget.ViewPager2.DataSetChangeObserver
    ...
    public abstract class AccessibilityProvider {
        ...
        /* access modifiers changed from: package-private */
        public void onLmInitializeAccessibilityNodeInfo(C0864d dVar) {
        }
    ...
    private RecyclerView.AbstractC1336e enforceChildFillListener() {
        return new RecyclerView.AbstractC1336e() {
            /* class com.bytedance.ee.bear.widgets.viewpager.viewpager2.widget.ViewPager2.C118764 */
    ...
    public class BasicAccessibilityProvider extends AccessibilityProvider {
        @Override // com.bytedance.ee.bear.widgets.viewpager.viewpager2.widget.ViewPager2.AccessibilityProvider
        public boolean handlesRvGetAccessibilityClassName() {
            return true;
        }
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() {
            /* class com.bytedance.ee.bear.widgets.viewpager.viewpager2.widget.ViewPager2.SavedState.C118771 */
    ...
    /* access modifiers changed from: private */
    public class PagerSnapHelperImpl extends C1404s {
        PagerSnapHelperImpl() {
        }
    ...
    public class LinearLayoutManagerImpl extends LinearLayoutManager {
        ...
        public int getExtraLayoutSpace(RecyclerView.State state) {
            ...
            return ViewPager2.this.getPageSize() * offscreenPageLimit;
        }
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        recyclerViewImpl.setId(ViewCompat.m4025a());
        ...
        C118742 r3 = new OnPageChangeCallback() {
            /* class com.bytedance.ee.bear.widgets.viewpager.viewpager2.widget.ViewPager2.C118742 */
        ...
        C118753 r4 = new OnPageChangeCallback() {
            /* class com.bytedance.ee.bear.widgets.viewpager.viewpager2.widget.ViewPager2.C118753 */
