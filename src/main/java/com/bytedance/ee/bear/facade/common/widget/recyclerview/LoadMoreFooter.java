...
public final class LoadMoreFooter extends RelativeLayout implements AbstractC27125d {
    ...
    public LoadMoreFooter(Context context) {
        ...
        m30974a(context, (AttributeSet) null, 0);
    }

    /* renamed from: a */
    private final LoadMoreFooter m30973a(int i) {
        this.f20965f = i;
        setBackgroundColor(i);
        AbstractC27128g gVar = this.f20964e;
        if (gVar == null) {
            Intrinsics.throwUninitializedPropertyAccessException("mRefreshKernel");
        }
        if (gVar != null) {
            AbstractC27128g gVar2 = this.f20964e;
            if (gVar2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("mRefreshKernel");
            }
            gVar2.mo96461b(this.f20965f);
        }
        return this;
    }
    ...
    public void setPrimaryColors(int... iArr) {
        ...
        if (this.f20961b == SpinnerStyle.FixedBehind) {
            if (iArr.length == 0) {
                z = true;
            } else {
                z = false;
    ...
    public boolean mo30338a(boolean z) {
        if (this.f20963d != z) {
            this.f20963d = z;
            if (z) {
                BearLottieView bearLottieView = this.f20960a;
                ...
                BearLottieView bearLottieView2 = this.f20960a;
    ...
    public LoadMoreFooter(Context context, AttributeSet attributeSet) {
        ...
        Intrinsics.checkParameterIsNotNull(context, "context");
        m30974a(context, attributeSet, 0);
    }
    ...
    public void onMeasure(int i, int i2) {
        if (View.MeasureSpec.getMode(i2) == 1073741824) {
            ...
            setPadding(getPaddingLeft(), this.f20966g, getPaddingRight(), this.f20967h);
        }
    ...
    public LoadMoreFooter(Context context, AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkParameterIsNotNull(context, "context");
        m30974a(context, attributeSet, i);
    }
    ...
    /* renamed from: a */
    private final void m30974a(Context context, AttributeSet attributeSet, int i) {
        ...
        BearLottieView bearLottieView3 = this.f20960a;
        if (bearLottieView3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("mLottieAnimationView");
        }
        bearLottieView3.cancelAnimation();
        BearLottieView bearLottieView4 = this.f20960a;
        if (bearLottieView4 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("mLottieAnimationView");
        }
        bearLottieView4.setVisibility(0);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, C13749l.m55758d(context, 66));
        layoutParams.addRule(13);
        BearLottieView bearLottieView5 = this.f20960a;
        if (bearLottieView5 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("mLottieAnimationView");
        }
        addView(bearLottieView5, layoutParams);
        ...
        this.f20962c = obtainStyledAttributes.getInt(1, this.f20962c);
        this.f20961b = SpinnerStyle.values()[obtainStyledAttributes.getInt(3, this.f20961b.ordinal())];
        if (obtainStyledAttributes.hasValue(2)) {
            m30973a(obtainStyledAttributes.getColor(2, 0));
        }
        obtainStyledAttributes.recycle();
        this.f20966g = C13749l.m55758d(context, this.f20966g);
        this.f20967h = C13749l.m55758d(context, this.f20967h);
        if (getPaddingTop() == 0) {
            ...
            this.f20966g = getPaddingTop();
            this.f20967h = getPaddingBottom();
        }
    }
}
