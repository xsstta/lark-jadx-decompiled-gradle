...
public class NotSupportLoadingView extends AbsLoadingView {

    /* renamed from: d */
    private FileLoadingView f19904d;
    ...
    public void mo28890b() {
        this.f19904d.mo28895a(C7096d.m28341a(this.f19887b.mo29494m()));
    }

    @Override // com.bytedance.ee.bear.drive.view.preview.loadingview.AbstractC7403b
    /* renamed from: a */
    public void mo28889a(int i) {
        this.f19904d.setProgress(i);
    }

    public NotSupportLoadingView(Context context, C7553d dVar, C7094b bVar) {
        super(context, dVar, bVar);
        this.f19904d = new FileLoadingView(context);
    }
}
