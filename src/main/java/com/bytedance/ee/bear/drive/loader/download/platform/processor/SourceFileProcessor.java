...
public class SourceFileProcessor extends AbsProcessor {
    ...
    public IProcessor.Result mo27688c() {
        ...
        String b2 = d.mo27592b(b, RustCallback.wrap(d2), mo27691f().mo27678a().mo27672a().mo27536a());
        if (!d.mo27593b(b2)) {
        ...
        d2.mo25451a(b2);
        C13479a.m54764b("DrivePlatform_Processor", getClass().getSimpleName() + " submit rust success, return rust key: " + b2);
        return IProcessor.Result.m28190a();
    }

    public SourceFileProcessor(C7079f fVar) {
        super(fVar);
    }
}
