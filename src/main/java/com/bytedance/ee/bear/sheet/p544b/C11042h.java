...
/* renamed from: com.bytedance.ee.bear.sheet.b.h */
public class C11042h extends AbstractC11035a {
    @Override // com.bytedance.ee.bear.onboarding.export.p516a.AbstractC10397d
    /* renamed from: b */
    public String mo21352b() {
        return "mobile_sheet_newbie_edit";
    }
    ...
    public boolean mo21351a(C6042c cVar, OnBoardingData onBoardingData) {
        ...
        String string = d.getString(R.string.Sheet_Newbie_Edit);
        String string2 = d.getString(R.string.Sheet_Newbie_EditHint);
        View findViewWithTag = c.findViewWithTag(FabItemEnum.input.name());
        if (findViewWithTag == null || mo42113f()) {
            return false;
        }
        findViewWithTag.post(new Runnable(findViewWithTag, string, onBoardingData, string2, cVar, d) {
            /* class com.bytedance.ee.bear.sheet.p544b.$$Lambda$h$nL1SUfuei_B7LftX6deRG_IrRwc */
            ...
            public final void run() {
                C11042h.m45963a(this.f$0, this.f$1, this.f$2, this.f$3, this.f$4, this.f$5);
            }
        });
        return true;
    }
    ...
    /* renamed from: a */
    public static /* synthetic */ void m45963a(View view, String str, OnBoardingData onBoardingData, String str2, C6042c cVar, FragmentActivity fragmentActivity) {
