...
/* renamed from: com.bytedance.ee.bear.sheet.b.j */
public class C11044j extends AbstractC11035a {
    @Override // com.bytedance.ee.bear.onboarding.export.p516a.AbstractC10397d
    /* renamed from: b */
    public String mo21352b() {
        return "mobile_sheet_newbie_search";
    }
    ...
    public boolean mo21351a(C6042c cVar, OnBoardingData onBoardingData) {
        ...
        String string = d.getString(R.string.Sheet_Newbie_Search);
        String string2 = d.getString(R.string.Sheet_Newbie_SearchHint);
        View a = cVar.mo24402b().mo19507a("SEARCH");
        if (a == null || mo42113f()) {
            return false;
        }
        a.post(new Runnable(a, string, onBoardingData, string2, cVar, d) {
            /* class com.bytedance.ee.bear.sheet.p544b.$$Lambda$j$FVoOviYGiNMtWLSocb1htZ4QR58 */
            ...
            public final void run() {
                C11044j.m45968a(this.f$0, this.f$1, this.f$2, this.f$3, this.f$4, this.f$5);
            }
        });
        return true;
    }
    ...
    /* renamed from: a */
    public static /* synthetic */ void m45968a(View view, String str, OnBoardingData onBoardingData, String str2, C6042c cVar, FragmentActivity fragmentActivity) {
        RectF a = C13749l.m55743a(view, 0, 0, 0, 0);
        float a2 = (float) C13749l.m55738a(10);
        a.top += a2;
        a.bottom -= a2;
        float f = ((a.right - a.left) - (a.bottom - a.top)) / 2.0f;
        a.left += f;
        a.right -= f;
        C10390c cVar2 = new C10390c(str, onBoardingData.isLast, a);
        cVar2.mo39561a(str2).mo39560a(FlowStyleHollowShape.Circle);
