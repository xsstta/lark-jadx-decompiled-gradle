...
/* renamed from: com.bytedance.ee.bear.sheet.b.q */
public class C11051q extends AbstractC11035a {
    @Override // com.bytedance.ee.bear.onboarding.export.p516a.AbstractC10397d
    /* renamed from: b */
    public String mo21352b() {
        return "mobile_sheet_redesign_toolbox";
    }
    ...
    public boolean mo21351a(C6042c cVar, OnBoardingData onBoardingData) {
        ...
        findViewWithTag.post(new Runnable(d, d.getString(R.string.Sheet_Redesign_FAB), findViewWithTag) {
            /* class com.bytedance.ee.bear.sheet.p544b.$$Lambda$q$vomf0jo7mNaGj_djnHDQrxFSKE */
            ...
            public final void run() {
                C11051q.m45990a(C6042c.this, this.f$1, this.f$2, this.f$3);
            }
        });
        return true;
    }
    ...
    /* renamed from: a */
    public static /* synthetic */ void m45990a(C6042c cVar, FragmentActivity fragmentActivity, String str, View view) {
