...
/* renamed from: com.bytedance.ee.bear.sheet.b.n */
public class C11048n extends AbstractC11035a {
    @Override // com.bytedance.ee.bear.onboarding.export.p516a.AbstractC10397d
    /* renamed from: b */
    public String mo21352b() {
        return "mobile_sheet_redesign_cardMode";
    }
    ...
    public boolean mo21351a(C6042c cVar, OnBoardingData onBoardingData) {
        ...
        View findViewWithTag = cVar.mo24403c().findViewWithTag(FabItemEnum.cardMode.name());
        if (findViewWithTag == null || mo42113f()) {
            return false;
        }
        findViewWithTag.post(new Runnable(d, d.getString(R.string.Sheet_Redesign_CardMode), findViewWithTag) {
            /* class com.bytedance.ee.bear.sheet.p544b.$$Lambda$n$Tj9R13v66xpfHWDjdjsxxUjhkYI */
            ...
            public final void run() {
                C11048n.m45981a(C6042c.this, this.f$1, this.f$2, this.f$3);
            }
        });
        return true;
    }
    ...
    /* renamed from: a */
    public static /* synthetic */ void m45981a(C6042c cVar, FragmentActivity fragmentActivity, String str, View view) {
