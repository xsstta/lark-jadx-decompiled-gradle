...
import com.bytedance.ee.bridge.connectormodule.RNGetRandomValuesModule;
...
/* renamed from: com.bytedance.ee.bridge.c */
public class C12601c extends AbstractC21102c {
    ...
    public List<ModuleSpec> mo47878a(final ReactApplicationContext reactApplicationContext) {
        return Arrays.asList(ModuleSpec.nativeModuleSpec(RNGetRandomValuesModule.class, new Provider<NativeModule>() {
            /* class com.bytedance.ee.bridge.C12601c.C126021 */
