...
public final class SearchUserInLobbyDialog extends AbstractView$OnAttachStateChangeListenerC61219a {
    ...
    public View mo211669a(Activity activity) {
        ...
        SearchUserInLobbyViewHolder cVar = new SearchUserInLobbyViewHolder(activity, kVar, this);
        this.f156252h = cVar;
        if (cVar == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewHolder");
        }
        return cVar.mo215137c();
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SearchUserInLobbyDialog(Activity activity, C61303k kVar, SearchParticipantInfo searchParticipantInfo, AbstractC62201a aVar) {
        super(activity, kVar);
        Intrinsics.checkParameterIsNotNull(activity, "activity");
        Intrinsics.checkParameterIsNotNull(kVar, "meeting");
        SearchUserInLobbyViewHolder cVar = this.f156252h;
        if (cVar == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewHolder");
        }
        cVar.mo215134a(searchParticipantInfo, aVar);
    }
}
