...
public final class HostAdvancedOptionsDialog extends AbstractView$OnAttachStateChangeListenerC61215b {
    ...
    public void mo211643j() {
        HostAdvancedOptionsViewHolder fVar = this.f157479e;
        if (fVar != null) {
            fVar.bY_();
        }
    }
    ...
    public void mo211606a() {
        if (bL_() != null) {
            ...
            this.f157478d = window.getStatusBarColor();
    ...
    public View mo211632b(Activity activity) {
        ...
        HostAdvancedOptionsViewHolder fVar = new HostAdvancedOptionsViewHolder(activity, kVar, this);
        this.f157479e = fVar;
        if (fVar == null) {
            Intrinsics.throwNpe();
        }
    ...
    public HostAdvancedOptionsDialog(Activity activity, C61303k kVar) {
        super(activity, kVar);
