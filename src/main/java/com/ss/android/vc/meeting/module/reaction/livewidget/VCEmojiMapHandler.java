...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\u0010\b\n\u0002\b\f\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0014\u0010\u0010\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u0004H\u0002J\u0014\u0010\u0011\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00060\u0004H\u0002R-\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u00048FX\u0002¢\u0006\u0012\n\u0004\b\n\u0010\u000b\u0012\u0004\b\u0007\u0010\u0002\u001a\u0004\b\b\u0010\tR-\u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00060\u00048FX\u0002¢\u0006\u0012\n\u0004\b\u000f\u0010\u000b\u0012\u0004\b\r\u0010\u0002\u001a\u0004\b\u000e\u0010\t¨\u0006\u0012"}, d2 = {"Lcom/ss/android/vc/meeting/module/reaction/livewidget/VCEmojiMapHandler;", "", "()V", "destToUnicodeMap", "", "", "", "destToUnicodeMap$annotations", "getDestToUnicodeMap", "()Ljava/util/Map;", "destToUnicodeMap$delegate", "Lkotlin/Lazy;", "emojiMap", "emojiMap$annotations", "getEmojiMap", "emojiMap$delegate", "generateDestToEmojiMap", "generateEmojiMap", "lib_vc_suiteRelease"}, mo238835k = 1, mv = {1, 1, 16})
/* renamed from: com.ss.android.vc.meeting.module.reaction.livewidget.a */
public final class VCEmojiMapHandler {

    /* renamed from: a */
    public static final VCEmojiMapHandler f158212a = new VCEmojiMapHandler();

    /* renamed from: b */
    private static final Lazy f158213b = LazyKt.lazy(C62839a.INSTANCE);

    /* renamed from: c */
    private static final Lazy f158214c = LazyKt.lazy(C62840b.INSTANCE);

    /* renamed from: a */
    public static final Map<String, Integer> m245975a() {
        return (Map) f158213b.getValue();
    }

    /* renamed from: b */
    public static final Map<Integer, Integer> m245976b() {
        return (Map) f158214c.getValue();
    }

    private VCEmojiMapHandler() {
    }

    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\u0010\b\n\u0000\u0010\u0000\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001H\n¢\u0006\u0002\b\u0004"}, d2 = {"<anonymous>", "", "", "", "invoke"}, mo238835k = 3, mv = {1, 1, 16})
    /* renamed from: com.ss.android.vc.meeting.module.reaction.livewidget.a$a */
    static final class C62839a extends Lambda implements Function0<Map<String, ? extends Integer>> {
        public static final C62839a INSTANCE = new C62839a();
        ...
        public final Map<String, ? extends Integer> invoke() {
            return VCEmojiMapHandler.f158212a.mo217147c();
        }
    }

    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\f\n\u0000\n\u0002\u0010$\n\u0002\u0010\b\n\u0000\u0010\u0000\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00020\u0001H\n¢\u0006\u0002\b\u0003"}, d2 = {"<anonymous>", "", "", "invoke"}, mo238835k = 3, mv = {1, 1, 16})
    /* renamed from: com.ss.android.vc.meeting.module.reaction.livewidget.a$b */
    static final class C62840b extends Lambda implements Function0<Map<Integer, ? extends Integer>> {
        public static final C62840b INSTANCE = new C62840b();
        ...
        public final Map<Integer, ? extends Integer> invoke() {
            return VCEmojiMapHandler.f158212a.mo217148d();
        }
    }

    /* renamed from: c */
    public final Map<String, Integer> mo217147c() {
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        linkedHashMap.put(129851, new String[]{"[Lark_Emoji_Blubber_0]", "[泣きそう]", "[快哭了]", "[Blubber]", "[Weeping]"});
        linkedHashMap.put(129882, new String[]{"[Trick]", "[Lark_Emoji_Trick_0]", "[憨笑]", "[馬鹿笑い]"});
        ...
        linkedHashMap.put(129906, new String[]{"[Grin]", "[ニヤリ]", "[Lark_Emoji_Grin_0]", "[呲牙]", "[Blush]", "[歯を見せて笑う]"});
        ...
        linkedHashMap.put(129886, new String[]{"[酷拽]", "[Lark_Emoji_haughty_0]", "[クールでかっこいい]", "[Haughty]", "[haughty]", "[Ruthless]"});
        ...
        linkedHashMap.put(129793, new String[]{"[Lark_Emoji_Applaud_0]", "[Applaud]", "[Applause]", "[鼓掌]", "[拍手]"});
        ...
        linkedHashMap.put(129864, new String[]{"[行かないで]", "[紫薇别走]", "[Don't go]", "[DonnotGo]", "[Lark_Emoji_DonnotGo_0]", "[Amazed]"});
        linkedHashMap.put(129819, new String[]{"[Lark_Emoji_BlackFace_0]", "[黑脸]", "[不機嫌]", "[New Moon Face]", "[MoonFace]", "[BlackFace]", "[黒顔]"});
        ...
        linkedHashMap.put(129825, new String[]{"[Lark_Emoji_Tease_0]", "[做鬼脸]", "[あっかんべえをする]", "[Goofy]", "[あっかんべえ]", "[Tease]"});
        ...
        linkedHashMap.put(129863, new String[]{"[脸红]", "[赤面]", "[Lark_Emoji_Blush_0]", "[XBlush]", "[Blushed]", "[おとなしい]"});
        ...
        linkedHashMap.put(129907, new String[]{"[+1]", "[Jiayi]"});
        ...
        linkedHashMap.put(129838, new String[]{"[クール]", "[Lark_Emoji_ShowOff_0]", "[ShowOff]", "[Cool]", "[酷]", "[かっこいい]"});
        ...
        linkedHashMap.put(129873, new String[]{"[Errr]", "[Error]", "[縦線]", "[Lark_Emoji_Errr_0]", "[黑线]", "[言葉が出ない]"});
        linkedHashMap.put(129837, new String[]{"[口から虹を出す]", "[吐彩虹]", "[Lark_Emoji_RainbowPuke_0]", "[RainbowPuke]", "[Rainbow]", "[彩虹]", "[虹]"});
        linkedHashMap.put(129888, new String[]{"[加油]", "[Fighting]", "[Muscle]", "[Lark_Emoji_Fighting_0]", "[頑張れ]", "[Strength]"});
    ...
    /* renamed from: d */
    public final Map<Integer, Integer> mo217148d() {
        LinkedHashMap linkedHashMap = new LinkedHashMap();
