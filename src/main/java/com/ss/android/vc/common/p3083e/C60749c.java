...
/* renamed from: com.ss.android.vc.common.e.c */
public class C60749c {
    /* renamed from: a */
    public static Bitmap m236070a(Bitmap bitmap, int i, int i2) {
        return m236071a(Bitmap.createScaledBitmap(bitmap, bitmap.getWidth() / i, bitmap.getHeight() / i, false), i2, true);
    }

    /* renamed from: a */
    private static Bitmap m236071a(Bitmap bitmap, int i, boolean z) {
        Bitmap bitmap2;
        int[] iArr;
        int i2 = i;
        if (z) {
