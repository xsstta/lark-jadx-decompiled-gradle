...
/* renamed from: com.ss.android.vc.lark.notification.prompt.b */
public class C61160b implements AbstractNotification.AbstractC48494a {
    ...
    public void mo135461a(Notice notice) {
        if (notice == null || TextUtils.isEmpty(notice.key)) {
            C60700b.m235864f("PromptLog_CalendarPromptNotificationCanceler", "[cancel]", "because notice or key is null");
            return;
        }
        C60700b.m235851b("PromptLog_CalendarPromptNotificationCanceler", "[cancel2]", "notice.key = " + notice.key);
