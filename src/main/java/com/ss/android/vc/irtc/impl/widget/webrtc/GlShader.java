...
class GlShader {
    ...
    public void release() {
        C61064p.m237486b("GlShader", "Deleting shader.");
        int i = this.program;
        if (i != -1) {
    ...
    private static int compileShader(int i, String str) {
        ...
        if (glCreateShader != 0) {
            ...
            C61064p.m237487c("GlShader", "Compile error " + GLES20.glGetShaderInfoLog(glCreateShader) + " in shader:\n" + str);
    ...
    public GlShader(String str, String str2) {
        ...
        if (glCreateProgram != 0) {
            ...
            C61064p.m237487c("GlShader", "Could not link program: " + GLES20.glGetProgramInfoLog(this.program));
