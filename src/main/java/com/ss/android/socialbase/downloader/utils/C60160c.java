...
public class C60160c {
    /* renamed from: a */
    public static void m233740a(int i, SparseArray<IDownloadListener> sparseArray, boolean z, DownloadInfo downloadInfo, BaseException baseException) {
                ...
                if (sparseArray.size() > 0) {
                    ...
                    for (int i2 = 0; i2 < clone.size(); i2++) {
                        ...
                        if (iDownloadListener != null) {
                            ...
                            } else if (iDownloadListener instanceof AbstractC60030h) {
