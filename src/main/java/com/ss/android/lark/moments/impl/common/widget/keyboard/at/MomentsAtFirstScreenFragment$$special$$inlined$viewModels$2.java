...
public final class MomentsAtFirstScreenFragment$$special$$inlined$viewModels$2 extends Lambda implements Function0<ak> {
    final /* synthetic */ Function0 $ownerProducer;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MomentsAtFirstScreenFragment$$special$$inlined$viewModels$2(Function0 function0) {
        super(0);
