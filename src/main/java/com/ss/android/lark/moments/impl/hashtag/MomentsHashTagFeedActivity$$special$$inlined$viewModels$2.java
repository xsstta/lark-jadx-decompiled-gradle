...
public final class MomentsHashTagFeedActivity$$special$$inlined$viewModels$2 extends Lambda implements Function0<ak> {
    final /* synthetic */ ComponentActivity $this_viewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MomentsHashTagFeedActivity$$special$$inlined$viewModels$2(ComponentActivity componentActivity) {
        super(0);
