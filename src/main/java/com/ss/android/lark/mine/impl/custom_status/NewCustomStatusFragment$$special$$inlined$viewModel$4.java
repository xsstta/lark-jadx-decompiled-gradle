...
public final class NewCustomStatusFragment$$special$$inlined$viewModel$4 extends Lambda implements Function0<String> {
    final /* synthetic */ KClass $viewModelClass;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NewCustomStatusFragment$$special$$inlined$viewModel$4(KClass kClass) {
        super(0);
