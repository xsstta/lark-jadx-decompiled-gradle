...
public class GetConnectedWifiHandlerV2 extends AbstractInjectJSApiHandler<BaseJSModel> implements Parcelable {
    public static final Parcelable.Creator<GetConnectedWifiHandlerV2> CREATOR = new Parcelable.Creator<GetConnectedWifiHandlerV2>() {
        /* class com.ss.android.lark.browser.biz.basic.jsapi.device.GetConnectedWifiHandlerV2.C296631 */
    ...
    /* renamed from: a */
    private String[] f74354a = {"android.permission.ACCESS_FINE_LOCATION"};
    ...
    protected GetConnectedWifiHandlerV2(Parcel parcel) {
        super(parcel);
        this.f74354a = parcel.createStringArray();
    }

    /* renamed from: a */
    private String m109768a(WifiInfo wifiInfo) {
    ...
    /* renamed from: a */
    private int m109767a(WifiConfiguration wifiConfiguration) {
    ...
    /* renamed from: a */
    private void m109769a(AbstractC25832c cVar) {
        WifiManager wifiManager = (WifiManager) mo91997u().getApplicationContext().getSystemService("wifi");
        WifiInfo connectionInfo = wifiManager.getConnectionInfo();
        JSONObject jSONObject = new JSONObject();
        jSONObject.put("SSID", (Object) m109768a(connectionInfo));
        jSONObject.put("BSSID", (Object) connectionInfo.getBSSID());
        jSONObject.put("secure", (Object) Boolean.valueOf(m109772a(wifiManager, connectionInfo)));
    ...
    /* renamed from: a */
    public /* synthetic */ void m109770a(AbstractC25832c cVar, Boolean bool) throws Exception {
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeStringArray(this.f74354a);
    }

    /* renamed from: a */
    private boolean m109772a(WifiManager wifiManager, WifiInfo wifiInfo) {
        int i;
        try {
    ...
    public void mo91861a(BaseJSModel baseJSModel, AbstractC25832c cVar) {
        if (!NetworkUtils.getNetworkType(mo91997u()).isWifi()) {
            m109771a(cVar, "no wifi connected", 413002);
        } else {
            new C51331a(mo91997u()).mo176924c(this.f74354a).subscribe(new Consumer(cVar) {
                /* class com.ss.android.lark.browser.biz.basic.jsapi.device.$$Lambda$GetConnectedWifiHandlerV2$r2N0NtVPYJTd2OfGau2zSt2yWU */
                ...
                public final void accept(Object obj) {
                    GetConnectedWifiHandlerV2.this.m109770a((GetConnectedWifiHandlerV2) this.f$1, (AbstractC25832c) ((Boolean) obj));
                }
            });
        }
    }
    ...
    /* renamed from: a */
    private void m109771a(AbstractC25832c cVar, String str, int i) {
        if (cVar != null) {
            JSONObject jSONObject = new JSONObject();
