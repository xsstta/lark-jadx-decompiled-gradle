...
/* renamed from: com.ss.android.lark.widget.select.c */
public class C59118c {
    /* renamed from: a */
    private static boolean m229640a(Layout layout, int i) {
    ...
    /* renamed from: a */
    public static int m229639a(SelectableView selectableView, int i, int i2, int i3) {
        Layout layout = selectableView.getLayout();
        if (layout == null) {
            return -1;
        }
        int lineForVertical = layout.getLineForVertical(i2);
        if (m229640a(layout, i3)) {
        ...
        if (offsetForHorizontal >= selectableView.getContent().length() - 1) {
            return offsetForHorizontal;
        }
        int i5 = offsetForHorizontal + 1;
        if (!m229640a(layout, i5)) {
            return offsetForHorizontal;
        }
