...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\u00020\u00012\u00020\u0002B\u0005¢\u0006\u0002\u0010\u0003J\b\u0010\t\u001a\u00020\u0005H\u0016J\b\u0010\n\u001a\u00020\u000bH\u0016J\b\u0010\f\u001a\u00020\rH\u0016J\u0010\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u0005H\u0016J&\u0010\u0011\u001a\u0004\u0018\u00010\r2\u0006\u0010\u0012\u001a\u00020\u00132\b\u0010\u0014\u001a\u0004\u0018\u00010\u00152\b\u0010\u0016\u001a\u0004\u0018\u00010\u0017H\u0016J\b\u0010\u0018\u001a\u00020\u000fH\u0016J\u001a\u0010\u0019\u001a\u00020\u000f2\u0006\u0010\u001a\u001a\u00020\r2\b\u0010\u0016\u001a\u0004\u0018\u00010\u0017H\u0016R\u000e\u0010\u0004\u001a\u00020\u0005X.¢\u0006\u0002\n\u0000R\u001c\u0010\u0006\u001a\u0010\u0012\f\u0012\n\u0012\u0002\b\u0003\u0012\u0002\b\u00030\b0\u0007X\u0004¢\u0006\u0002\n\u0000¨\u0006\u001b"}, d2 = {"Lcom/ss/android/lark/mm/module/detail/contentdetail/MmContentDetailFragment;", "Lcom/ss/android/lark/mm/module/detail/main/MmBaseDetailFragment;", "Lcom/ss/android/lark/mm/module/framework/IMmViewControlContext;", "()V", "mContext", "Landroid/content/Context;", "viewControls", "", "Lcom/ss/android/lark/mm/module/framework/MmBaseViewControl;", "getMContext", "getMmTimeExecutor", "Lcom/ss/android/lark/mm/utils/timer/MmTimerExecutor;", "getRootView", "Landroid/view/View;", "onAttach", "", "context", "onCreateView", "inflater", "Landroid/view/LayoutInflater;", "container", "Landroid/view/ViewGroup;", "savedInstanceState", "Landroid/os/Bundle;", "onDestroy", "onViewCreated", "view", "mm_release"}, mo238835k = 1, mv = {1, 1, 16})
/* renamed from: com.ss.android.lark.mm.module.detail.a.f */
public final class MmContentDetailFragment extends MmBaseDetailFragment implements IMmViewControlContext {

    /* renamed from: a */
    private final List<MmBaseViewControl<?, ?>> f115796a = new ArrayList();

    /* renamed from: b */
    private Context f115797b;

    /* renamed from: c */
    private HashMap f115798c;
    ...
    public View mo161166a(int i) {
        if (this.f115798c == null) {
            this.f115798c = new HashMap();
        }
        View view = (View) this.f115798c.get(Integer.valueOf(i));
        if (view != null) {
            return view;
        }
        View view2 = getView();
        ...
        this.f115798c.put(Integer.valueOf(i), findViewById);
        return findViewById;
    }
    ...
    public void onDestroy() {
        Iterator<T> it = this.f115796a.iterator();
        while (it.hasNext()) {
            it.next().mo161245h();
        }
        this.f115796a.clear();
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (f != null && d != null) {
            String name = MmContentDetailControl.class.getName();
            Intrinsics.checkExpressionValueIsNotNull(name, "MmContentDetailControl::class.java.name");
            d.mo161918b(name);
            this.f115796a.add(new MmContentDetailViewControl(this, new MmContentDetailViewControlAdapter(f, d, new MmContentDetailControl(mo161910g(), mo161911h()))));
            Iterator<T> it = this.f115796a.iterator();
            while (it.hasNext()) {
                it.next().be_();
            }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        return layoutInflater.inflate(R.layout.mm_fragment_detail_content, viewGroup, false);
    }
}
