...
/* renamed from: com.ss.android.lark.app.initiator.h */
public class C28918h implements AbstractC28915e {

    /* renamed from: a */
    final AppLauncherTaskScheduler f72535a = new AppLauncherTaskScheduler();

    /* renamed from: b */
    private BroadcastReceiver f72536b;
    ...
    public void mo102529d(Context context) {
        ...
        context.unregisterReceiver(this.f72536b);
        C51959a.m201528a();
    ...
    public void mo102527b(Context context) {
        ...
        this.f72535a.mo102769a(waitNecessaryTask).mo102770a(context);
    ...
    public void mo102526a(Context context) {
        ...
        this.f72535a.mo102769a(new InitBaseComponentTask()).mo102769a(new InitFeatureGatingTask()).mo102769a(new SpInitorTask()).mo102769a(new InitLanguageTask().mo92544a(SpInitorTask.class)).mo102769a(new InitTTWebViewBasicTask()).mo102769a(new ModuleDependencyInitorTask()).mo102769a(new InitMiraTask()).mo102769a(new InitPrivacyTask()).mo102769a(new InitNightModeTask()).mo102770a(context);
    }

    @Override // com.ss.android.lark.app.initiator.AbstractC28915e
    /* renamed from: c */
    public void mo102528c(Context context) {
        this.f72535a.mo102769a(new InitCrashMonitorTask()).mo102769a(new InitTTWebViewBusinessTask()).mo102769a(new CompressSoLoaderTask()).mo102769a(new InitAppendSoLibPathTask()).mo102769a(new StartMiraTask()).mo102769a(new InitBaseFeatureTask().mo92544a(InitNightModeTask.class)).mo102769a(new InitPerformanceMonitorTask()).mo102769a(new InitAsyncBatteryOptionalTask()).mo102769a(new InitAvatarLoaderTask()).mo102769a(new InitRxJavaTask()).mo102769a(new InitMonitorTask()).mo102770a(context);
        LocaleChangeReceiver localeChangeReceiver = new LocaleChangeReceiver();
        this.f72536b = localeChangeReceiver;
        m105992a(context, localeChangeReceiver, new IntentFilter("android.intent.action.LOCALE_CHANGED"));
        NetworkBroadcastReceiver.m153065a(context);
    }

    @Skip({"com.bytedance.sysoptimizer.ReceiverRegisterCrashOptimizer"})
    /* renamed from: a */
    public static Intent m105992a(Context context, BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        try {
