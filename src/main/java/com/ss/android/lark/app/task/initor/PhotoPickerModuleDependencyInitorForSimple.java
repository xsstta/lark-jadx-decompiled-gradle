...
public class PhotoPickerModuleDependencyInitorForSimple {
    /* renamed from: a */
    public static void m106465a(final Context context) {
        C58612c.m227291a(new C58612c.AbstractC58615c() {
            /* class com.ss.android.lark.app.task.initor.PhotoPickerModuleDependencyInitorForSimple.C290021 */

            /* renamed from: b */
            private final HashMap<C58612c.AbstractC58616d, AbstractC29579a> f72680b = new HashMap<>();
            ...
            public void mo102842a(MessageIdentity messageIdentity, final IGetDataCallback<FileState> iGetDataCallback) {
                ...
                ((ICoreApi) ApiUtils.getApi(ICoreApi.class)).checkFileState(messageId, sourceId, sourceType.getNumber(), m106466a(sourceType), new IGetDataCallback<com.ss.android.lark.biz.core.api.FileState>() {
                    /* class com.ss.android.lark.app.task.initor.PhotoPickerModuleDependencyInitorForSimple.C290021.C290031 */
            ...
            public void mo102844a(MessageIdentity messageIdentity, String str, String str2, IGetDataCallback<String> iGetDataCallback, AbstractC25974h hVar) {
                ...
                Message.SourceType sourceType = messageIdentity.getSourceType();
                ((ICoreApi) ApiUtils.getApi(ICoreApi.class)).downLoadMessageVideo(context, messageId, sourceId, chatId, sourceType.getNumber(), m106466a(sourceType), str, str2, iGetDataCallback, hVar);
            }
            ...
            public void mo102837a(Context context, Fragment fragment, int i, String str, String str2, boolean z, boolean z2, String str3) {
                mo102876a(context, fragment, i, str, str2, "from_preview", z, z2, str3);
            }

            @Override // com.ss.android.lark.widget.photo_picker.C58612c.AbstractC58615c
            /* renamed from: a */
            public void mo102835a(Context context, Fragment fragment, int i, String str, String str2) {
                mo102876a(context, fragment, i, str, str2, "from_picker", false, false, "");
            }

            /* renamed from: a */
            public void mo102876a(Context context, Fragment fragment, int i, String str, String str2, String str3, boolean z, boolean z2, String str4) {
            ...
            public C58612c.AbstractC58614b mo102869l() {
                return new C58612c.AbstractC58614b() {
                    /* class com.ss.android.lark.app.task.initor.PhotoPickerModuleDependencyInitorForSimple.C290021.C290042 */
                    ...
                    public void mo102872a(final File file, boolean z, final C58612c.AbstractC58613a aVar) {
                        C36808a.m145205a(file, z, new C36808a.AbstractC36810a() {
                            /* class com.ss.android.lark.app.task.initor.PhotoPickerModuleDependencyInitorForSimple.C290021.C290042.C290052 */
            ...
            /* renamed from: a */
            private int m106466a(Message.SourceType sourceType) {
            ...
            public void mo102853b(C58612c.AbstractC58616d dVar) {
                ((ICoreApi) ApiUtils.getApi(ICoreApi.class)).removePushResourceDownloadProgressListener(this.f72680b.remove(dVar));
            }
            ...
            public File mo102850b(IRequestCreator iRequestCreator, String str, String str2, String str3, boolean z, int i) {
                return m106467a(str, str2, str3, z, i, false, true);
            }

            @Override // com.ss.android.lark.widget.photo_picker.C58612c.AbstractC58615c
            /* renamed from: a */
            public File mo102827a(IRequestCreator iRequestCreator, String str, String str2, String str3, boolean z, int i) {
                return m106467a(str, str2, str3, z, i, false, false);
            }

            /* renamed from: a */
            private File m106467a(String str, String str2, String str3, boolean z, int i, boolean z2, boolean z3) {
                Object obj;
                boolean z4;
                Object obj2;
                if (z) {
            ...
            public void mo102852b(Context context, Fragment fragment, int i, String str, String str2, boolean z, boolean z2, String str3) {
                mo102876a(context, fragment, i, str, str2, "from_picker", z, z2, str3);
            }
            ...
            public File mo102829a(IRequestCreator iRequestCreator, String str, String str2, String str3, boolean z, boolean z2, boolean z3, int i, boolean z4) {
                return m106467a(str, str2, str3, z, i, z4, false);
            }
            ...
            public File mo102828a(IRequestCreator iRequestCreator, String str, String str2, String str3, boolean z, boolean z2, boolean z3, int i, int i2, ImageFormat imageFormat, int i3, boolean z4) {
                return m106467a(str, str2, str3, z, i3, z4, false);
            }
        });
    }
}
