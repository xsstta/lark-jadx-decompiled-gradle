...
public class SetMenuHandlerV2 extends AbstractInjectJSApiHandler<NavigationMenu> implements Parcelable {
    public static final Parcelable.Creator<SetMenuHandlerV2> CREATOR = new Parcelable.Creator<SetMenuHandlerV2>() {
        /* class com.ss.android.lark.apihandler.basic.jsapi.navigation.SetMenuHandlerV2.C287785 */
    ...
    /* renamed from: com.ss.android.lark.apihandler.basic.jsapi.navigation.SetMenuHandlerV2$a */
    public static final class C28780a implements Serializable {
    ...
    /* renamed from: a */
    private List<CommonPopupRecycleAdapter.ListItem> m105467a(List<NavigationMenu.MenuItem> list) {
    ...
    /* renamed from: a */
    private static Bitmap m105466a(String str) {
    ...
    /* renamed from: b */
    private List<C28780a> m105468b(List<NavigationMenu.MenuItem> list) {
    ...
    /* renamed from: a */
    public String mo102281a(List<NavigationMenu.MenuItem> list, String str) {
        if (TextUtils.isEmpty(str)) {
            return "";
        }
        for (NavigationMenu.MenuItem menuItem : list) {
    ...
    public void mo91861a(NavigationMenu navigationMenu, final AbstractC25832c cVar) {
        ...
        if (i != 0) {
            ...
            List<C28780a> b2 = m105468b((List<NavigationMenu.MenuItem>) arrayList);
            mo91999w().mo67308b().removeAllActions();
            if (b2.size() <= 2) {
                for (C28780a aVar : b2) {
                    if (aVar.getDrawable() == null) {
                        ...
                        b3.addAction(new IActionTitlebar.TextAction(text, i4) {
                            /* class com.ss.android.lark.apihandler.basic.jsapi.navigation.SetMenuHandlerV2.C287741 */

                            @Override // com.ss.android.lark.ui.IActionTitlebar.Action, com.ss.android.lark.ui.IActionTitlebar.BaseAction
                            public void performAction(View view) {
                                super.performAction(view);
                                SetMenuHandlerV2.this.mo102284b();
                                String a = SetMenuHandlerV2.this.mo102281a(arrayList, ((TextView) view).getText().toString());
                        ...
                        mo91999w().mo67308b().addAction(new IActionTitlebar.C57573a(aVar.getDrawable()) {
                            /* class com.ss.android.lark.apihandler.basic.jsapi.navigation.SetMenuHandlerV2.C287752 */
            ...
            b4.addAction(new IActionTitlebar.TextAction(text2, i2) {
                /* class com.ss.android.lark.apihandler.basic.jsapi.navigation.SetMenuHandlerV2.C287763 */
            ...
            if (b) {
                i3 = R.drawable.web_titlebar_more_white_bg_selector;
            } else {
                i3 = R.drawable.web_titlebar_more_bg_selector;
            }
            b5.addAction(new IActionTitlebar.C57573a(i3) {
                /* class com.ss.android.lark.apihandler.basic.jsapi.navigation.SetMenuHandlerV2.C287774 */
                ...
                public void performAction(View view) {
                    ...
                    List list = arrayList;
                    setMenuHandlerV2.mo102282a(view, list.subList(1, list.size()), cVar);
                }
            });
        }
    }
    ...
    /* renamed from: a */
    public void mo102282a(View view, List<NavigationMenu.MenuItem> list, AbstractC25832c cVar) {
        m105469b(view, list, cVar);
    }

    /* renamed from: b */
    private void m105469b(View view, List<NavigationMenu.MenuItem> list, final AbstractC25832c cVar) {
        final List<CommonPopupRecycleAdapter.ListItem> a = m105467a(list);
        C57590d.m223633a(mo91999w().mo67313f(), view, 0, a, new CommonPopupRecycleAdapter.AbstractC57564a() {
            /* class com.ss.android.lark.apihandler.basic.jsapi.navigation.SetMenuHandlerV2.C287796 */

            @Override // com.ss.android.lark.ui.CommonPopupRecycleAdapter.AbstractC57564a
            /* renamed from: a */
            public void mo102289a(View view, int i) {
                String id = ((CommonPopupRecycleAdapter.ListItem) a.get(i)).getId();
                AbstractC25832c cVar = cVar;
                cVar.mo91902a("{\"id\":\"" + id + "\"}");
            }
        });
