...
public class GetGatewayIpHandlerV2 extends AbstractInjectJSApiHandler<BaseJSModel> implements Parcelable {
    public static final Parcelable.Creator<GetGatewayIpHandlerV2> CREATOR = new Parcelable.Creator<GetGatewayIpHandlerV2>() {
        /* class com.ss.android.lark.apihandler.basic.jsapi.device.GetGatewayIpHandlerV2.C287341 */
    ...
    /* renamed from: a */
    private void m105349a(Context context, AbstractC25832c cVar) {
        DhcpInfo dhcpInfo = ((WifiManager) context.getSystemService("wifi")).getDhcpInfo();
        if (dhcpInfo == null) {
            m105350a(cVar, "no dhcp Info", 423003);
            return;
        }
        JSONObject jSONObject = new JSONObject();
        jSONObject.put("ip", (Object) m105348a(dhcpInfo.gateway));
    ...
    public void mo91861a(BaseJSModel baseJSModel, AbstractC25832c cVar) {
        if (mo91997u() == null) {
            m105350a(cVar, "context null", 423000);
        } else if (!NetworkUtils.getNetworkType(mo91997u()).isWifi()) {
            m105350a(cVar, "no wifi connected", 423002);
        } else {
            m105349a(mo91997u(), cVar);
        }
    }

    /* renamed from: a */
    private void m105350a(AbstractC25832c cVar, String str, int i) {
        if (cVar != null) {
            JSONObject jSONObject = new JSONObject();
