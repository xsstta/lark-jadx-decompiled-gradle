...
public final class CreateTeamPickerPiece extends BaseTeamPickerPiece {
    ...
    public ChatterPickerParams.Builder mo189641d() {
        return new ChatterPickerParams.Builder().mo183676h(true).mo183716m(false).mo183718n(false).mo183678j(true).mo183728s(false);
    }
