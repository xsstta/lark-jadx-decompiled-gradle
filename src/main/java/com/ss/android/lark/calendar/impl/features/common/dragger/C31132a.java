...
/* renamed from: com.ss.android.lark.calendar.impl.features.common.dragger.a */
public class C31132a {
    /* renamed from: a */
    public static Rect m116222a(View view, View view2) {
        Point point = new Point();
        m116221a(view, view2, point);
        return new Rect(point.x, point.y, point.x + view.getWidth(), point.y + view.getHeight());
    }

    /* renamed from: a */
    public static float m116221a(View view, View view2, Point point) {
    ...
    /* renamed from: b */
    public static float m116223b(View view, View view2, Point point) {
        View view3;
        ArrayList arrayList = new ArrayList();
        float[] fArr = {(float) point.x, (float) point.y};
        while (view != view2) {
