...
public class CalendarDate implements Serializable {
    ...
    public int getWeeklyDayIndex() {
        return getWeeklyDayIndex(C30022a.f74884c.mo108456c().getWeekStartDay());
    }

    public int getYearWeek() {
        return getYearWeek(C30022a.f74884c.mo108456c().getWeekStartDay());
    }
    ...
    /* renamed from: com.ss.android.lark.calendar.impl.features.calendarview.CalendarDate$1 */
    public static /* synthetic */ class C306541 {

        /* renamed from: a */
        static final /* synthetic */ int[] f76775a;
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.ss.android.lark.calendar.impl.features.calendarview.CalendarDate.C306541.f76775a = r0
            ...
            L_0x0012:
                int[] r0 = com.ss.android.lark.calendar.impl.features.calendarview.CalendarDate.C306541.f76775a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.ss.android.lark.calendar.impl.features.calendarview.CalendarDate.C306541.<clinit>():void");
        }
    }
    ...
    public int getWeeklyDayIndex(CalendarSetting.DayOfWeek dayOfWeek) {
        int i = C306541.f76775a[dayOfWeek.ordinal()];
        if (i == 1) {
