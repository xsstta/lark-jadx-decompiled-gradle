...
public final class WXTimeLineShareHandler extends BaseShareHandler {
    ...
    public void mo113988a(Context context, Bitmap bitmap) {
        ...
        if (C30022a.f74883b.mo112700h()) {
            ...
            String string = UIHelper.getString(R.string.Calendar_Share_ContinueSharingMoment);
            Intrinsics.checkExpressionValueIsNotNull(string, "UIHelper.getString(R.str…re_ContinueSharingMoment)");
            fVar.mo113956a(context, bitmap, string, ShareType.WX_TIMELINE);
            return;
        }
        ThirdShareUtils.f79505a.mo113955a(context, bitmap, ShareType.WX_TIMELINE);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ WXTimeLineShareHandler(InnerShareDependency aVar, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public void mo113989a(Context context, String str, String str2, String str3, String str4) {
        ...
        ThirdShareUtils.f79505a.mo113957a(context, ShareType.WX_TIMELINE, str, str2, str3);
    }
}
