...
import com.ss.android.lark.mail.impl.message.view.BigContentMessageView;

/* renamed from: com.ss.android.lark.mail.impl.message.pageroute.a.b */
public class C42944b extends AbstractC42925b {
    ...
    public AbsMessageTemplateView mo154012a(Context context) {
        return new BigContentMessageView(context);
    }
}
