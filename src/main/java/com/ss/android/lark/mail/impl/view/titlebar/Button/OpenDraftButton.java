...
public class OpenDraftButton extends AbsButton {
    @Override // com.ss.android.lark.mail.impl.view.titlebar.AbsButton
    public int getDrawableID() {
        return R.drawable.ud_icon_edit_continue_outlined;
    }
    ...
    public String getText() {
        return C43819s.m173684a((int) R.string.Mail_Normal_Draft);
    }

    public OpenDraftButton(AbsButton.AbstractC43948a aVar) {
        super(aVar);
    }
}
