...
public class MoveToOtherButton extends AbsButton {
    ...
    public String getText() {
        return C43819s.m173684a((int) R.string.Mail_SmartInbox_MoveToOthers);
    }

    public MoveToOtherButton(AbsButton.AbstractC43948a aVar) {
        super(aVar);
    }
}
