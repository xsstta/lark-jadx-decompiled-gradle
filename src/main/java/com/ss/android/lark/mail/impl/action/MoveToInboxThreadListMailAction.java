...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0002\b\t\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0007\u0018\u00002\u00020\u0001B)\u0012\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003\u0012\u0006\u0010\u0005\u001a\u00020\u0004\u0012\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003¢\u0006\u0002\u0010\u0007J\t\u0010\r\u001a\u00020\u000eHÖ\u0001J\b\u0010\u000f\u001a\u00020\u0004H\u0016J\u0019\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u000eHÖ\u0001R\u0014\u0010\u0005\u001a\u00020\u0004X\u0004¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\tR\u001a\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003X\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000bR\u001a\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003X\u0004¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\u000b¨\u0006\u0015"}, d2 = {"Lcom/ss/android/lark/mail/impl/action/MoveToInboxThreadListMailAction;", "Lcom/ss/android/lark/mail/impl/action/MoveThreadListAction;", "threadIds", "", "", "fromLabelId", "removeLabelIds", "(Ljava/util/List;Ljava/lang/String;Ljava/util/List;)V", "getFromLabelId", "()Ljava/lang/String;", "getRemoveLabelIds", "()Ljava/util/List;", "getThreadIds", "describeContents", "", "getSuccessTip", "writeToParcel", "", "parcel", "Landroid/os/Parcel;", "flags", "mail_release"}, mo238835k = 1, mv = {1, 1, 16})
public final class MoveToInboxThreadListMailAction extends MoveThreadListAction {
    public static final Parcelable.Creator CREATOR = new C41788a();

    /* renamed from: a */
    private final List<String> f106093a;

    /* renamed from: b */
    private final String f106094b;

    /* renamed from: c */
    private final List<String> f106095c;

    @Metadata(bv = {1, 0, 3}, mo238835k = 3, mv = {1, 1, 16})
    /* renamed from: com.ss.android.lark.mail.impl.action.MoveToInboxThreadListMailAction$a */
    public static class C41788a implements Parcelable.Creator {
        @Override // android.os.Parcelable.Creator
        public final Object createFromParcel(Parcel parcel) {
            Intrinsics.checkParameterIsNotNull(parcel, "in");
            return new MoveToInboxThreadListMailAction(parcel.createStringArrayList(), parcel.readString(), parcel.createStringArrayList());
        }

        @Override // android.os.Parcelable.Creator
        public final Object[] newArray(int i) {
            return new MoveToInboxThreadListMailAction[i];
        }
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeStringList(this.f106093a);
        parcel.writeString(this.f106094b);
        parcel.writeStringList(this.f106095c);
    }
    ...
    public String mo150247c() {
        ...
        String a2 = C43819s.m173684a((int) R.string.Mail_Notification_Multi_Thread_Inbox);
        Intrinsics.checkExpressionValueIsNotNull(a2, "StringUtils.getString(R.…ation_Multi_Thread_Inbox)");
        return mo150293a(a, a2);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MoveToInboxThreadListMailAction(List<String> list, String str, List<String> list2) {
