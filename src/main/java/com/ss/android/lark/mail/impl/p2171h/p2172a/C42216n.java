...
/* renamed from: com.ss.android.lark.mail.impl.h.a.n */
public class C42216n extends AbstractC42192a {
    ...
    public JSONObject mo152303a(JSONObject jSONObject) {
        return C43767j.m173489a().mo155932a("event", Event.mail_message_list_load).mo155934a();
    }
    ...
    public JSONObject mo152305c(JSONObject jSONObject) {
        return C43767j.m173489a().mo155932a("category", new ConcurrentHashMap<String, Object>(jSONObject) {
            /* class com.ss.android.lark.mail.impl.p2171h.p2172a.C42216n.C422171 */
            final /* synthetic */ JSONObject val$params;

            {
                this.val$params = r4;
                put("scene_type", r4.optString("scene_type", "select_thread"));
                put("from_db", Integer.valueOf(r4.optInt("from_db", 0)));
                put("debug_message", r4.optString("debug_message", ""));
                put("mail_body_length", Integer.valueOf(r4.optInt("mail_body_length", 0)));
    ...
    public JSONObject mo152304b(JSONObject jSONObject) {
        return C43767j.m173489a().mo155932a("biz", Biz.Mail).mo155932a("scene", Scene.MailRead).mo155933a("page", "message").mo155934a();
    }
}
