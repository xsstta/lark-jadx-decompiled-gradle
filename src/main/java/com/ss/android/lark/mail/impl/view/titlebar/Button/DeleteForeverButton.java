...
public class DeleteForeverButton extends AbsButton {
    ...
    public String getText() {
        return C43819s.m173684a((int) R.string.Mail_ThreadAction_DeleteForeverMobile);
    }

    public DeleteForeverButton(AbsButton.AbstractC43948a aVar) {
        super(aVar);
    }
}
