...
/* renamed from: com.ss.android.lark.mail.impl.settings.component.settingitem.j */
public class C43429j extends AbsSettingItemViewModel {
    ...
    public ISettingItemModel.Function mo155208b() {
        return ISettingItemModel.Function.FUNC_SIGNATURE_SWITCH;
    }
    ...
    public String mo155212d() {
        return C43819s.m173684a((int) R.string.Mail_Setting_EmailSignatureMobile);
    }
    ...
    public C43429j(LifecycleOwner lifecycleOwner, ISettingItemModel iSettingItemModel) {
    ...
    public void mo155205a(View view, boolean z) {
        C42699a.m170283e(this.f110309a, mo155217i());
