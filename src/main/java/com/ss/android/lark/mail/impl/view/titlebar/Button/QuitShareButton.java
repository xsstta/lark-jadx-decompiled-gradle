...
public class QuitShareButton extends AbsButton {
    ...
    public String getText() {
        return C43819s.m173684a((int) R.string.Mail_Share_QuitSharing);
    }

    public QuitShareButton(AbsButton.AbstractC43948a aVar) {
        super(aVar);
    }
}
