...
public class MultiThreadActionConfig_Runtime extends MultiThreadActionConfig {
    private HashMap labelConfigMap = new HashMap();

    public MultiThreadActionConfig_Runtime() {
    ...
    private ThreadActionConfig getDefaultConfig() {
        ...
        addActionDueToFG(arrayList, "MARK_AS_READ");
    ...
    private HashMap<String, ThreadActionConfig> getSceneConfig() {
        ...
        addActionDueToFG(arrayList3, "MARK_AS_READ");
        ...
        addActionDueToFG(arrayList5, "MARK_AS_READ");
        ...
        addActionDueToFG(arrayList7, "MOVE_TO_TRASH");
        ArrayList<String> arrayList8 = new ArrayList<>();
        addActionDueToFG(arrayList8, "CHANGE_LABEL");
        this.labelConfigMap.put("DRAFT", new ThreadActionConfig(arrayList7, arrayList8));
        ArrayList<String> arrayList9 = new ArrayList<>();
        addActionDueToFG(arrayList9, "MOVE_TO_TRASH");
        addActionDueToFG(arrayList9, "MARK_AS_READ");
        ...
        addActionDueToFG(arrayList11, "MARK_AS_READ");
        ...
        addActionDueToFG(arrayList13, "MARK_AS_READ");
        ...
        addActionDueToFG(arrayList15, "MARK_AS_READ");
        ...
        addActionDueToFG(arrayList17, "MARK_AS_READ");
