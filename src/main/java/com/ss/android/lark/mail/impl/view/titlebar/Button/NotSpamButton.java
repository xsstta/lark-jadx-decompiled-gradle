...
public class NotSpamButton extends AbsButton {
    @Override // com.ss.android.lark.mail.impl.view.titlebar.AbsButton
    public int getDrawableID() {
        return R.drawable.ud_icon_notspam_outlined;
    }
    ...
    public String getText() {
        return C43819s.m173684a((int) R.string.Mail_ThreadAction_Unspam);
    }

    public NotSpamButton(AbsButton.AbstractC43948a aVar) {
        super(aVar);
    }
}
