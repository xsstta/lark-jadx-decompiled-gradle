...
/* renamed from: com.ss.android.lark.mail.impl.settings.component.settingitem.a */
public class C43417a extends AbsSettingItemViewModel {
    ...
    public ISettingItemModel.Function mo155208b() {
        return ISettingItemModel.Function.FUNC_AUTO_REPLY_SWITCH;
    }
    ...
    public String mo155212d() {
        return C43819s.m173684a((int) R.string.Mail_Setting_EmailAutoReply);
    }
    ...
    public String mo155213e() {
        return C43819s.m173684a((int) R.string.Mail_OOO_Title_Tip);
    }
    ...
    public C43417a(LifecycleOwner lifecycleOwner, ISettingItemModel iSettingItemModel) {
    ...
    public void mo155205a(View view, boolean z) {
        C42699a.m170287g(this.f110309a, mo155217i());
    }
}
