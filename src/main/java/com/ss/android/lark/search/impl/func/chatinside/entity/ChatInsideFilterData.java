...
public final class ChatInsideFilterData {
    ...
    public ChatInsideFilterData() {
        ...
        this.f132221b = a;
        this.f132222c = SearchConstants.SpaceType.UNKNOWN;
    }

    /* renamed from: a */
    public final void mo182736a(SearchConstants.SpaceType spaceType) {
        this.f132222c = spaceType;
    }

    /* renamed from: a */
    public final void mo182737a(NetSearchRequest.Filter filter) {
        Intrinsics.checkParameterIsNotNull(filter, "<set-?>");
        this.f132221b = filter;
    }

    /* renamed from: a */
    public final void mo182738a(List<String> list) {
