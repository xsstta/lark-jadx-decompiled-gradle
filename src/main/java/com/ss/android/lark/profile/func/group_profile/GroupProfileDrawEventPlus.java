...
public final class GroupProfileDrawEventPlus extends BaseLKUIPlus {
    ...
    public void onDelegateDispatchDrawEnd(Canvas canvas) {
        ...
        if (this.isFirstRender) {
            ...
            GroupProfilePerceivableErrorCostTimeHitPoint.f130734a.mo180536g();
        }
    }
}
