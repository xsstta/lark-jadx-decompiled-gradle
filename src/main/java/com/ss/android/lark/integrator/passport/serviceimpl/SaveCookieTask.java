...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0011\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0002R\u0014\u0010\u0003\u001a\u00020\u0004XD¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u000b"}, d2 = {"Lcom/ss/android/lark/integrator/passport/serviceimpl/SaveCookieTask;", "Lcom/ss/android/lark/integrator/passport/serviceimpl/IInitializeTask;", "()V", "taskName", "", "getTaskName", "()Ljava/lang/String;", "invoke", "", "user", "Lcom/ss/android/lark/passport/signinsdk_api/account/User;", "passport_productionUsRelease"}, mo238835k = 1, mv = {1, 1, 16})
/* renamed from: com.ss.android.lark.integrator.passport.serviceimpl.g */
public final class SaveCookieTask implements IInitializeTask {

    /* renamed from: a */
    public static final SaveCookieTask f101766a = new SaveCookieTask();

    /* renamed from: b */
    private static final String f101767b = f101767b;

    private SaveCookieTask() {
    }
    ...
    /* renamed from: a */
    public void mo145318a(String str) {
        Intrinsics.checkParameterIsNotNull(str, "msg");
        IInitializeTask.C40012a.m158652a(this, str);
    }

    /* renamed from: a */
    public void mo145317a(User user) {
        Intrinsics.checkParameterIsNotNull(user, "user");
        ServiceFinder.m193748c().clearCookies();
        ServiceFinder.m193748c().saveSessionToCookies(user.getSession(), user.getSessionWithDomainMap());
        mo145318a("save session to cookie success");
    }
