...
/* renamed from: com.ss.android.lark.mediapicker.utils.j */
public final class C44754j {
    /* renamed from: b */
    public static boolean m177501b(String str) {
    ...
    /* renamed from: c */
    public static boolean m177502c(String str) {
        if (TextUtils.isEmpty(str)) {
            return false;
        }
        str.hashCode();
    ...
    /* renamed from: a */
    public static int m177499a(String str) {
        if (TextUtils.isEmpty(str)) {
            return 1;
        }
        str.hashCode();
    ...
    /* renamed from: a */
    public static boolean m177500a(String str, String str2) {
        if (m177499a(str) == m177499a(str2)) {
            return true;
        }
        return false;
    }
