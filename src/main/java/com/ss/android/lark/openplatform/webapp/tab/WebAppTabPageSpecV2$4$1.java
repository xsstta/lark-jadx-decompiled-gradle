...
class WebAppTabPageSpecV2$4$1 extends IWebTabCallbackInterface.Default {
    final /* synthetic */ C48893d.C488974 this$1;

    WebAppTabPageSpecV2$4$1(C48893d.C488974 r1) {
        this.this$1 = r1;
    }
    ...
    public void onAppAddResult(boolean z) throws RemoteException {
        C53241h.m205898b("WebAppTabPageSpecV2", "onAddResult " + z);
        if (z) {
            C48893d.this.f122836f = true;
        }
    }
}
