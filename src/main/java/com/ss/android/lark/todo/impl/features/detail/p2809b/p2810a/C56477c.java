...
/* renamed from: com.ss.android.lark.todo.impl.features.detail.b.a.c */
public class C56477c {

    /* renamed from: a */
    private static AbstractC56256k f139696a = TodoDependencyHolder.f139242a.mo191730a().imageDependency();

    /* renamed from: a */
    public static RichTextElement.TextProperty m220159a(RichTextElement.TextProperty textProperty) throws Exception {
        String str;
        int i;
        ...
        if (textProperty == null) {
            ...
            i = textProperty.numberOfLines.intValue();
        }
        textProperty2.setNumberOfLines(i);
        return textProperty2;
    }

    /* renamed from: a */
    public static RichTextElement.ImageProperty m220145a(RichTextElement.ImageProperty imageProperty) throws Exception {
        String str;
        String str2;
        int i;
        int i2;
        ...
        imageProperty2.setMiddleKey(f139696a.mo145393b(imageProperty));
        imageProperty2.setThumbKey(f139696a.mo145390a(imageProperty));
        boolean z = false;
        if (imageProperty == null) {
            i = 0;
        } else {
    ...
    /* renamed from: a */
    public static RichTextElement.ParagraphProperty m220154a(RichTextElement.ParagraphProperty paragraphProperty) throws Exception {
        return new RichTextElement.ParagraphProperty();
    }

    /* renamed from: a */
    public static RichTextElement.FigureProperty m220140a(RichTextElement.FigureProperty figureProperty) throws Exception {
        return new RichTextElement.FigureProperty();
    }

    /* renamed from: a */
    public static RichTextElement.ItalicProperty m220146a(RichTextElement.ItalicProperty italicProperty) throws Exception {
        String str;
    ...
    /* renamed from: a */
    public static RichTextElement.UnderlineProperty m220164a(RichTextElement.UnderlineProperty underlineProperty) throws Exception {
        String str;
    ...
    /* renamed from: a */
    public static RichTextElement.EmotionProperty m220139a(RichTextElement.EmotionProperty emotionProperty) throws Exception {
        String str;
    ...
    /* renamed from: a */
    public static RichTextElement.SelectProperty m220158a(RichTextElement.SelectProperty selectProperty) throws Exception {
        int i;
    ...
    /* renamed from: a */
    public static RichTextElement.ProgressSelectOptionProperty m220155a(RichTextElement.ProgressSelectOptionProperty progressSelectOptionProperty) throws Exception {
        String str;
        String str2;
        String str3;
        boolean z;
    ...
    /* renamed from: a */
    public static RichTextElement.TextableAreaProperty m220160a(RichTextElement.TextableAreaProperty textableAreaProperty) throws Exception {
        int i;
    ...
    /* renamed from: a */
    public static RichTextElement.TimeProperty m220162a(RichTextElement.TimeProperty timeProperty) throws Exception {
        long j;
        String str;
    ...
    /* renamed from: a */
    public static RichTextElement.LinkProperty m220148a(RichTextElement.LinkProperty linkProperty) throws Exception {
        String str;
    ...
    /* renamed from: a */
    public static RichTextElement.MediaProperty m220149a(RichTextElement.MediaProperty mediaProperty) throws Exception {
        String str;
        String str2;
        long j;
        String str3;
        ...
        Image image = null;
        mediaProperty2.setOriginImage((mediaProperty == null || mediaProperty.image == null) ? null : m220127a(mediaProperty.image.origin));
        if (!(mediaProperty == null || mediaProperty.image == null)) {
            image = m220128a(mediaProperty.image);
        }
    ...
    /* renamed from: a */
    public static RichTextElement.SelectMenuProperty m220157a(RichTextElement.SelectMenuProperty selectMenuProperty) throws Exception {
        String str;
        String str2;
    ...
    /* renamed from: a */
    public static RichTextElement.OverflowMenuProperty m220152a(RichTextElement.OverflowMenuProperty overflowMenuProperty) throws Exception {
        String str;
        boolean z;
    ...
    /* renamed from: a */
    public static RichTextElement.DatePickerProperty m220135a(RichTextElement.DatePickerProperty datePickerProperty) throws Exception {
        String str;
        String str2;
        String str3;
        boolean z;
    ...
    /* renamed from: a */
    public static RichTextElement.TimePickerProperty m220161a(RichTextElement.TimePickerProperty timePickerProperty) throws Exception {
        String str;
        String str2;
        String str3;
        boolean z;
    ...
    /* renamed from: a */
    public static RichTextElement.DateTimePickerProperty m220136a(RichTextElement.DatetimePickerProperty datetimePickerProperty) throws Exception {
        String str;
        String str2;
        String str3;
        boolean z;
    ...
    /* renamed from: a */
    public static RichTextElement.ParagraphProperty m220153a() {
        return new RichTextElement.ParagraphProperty();
    }

    /* renamed from: a */
    public static RichTextElement.DocsProperty m220138a(RichTextElement.DocsProperty docsProperty) {
        return new RichTextElement.DocsProperty();
    }

    /* renamed from: a */
    public static RichTextElement.H1Property m220141a(RichTextElement.H1Property h1Property) {
        return new RichTextElement.H1Property();
    }

    /* renamed from: a */
    public static RichTextElement.H2Property m220142a(RichTextElement.H2Property h2Property) {
        return new RichTextElement.H2Property();
    }

    /* renamed from: a */
    public static RichTextElement.H3Property m220143a(RichTextElement.H3Property h3Property) {
        return new RichTextElement.H3Property();
    }

    /* renamed from: a */
    public static RichTextElement.ULProperty m220163a(RichTextElement.ULProperty uLProperty) {
    ...
    /* renamed from: a */
    public static RichTextElement.OLProperty m220151a(RichTextElement.OLProperty oLProperty) {
    ...
    /* renamed from: a */
    public static RichTextElement.LIProperty m220147a(RichTextElement.LIProperty lIProperty) {
        return new RichTextElement.LIProperty();
    }

    /* renamed from: a */
    public static RichTextElement.QuoteProperty m220156a(RichTextElement.QuoteProperty quoteProperty) {
        return new RichTextElement.QuoteProperty();
    }

    /* renamed from: a */
    public static RichTextElement.HRProperty m220144a(RichTextElement.HRProperty hRProperty) {
        return new RichTextElement.HRProperty();
    }

    /* renamed from: a */
    public static RichTextElement.MentionProperty m220150a(RichTextElement.MentionProperty mentionProperty) {
    ...
    /* renamed from: a */
    public static RichTextElement.CodeProperty m220134a(RichTextElement.CodeProperty codeProperty) {
        return new RichTextElement.CodeProperty();
    }

    /* renamed from: a */
    public static RichTextElement.DivProperty m220137a(RichTextElement.DivProperty divProperty) throws Exception {
        return new RichTextElement.DivProperty();
    }

    /* renamed from: a */
    public static RichTextElement.BoldProperty m220131a(RichTextElement.BoldProperty boldProperty) throws Exception {
        String str;
    ...
    /* renamed from: a */
    private static Image m220127a(com.bytedance.lark.pb.basic.v1.Image image) {
        if (image == null) {
            return null;
        }
    ...
    /* renamed from: a */
    private static Image m220128a(ImageSet imageSet) {
        com.ss.android.lark.image.entity.Image a = f139696a.mo145387a(imageSet);
        if (a == null) {
            return null;
        }
    ...
    /* renamed from: a */
    public static RichTextElement.AnchorProperty m220129a(RichTextElement.AnchorProperty anchorProperty) throws Exception {
        String str;
        boolean f = TodoDependencyHolder.f139242a.mo191731b().mo191933f();
        ...
        if (anchorProperty != null) {
            ...
            if (f) {
                anchorProperty2.setDisplayTitle(str);
            }
            ...
            anchorProperty2.setDisplayTitle("");
    ...
    /* renamed from: a */
    public static RichTextElement.AtProperty m220130a(RichTextElement.AtProperty atProperty) throws Exception {
        String str;
        boolean z;
    ...
    /* renamed from: a */
    public static RichTextElement.ButtonProperty m220132a(RichTextElement.ButtonProperty buttonProperty) throws Exception {
        String str;
        boolean z;
        boolean z2;
        String str2;
    ...
    /* renamed from: a */
    public static RichTextElement.CodeBlockProperty m220133a(RichTextElement.CodeBlockProperty codeBlockProperty) {
