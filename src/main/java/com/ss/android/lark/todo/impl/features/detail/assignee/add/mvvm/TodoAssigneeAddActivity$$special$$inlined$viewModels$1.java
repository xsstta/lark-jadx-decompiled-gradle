...
public final class TodoAssigneeAddActivity$$special$$inlined$viewModels$1 extends Lambda implements Function0<C1144ai.AbstractC1146b> {
    final /* synthetic */ ComponentActivity $this_viewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TodoAssigneeAddActivity$$special$$inlined$viewModels$1(ComponentActivity componentActivity) {
        super(0);
