...
import com.ss.android.lark.todo.impl.features.messagecard.comment.TodoCommentCellBinder;
...
public final class TodoCommentMessageCell extends TodoBaseMessageCell implements IOpenMessageCell<TodoContentVO>, IOpenBubbleStyleProvider<TodoContentVO> {
    ...
    public Class<TodoContentVO> mo120409a() {
        return TodoCommentContentVO.class;
    }
    ...
    public TodoCommentMessageCell(IMessageContext aVar, IOpenCellCallback<TodoContentVO> bVar) {
    ...
    public TodoCommentMessageCell(IMessageContext aVar, boolean z, IOpenCellCallback<TodoContentVO> bVar) {
        super(aVar, bVar);
        Intrinsics.checkParameterIsNotNull(aVar, "mMessageContext");
        Intrinsics.checkParameterIsNotNull(bVar, "mOpenCellCallback");
        this.f139204d = new TodoCommentCellBinder(z);
    }
}
