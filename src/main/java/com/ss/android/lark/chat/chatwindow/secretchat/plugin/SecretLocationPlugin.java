...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0016¨\u0006\t"}, d2 = {"Lcom/ss/android/lark/chat/chatwindow/secretchat/plugin/SecretLocationPlugin;", "Lcom/ss/android/lark/chat/chatwindow/biz/plugin/core/BaseChatPlugin;", "()V", "onCreate", "", "chatApp", "Lcom/ss/android/lark/chat/chatwindow/chat/v2/component/IChatWindowApp;", "initData", "Lcom/ss/android/lark/chatwindow/model/data/ChatWindowInitData;", "im_chat_chat_productionUsRelease"}, mo238835k = 1, mv = {1, 1, 16})
/* renamed from: com.ss.android.lark.chat.chatwindow.secretchat.plugin.d */
public final class SecretLocationPlugin extends BaseChatPlugin {

    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0016¨\u0006\u0006"}, d2 = {"com/ss/android/lark/chat/chatwindow/secretchat/plugin/SecretLocationPlugin$onCreate$1", "Lcom/ss/android/lark/chat/chatwindow/biz/component/keyboard/IKeyboardComponent$IKeyboardComponentCallbacks;", "onKeyboardReady", "", "keyboard", "Lcom/ss/android/lark/keyboard/KeyBoard;", "im_chat_chat_productionUsRelease"}, mo238835k = 1, mv = {1, 1, 16})
    /* renamed from: com.ss.android.lark.chat.chatwindow.secretchat.plugin.d$a */
    public static final class C33920a implements IKeyboardComponent.IKeyboardComponentCallbacks {

        /* renamed from: a */
        final /* synthetic */ IChatWindowApp f87420a;

        /* renamed from: b */
        final /* synthetic */ Chat f87421b;

        /* renamed from: c */
        final /* synthetic */ ChatChatter f87422c;

        /* renamed from: d */
        final /* synthetic */ IKeyboardComponent f87423d;
        ...
        public void mo122066a(KeyBoard fVar) {
            ...
            Object o = this.f87420a.mo123193o();
            if (o != null) {
                Chat chat = this.f87421b;
                Intrinsics.checkExpressionValueIsNotNull(chat, "chat");
                LocationPlusItemPlugin dVar = new LocationPlusItemPlugin(new IKeyboardCreator.PluginContext((Fragment) o, fVar, chat, this.f87422c, null));
                this.f87423d.mo121977a(dVar.mo122012a(), dVar);
                return;
            }
            throw new TypeCastException("null cannot be cast to non-null type androidx.fragment.app.Fragment");
        }

        C33920a(IChatWindowApp dVar, Chat chat, ChatChatter chatChatter, IKeyboardComponent cVar) {
            this.f87420a = dVar;
            this.f87421b = chat;
            this.f87422c = chatChatter;
            this.f87423d = cVar;
        }
    }
    ...
    public void mo122114a(IChatWindowApp dVar, C35219b bVar) {
        ...
        if (ChatKeyboardFgUtil.f85002a.mo122016a()) {
            ...
            cVar.mo121971a(new C33920a(dVar, chat, chatChatter, cVar));
        }
    }
}
