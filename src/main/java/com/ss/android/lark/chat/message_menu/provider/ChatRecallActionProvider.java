...
public final class ChatRecallActionProvider implements ActionProvider {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0000\b\u0004\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\r\u0010\u0005\u001a\u00020\u0006H\u0016¢\u0006\u0002\u0010\u0007J\r\u0010\b\u001a\u00020\u0006H\u0016¢\u0006\u0002\u0010\u0007J\b\u0010\t\u001a\u00020\u0006H\u0016J\b\u0010\n\u001a\u00020\u000bH\u0016J\b\u0010\f\u001a\u00020\rH\u0016J\b\u0010\u000e\u001a\u00020\u000fH\u0016¨\u0006\u0010"}, d2 = {"Lcom/ss/android/lark/chat/message_menu/provider/ChatRecallActionProvider$RecallMessageAction;", "Lcom/ss/android/lark/biz/im/extension/MessageAction;", "actionContext", "Lcom/ss/android/lark/biz/im/extension/ActionContext;", "(Lcom/ss/android/lark/chat/message_menu/provider/ChatRecallActionProvider;Lcom/ss/android/lark/biz/im/extension/ActionContext;)V", "getIconDrawableRes", "", "()Ljava/lang/Integer;", "getIconTintColorRes", "getId", "getLabel", "", "isEnable", "", "onClick", "", "im_chat_chat_productionUsRelease"}, mo238835k = 1, mv = {1, 1, 16})
    /* renamed from: com.ss.android.lark.chat.c.c.j$a */
    public final class RecallMessageAction extends MessageAction {

        /* renamed from: a */
        final /* synthetic */ ChatRecallActionProvider f84944a;
        ...
        public Integer mo106819b() {
            return Integer.valueOf((int) R.drawable.ud_icon_recall_outlined);
        }
        ...
        public String mo106821d() {
            String string = UIHelper.getString(R.string.Lark_Legacy_ChatWithdrow);
            Intrinsics.checkExpressionValueIsNotNull(string, "UIHelper.getString(R.str…Lark_Legacy_ChatWithdrow)");
            return string;
        }
        ...
        public void mo106823f() {
            new C33099ab(mo106825h().mo106783c()).mo122268a(mo106825h().mo106788h());
        }

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public RecallMessageAction(ChatRecallActionProvider jVar, ActionContext actionContext) {
            super(actionContext);
    ...
    public MessageAction mo106809b(ActionContext actionContext) {
        Intrinsics.checkParameterIsNotNull(actionContext, "actionContext");
        return new RecallMessageAction(this, actionContext);
    }
    ...
    public boolean mo106807a(ActionContext actionContext) {
        Intrinsics.checkParameterIsNotNull(actionContext, "actionContext");
        if (actionContext.mo106788h().mo121695c()) {
            return true;
        }
        Chat e = actionContext.mo106785e();
        if (e == null || !C34339g.m133167a(e)) {
            return false;
        }
        return true;
    }
