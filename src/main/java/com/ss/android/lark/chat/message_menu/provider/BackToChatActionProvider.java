...
public final class BackToChatActionProvider implements ActionProvider {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0000\b\u0004\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\r\u0010\u0005\u001a\u00020\u0006H\u0016¢\u0006\u0002\u0010\u0007J\r\u0010\b\u001a\u00020\u0006H\u0016¢\u0006\u0002\u0010\u0007J\b\u0010\t\u001a\u00020\u0006H\u0016J\b\u0010\n\u001a\u00020\u000bH\u0016J\b\u0010\f\u001a\u00020\rH\u0016J\b\u0010\u000e\u001a\u00020\u000fH\u0016¨\u0006\u0010"}, d2 = {"Lcom/ss/android/lark/chat/message_menu/provider/BackToChatActionProvider$BackToChatMessageAction;", "Lcom/ss/android/lark/biz/im/extension/MessageAction;", "actionContext", "Lcom/ss/android/lark/biz/im/extension/ActionContext;", "(Lcom/ss/android/lark/chat/message_menu/provider/BackToChatActionProvider;Lcom/ss/android/lark/biz/im/extension/ActionContext;)V", "getIconDrawableRes", "", "()Ljava/lang/Integer;", "getIconTintColorRes", "getId", "getLabel", "", "isEnable", "", "onClick", "", "im_chat_chat_productionUsRelease"}, mo238835k = 1, mv = {1, 1, 16})
    /* renamed from: com.ss.android.lark.chat.c.c.a$a */
    public final class BackToChatMessageAction extends MessageAction {

        /* renamed from: a */
        final /* synthetic */ BackToChatActionProvider f84919a;
        ...
        public Integer mo106819b() {
            return Integer.valueOf((int) R.drawable.ud_icon_viewinchat_outlined);
        }
        ...
        public String mo106821d() {
            String string = UIHelper.getString(R.string.Lark_Message_ThreadMessageActionViewInChat);
            Intrinsics.checkExpressionValueIsNotNull(string, "UIHelper.getString(R.str…dMessageActionViewInChat)");
            return string;
        }
        ...
        public void mo106823f() {
            ...
            if (e != null) {
                ...
                C35228b.m137564a().mo121114a(mo106825h().mo106782b(), ChatBundle.m109259a().mo105927a(id).mo105920a(mo106825h().mo106788h().mo121717y()).mo105933c("chat_thread").mo105929a());
            }
        }

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public BackToChatMessageAction(BackToChatActionProvider aVar, ActionContext actionContext) {
            super(actionContext);
            Intrinsics.checkParameterIsNotNull(actionContext, "actionContext");
            this.f84919a = aVar;
        }
    ...
    public Collection<ActionContext.PageType> mo106806a() {
        return CollectionsKt.listOf(ActionContext.PageType.CHAT_THREAD);
    }
    ...
    public MessageAction mo106809b(ActionContext actionContext) {
        Intrinsics.checkParameterIsNotNull(actionContext, "actionContext");
        return new BackToChatMessageAction(this, actionContext);
    }
}
