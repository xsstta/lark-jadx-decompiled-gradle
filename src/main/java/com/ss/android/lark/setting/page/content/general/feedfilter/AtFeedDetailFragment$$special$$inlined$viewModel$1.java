...
public final class AtFeedDetailFragment$$special$$inlined$viewModel$1 extends Lambda implements Function0<String> {
    final /* synthetic */ KClass $viewModelClass;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AtFeedDetailFragment$$special$$inlined$viewModel$1(KClass kClass) {
        super(0);
