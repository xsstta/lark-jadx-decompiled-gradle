...
public class X509Util {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (z) {
                try {
                    ...
                    LogUtil.m257131e("X509Util", "Unable to reload the default TrustManager", e);
                } catch (KeyStoreException e2) {
                    LogUtil.m257131e("X509Util", "Unable to reload the default TrustManager", e2);
                } catch (NoSuchAlgorithmException e3) {
                    LogUtil.m257131e("X509Util", "Unable to reload the default TrustManager", e3);
                }
            }
        }
    }
    ...
    public static void clearTestRootCertificates() throws java.security.NoSuchAlgorithmException, java.security.cert.CertificateException, java.security.KeyStoreException {
        /*
            ensureInitialized()
            java.lang.Object r0 = com.ss.video.rtc.base.utils.X509Util.sLock
            monitor-enter(r0)
            java.security.KeyStore r1 = com.ss.video.rtc.base.utils.X509Util.sTestKeyStore     // Catch:{ IOException -> 0x0012 }
            r2 = 0
        ...
        L_0x0014:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.video.rtc.base.utils.X509Util.clearTestRootCertificates():void");
    }
    ...
    private static void ensureInitializedLocked() throws CertificateException, KeyStoreException, NoSuchAlgorithmException {
        ...
        if (sTrustStorageListener == null) {
            ...
            INVOKEVIRTUAL_com_ss_video_rtc_base_utils_X509Util_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver(ContextUtils.getApplicationContext(), sTrustStorageListener, intentFilter);
        }
    }
    ...
    public static final class X509TrustManagerIceCreamSandwich implements X509TrustManagerImplementation {
        ...
        @Override // com.ss.video.rtc.base.utils.X509Util.X509TrustManagerImplementation
        public List<X509Certificate> checkServerTrusted(X509Certificate[] x509CertificateArr, String str, String str2) throws CertificateException {
            try {
                this.mTrustManager.checkServerTrusted(x509CertificateArr, str);
                return Collections.emptyList();
            } catch (RuntimeException e) {
                LogUtil.m257131e("X509Util", "X509TrustManager unexpectedly threw: %s", e);
    ...
    public static final class X509TrustManagerJellyBean implements X509TrustManagerImplementation {
        ...
        public List<X509Certificate> checkServerTrusted(X509Certificate[] x509CertificateArr, String str, String str2) throws CertificateException {
            try {
                ...
                LogUtil.m257131e("X509Util", "checkServerTrusted() unexpectedly threw: %s", e);
                throw new CertificateException(e);
            }
        }
    }
    ...
    static boolean verifyKeyUsage(java.security.cert.X509Certificate r4) throws java.security.cert.CertificateException {
        ...
        L_0x003a:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.video.rtc.base.utils.X509Util.verifyKeyUsage(java.security.cert.X509Certificate):boolean");
    }
            ...
            for (TrustManager trustManager : trustManagers) {
                if (trustManager instanceof X509TrustManager) {
                    try {
                        ...
                        LogUtil.m257130e("X509Util", "Error creating trust manager (" + trustManager.getClass().getName() + "): " + e);
                    }
                }
            }
            LogUtil.m257130e("X509Util", "Could not find suitable trust manager");
            return null;
        } catch (RuntimeException e2) {
            LogUtil.m257131e("X509Util", "TrustManagerFactory.getTrustManagers() unexpectedly threw: %s", e2);
        ...
        while (true) {
            ...
            if (certificate != null) {
                if (!(certificate instanceof X509Certificate)) {
                    LogUtil.m257130e("X509Util", "Anchor " + str + " not an X509Certificate: " + certificate.getClass().getName());
                } else {
    ...
    public static Intent INVOKEVIRTUAL_com_ss_video_rtc_base_utils_X509Util_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver(Context context, BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        try {
            ...
            try {
                ...
                for (int i = 1; i < bArr.length; i++) {
                    try {
                        ...
                        LogUtil.m257133w("X509Util", "intermediate " + i + " failed parsing");
                    }
                }
                    ...
                    synchronized (sLock) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                LogUtil.m257132i("X509Util", "Failed to validate the certificate chain, error: " + e.getMessage());
