...
/* renamed from: com.tt.miniapphost.a.e.h */
public class C67462h extends AbstractC67456b {

    /* renamed from: c */
    private WebView f170098c;
    ...
    /* renamed from: a */
    public String mo234201a() {
        WebView webView = this.f170098c;
        if (webView == null) {
            return null;
        }
    ...
    public C67462h(Context context) {
        super(context);
    }
    ...
    public C67462h(Context context, WebView webView) {
        super(context);
        this.f170098c = webView;
    }
